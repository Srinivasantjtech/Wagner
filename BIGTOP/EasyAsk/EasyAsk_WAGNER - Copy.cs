...
namespace TradingBell.WebCat.EasyAsk
{
    ...
    public class EasyAsk_WAGNER
    {
        ...
        public void CreateYouHaveSelectAndBreadCrumb(string EAPATH, bool xml)
        {
            ...
            try
            {
                ...
                YHSAndBC.Tables["YHSAndBC"].Columns.Add("TBT_REWRITEURL", typeof(string));
                ...
                YHSAndBC.Tables["YHSAndBC"].Columns.Add("ProductCode", typeof(string));
                 ...
                 YHSAndBC.Tables["YHSAndBC"].Columns.Add("TBT_URL_REMOVE", typeof(string));
                ...
                if (EA != "")
                {
                                ...
                                else if (strvalupper.Contains("PROD"))
                                {
                                    ...
                                    if (tmpsplit.Length > 2)
                                    {
                                        ...
                                        catch (Exception ex)
                                        {
                                            ...
                                            objErrorhandler.CreateLog(ex.ToString() + " " + HttpContext.Current.Request.RawUrl + "tmpsplit" + tmpsplit.Length);
                    ...
                    string tdrowiitemvalue1 = string.Empty;
                    string tdrowiitemvalue2 = string.Empty;
                            ...
                            for (int i = 0; i <= YHSAndBC.Tables["YHSAndBC"].Rows.Count - 1; i++)
                            {
                                using (DataTable td = YHSAndBC.Tables["YHSAndBC"])
                                {
                                    ...
                                    if (tdrtemppath.Contains("search") && i == 0)
                                    {
                                        ...
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tdrowiitemvalue, "ps.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] =  tempstrnew+"/ps/";
                                    ...
                                    else if (tdrtemppath.Contains("search"))
                                    {
                                        ...
                                        if ((isProduct))
                                        {
                                            if (tdrowItemType == "product")
                                            {
                                                ...
                                                string[] StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "////UserSearch=Prod Id" }, StringSplitOptions.None);
                                                if (StrValue1.Length == 1)
                                                {
                                                    StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "////UserSearch1=Prod Id" }, StringSplitOptions.None);

                                                }
                                                string path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue1[0]));
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pd.aspx?" + tempstr + "&fid=" + familyid + "&pid=" + Productid + "&searchstr=" + scrtext + path;

                                                string[] StrValue = StrValue1[0].Split(new string[] { "////" }, StringSplitOptions.None);
                                                string tempstrnew = string.Empty;
                                                if (StrValue.Length >= 4)
                                                {

                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + td.Rows[i]["productcode"] + "////" + StrValue[2] + "////" + StrValue[3] + "////" + familyname, "pd.aspx", false);

                                                }
                                                else
                                                {
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + td.Rows[i]["productcode"] + "////" + familyname, "pd.aspx", false);
                                                }
                                                
                                                
                                                
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = tempstrnew + "/pd/";

                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"];  //"categorylist.aspx" + tempstr;
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];  //"categorylist.aspx" + tempstr;
                                        ...
                                        else if ((isFamily))
                                        {
                                            if (tdrowItemType == "family")
                                            {
                                                ...
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx?" + tempstr + "&fid=" + HttpUtility.UrlEncode(tdrowiitemvalue) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                             //   string tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["FamilyName"], "fl.aspx", false);

                                                string tempstrnew = string.Empty;
                                                if (StrValue.Length >= 4)
                                                {

                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + StrValue[2] + "////" + StrValue[3] + "////" + td.Rows[i]["FamilyName"], "fl.aspx", false);

                                                }
                                                else
                                                {

                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["FamilyName"], "fl.aspx", false);
                                                }
                                                
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = tempstrnew + "/fl/";


                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];  //"categorylist.aspx" + tempstr;
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                            }
                                            else
                                            {
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx?" + tempstr + "&fid=" + familyid + "&tsb=" + tsb + "&tsm=" + tsm + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowiitemvalue) + "&bname=" + tsb + "&searchstr=" + scrtext + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                        ...
                                        {
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "ps.aspx" + tempstr + "&tsb=" + tsb + "&tsm=" + tsm + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowiitemvalue) + "&bname=" + tsb + "&searchstr=" + scrtext + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString())); ;
                                            string tempstrnew = objHelperServices.SimpleURL_Str(tempstr.Replace("?srctext=", ""), "ps.aspx", false);
                                           
                                                tdrowiitemvalue1 = objHelperServices.SimpleURL_Str(tdrowiitemvalue, "ps.aspx", false);
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] =  "/"+ tdrowiitemvalue1+"/"+tempstrnew +  "/ps/" ;
                                            //}
                                            //else if (tdrowiitemvalue2 == string.Empty)
                                            //{
                                            //    tdrowiitemvalue2 = objHelperServices.SimpleURL_Str(tdrowiitemvalue, "ps.aspx", false);
                                            //    YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/" +  tdrowiitemvalue2 + "/" + tdrowiitemvalue1 + "/"+tempstrnew + "/ps/";
                                            //}
                                            //else
                                            //{
                                            ...
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"];
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                            //"categorylist.aspx" + tempstr;
                                        }
                                    }
                                }
                            }
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i <= YHSAndBC.Tables["YHSAndBC"].Rows.Count - 1; i++)
                            {
                                using (DataTable td = YHSAndBC.Tables["YHSAndBC"])
                                {
                                    ...
                                    string productcode = td.Rows[i]["ProductCode"].ToString().ToLower();
                                    ...
                                    if (tdrowtemppath == "/Category")
                                    {
                                        ...
                                        tempstr = objHelperServices.SimpleURL_Str(tdrowitemvalue, "ct.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/"+tempstr + "/ct/";
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = "home.aspx";
                                    }
                                    else if (tdrowtemppath == "/CableL")
                                    {
                                        ...
                                        tempstr = "?id=0&cid=" + CatId + "&byp=" + byp;
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tdrowitemvalue, "ct.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/pl/";
                                    ...
                                    else if (tdrowtemppath == "/Brand")
                                    {
                                        ...
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tsb + "////" + CatId, "ct.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/ct/";

                                        //"&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(td.Rows[i]["Itemvalue"].ToString()) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = "home.aspx";
                                    ...
                                    else if (tdrowtemppath == "/Brand/Model")
                                    {
                                        ...
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tsb + "////" + tsm, "bybrand.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/bb/";
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"];
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                    ...
                                    {
                                        string[] StrValue = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);
                                        string path = string.Empty;
                                        if (StrValue.Length >= 4)
                                        {
                                            path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue[0] + "////" + StrValue[1] + "////" + StrValue[2] + "////" + StrValue[3]));
                                        }
                                        else if (StrValue.Length < 4)
                                        {
                                            path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue[0] + "////" + StrValue[1] + "////" + StrValue[2] ));  
                                        }

                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + path;
                                            //+ "&bname=" + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                        //string x = objHelperServices.SimpleURL_MS_Str(HttpContext.Current.Session["EA"].ToString(), "pl", false);

                                        string tempstrnew = objHelperServices.SimpleURL_Str(tempstr + "////" + tdrowitemvalue, "pl.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/"+tempstrnew + "/pl/";
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"];  //"categorylist.aspx" + tempstr;
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                    }
                                    else if (tdrowtemppath == "/Category/Brand")
                                    {
                                        tsb = td.Rows[i]["Itemvalue"].ToString();
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "ct.aspx?" + tempstr + "&bypcat=1&tsb=" + HttpUtility.UrlEncode(tsb);
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tempstr + "////" + tsb, "ct.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/"+tempstrnew + "/ct/";
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"]; //"categorylist.aspx" + tempstr;
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                    }
                                    else if (tdrowtemppath == "/Category/Brand/Model")
                                    {
                                        ...
                                        string tempstrnew = objHelperServices.SimpleURL_Str(tempstr + "////" + tsb + "////" + tsm, "bybrand.aspx", false);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/bb/";
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"];//"categorylist.aspx" + tempstr + "&bypcat=1&tsb=" + HttpUtility.UrlEncode(tsb);
                                        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                    }
                                    ...
                                    else if (tdrowtemppath.StartsWith("/Category/Brand/Model"))
                                    {
                                        if ((isProduct))
                                        {
                                            ...
                                            if (tdrowitemtypelwr == "product" && objhelper.CDEC(td.Rows[i]["Itemvalue"]) > 0)
                                            {
                                                ...
                                                string path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue1[0]));
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pd.aspx?" + tempstr + "&fid=" + familyid + "&pid=" + Productid + path;
                                                ...
                                                if (StrValue.Length >= 4)
                                                {
                                                    ...
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + productcode + "////" + StrValue[2] + "////" + StrValue[3] + "////" + td.Rows[i]["FamilyName"], "pd.aspx", false);

                                                }
                                                else
                                                {
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + productcode + "////" + td.Rows[i]["FamilyName"], "pd.aspx", false);
                                                }
                                                
                                             //   string tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + Productid + "=" + td.Rows[i]["Itemvalue"] + "////" + familyname, "productdetails.aspx", false);
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/pd/";

                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"]; //"bybrand.aspx" + tempstr + "&tsb=" + HttpUtility.UrlEncode(tsb) + "&tsm=" + HttpUtility.UrlEncode(tsb);
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                            }
                                        }
                                        else if ((isFamily))
                                        {
                                            if (tdrowitemtypelwr == "family")
                                            {
                                                string[] StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "UserSearch=Family Id=" }, StringSplitOptions.None);
                                                if (StrValue1.Length == 1)
                                                {
                                                    StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "UserSearch1=Family Id=" }, StringSplitOptions.None);
                                                ...
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx?" + tempstr + "&fid=" + familyid + path;
                                                ...
                                                if (StrValue.Length >= 4)
                                                {
                                                    ...
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + StrValue[2] + "////" + StrValue[3] + "////" + familyname, "fl.aspx", false);

                                                }
                                                else
                                                {

                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + familyname, "fl.aspx", false);
                                                }
                                            ...
                                            else
                                            {
                                                ...
                                                string path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue1[0]));
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx?" + tempstr + "&fid=" + familyid + "&tsb=" + HttpUtility.UrlEncode(tsb) + "&tsm=" + HttpUtility.UrlEncode(tsm) + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + path;
                                                string[] StrValue = StrValue1[0].Split(new string[] { "////" }, StringSplitOptions.None);
                                                string tempstrnew = string.Empty;
                                                if (StrValue.Length >= 4)
                                                {
                                                ...
                                                //string tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + familyname, "fl.aspx", false);
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/"+tempstrnew + "/fl/";
                                        ...
                                        {
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "bb.aspx?" + tempstr + "&tsb=" + HttpUtility.UrlEncode(tsb) + "&tsm=" + HttpUtility.UrlEncode(tsm) + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));

                                            string tempstrnew = objHelperServices.SimpleURL_Str(tsb + "////" + tsm + "////" + tdrowitemvalue, "bb.aspx", false);
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ tempstrnew + "/bb/";
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["RemoveUrl"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["TBT_REWRITEURL"]; //"bybrand.aspx" + tempstr + "&tsb=" + HttpUtility.UrlEncode(tsb) + "&tsm=" + HttpUtility.UrlEncode(tsb);
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_URL_REMOVE"] = YHSAndBC.Tables["YHSAndBC"].Rows[i - 1]["Url"];
                                        }
                                    ...
                                    else if (tdrowtemppath.StartsWith("/Category/Category") || tdrowtemppath.StartsWith("/Category/Family") || tdrowtemppath.StartsWith("/CableL") || tdrowtemppath.StartsWith("/Brand"))
                                    {
                                            ...
                                            if (tdrowitemtypelwr == "product" && objhelper.CDEC(td.Rows[i]["Itemvalue"]) > 0)
                                            {
                                              ...
                                              //  string tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + Productid + "=" + td.Rows[i]["Itemvalue"] + "////" + familyname, "productdetails.aspx", false);
                                                ...
                                                if (StrValue.Length >= 4)
                                                {
                                                    ...
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + productcode + "////" + StrValue[2] + "////" + StrValue[3] + "////" + familyname, "pd.aspx", false);

                                                }
                                                else
                                                {
                                                    tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + td.Rows[i]["Itemvalue"] + "=" + productcode + "////" + familyname, "pd.aspx", false);
                                                }
                                        ...
                                        else if ((isFamily))
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx?" + tempstr + "&fid=" + familyid + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + path;
                                              //  string tempstrnew = objHelperServices.SimpleURL_Str(familyid + "////" + familyname, "fl.aspx", false);
                                        ...
                                        else
                                        {
                                            ...
                                            // string tempstrnew = objHelperServices.SimpleURL_Str(tdrowitemvalue + "////" + tempstr, "pl.aspx", false);
                                            string x = HttpContext.Current.Request.RawUrl   ;
                                           // string x = objHelperServices.SimpleURL_Str(HttpContext.Current.Session["EA"].ToString(), "pl", false);
                                            string[] StrValue = x.Split(new string[] { "/" }, StringSplitOptions.None);
                                            Array.Reverse(StrValue);
                                            string TBT_REWRITEURL = string.Empty;

                                           

                                            if (i == YHSAndBC.Tables["YHSAndBC"].Rows.Count - 1)
                                            {
                                                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = HttpContext.Current.Request.RawUrl;
                                            }
                                            else
                                            {
                                      ...
                                      if (i==2)
                                      {
                                          TBT_REWRITEURL = StrValue[4] + "/" + StrValue[3] + "/" + StrValue[2] + "/" + StrValue[1] + "/";
                                      }
                                      else if (i==3)
                                      {

                                          TBT_REWRITEURL = StrValue[5] + "/" +StrValue[4] + "/" + StrValue[3] + "/" + StrValue[2] + "/" + StrValue[1] +"/";
                                      }
                                      else if (i == 4)
                                      {

                                          TBT_REWRITEURL = StrValue[6] + "/" + StrValue[5] + "/" + StrValue[4] + "/" + StrValue[3] + "/" + StrValue[2] + "/" + StrValue[1] + "/";
                                      }
                                      else if (i == 5)
                                      {

                                          TBT_REWRITEURL = StrValue[7] + "/" + StrValue[6] + "/" + StrValue[5] + "/" + StrValue[4] + "/" + StrValue[3] + "/" + StrValue[2] + "/" + StrValue[1] + "/";
                                      }
                                            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = TBT_REWRITEURL;     
                                            }

                                         
                                            string[] StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);

                                                   string path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue1[0] + "////" + StrValue1[1] + "////" + StrValue1[2] + "////" + StrValue1[3]));
                                            ...
                                            //    {
                                            //        if (StrValue[2].Contains("~") == false)
                                            //        {
                                            //            string[] StrValue1 = HttpContext.Current.Session["EA"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);

                                            //            string path = "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(StrValue1[0] + "////" + StrValue1[1] + "////" + StrValue1[2] + "////" + StrValue1[3]));

                                            //            if (tdrowtemppath == "/Brand")
                                            //            {
                                            //                tdrowitemvalue = tdrowitemvalue.Replace("brand", "");
                                                        
                                            //            }
                                            //            string x1 = objHelperServices.SimpleURL_Str(tdrowitemvalue, "pl", false);
                                            //            if (StrValue.Length == 3)
                                            //            {
                                            //                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/" + x1 + "/" + StrValue[1] + "/" + StrValue[2] + "/pl/";
                                            //            }
                                            //            else if (StrValue.Length >=4)
                                            //            {
                                            //                YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = "/" + x1 + "/" + StrValue[StrValue.Length - 4] + "/" + StrValue[StrValue.Length - 3] + "/pl/";
                                            //            }
                                            //            YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + path;
                                            ...
                                            //        else
                                            //        {
                                            //            YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] ="/"+ StrValue[3] + "/" + StrValue[4] + "/pl/";
                                            //            YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                            //        }
                                            //    }
                                            ...
                                            //    if (StrValue.Length == 2)
                                            //    {
                                            //        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = StrValue[0] + "/" + StrValue[1] + "/" + StrValue[2] + "/pl/";
                                            //        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue);
                                            ...
                                            //    else 
                                            //    {
                                            //        YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = StrValue[0] + "/" + StrValue[1] +"/pl/";
                                            //        YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&path=" + HttpUtility.UrlEncode(objSecurity.StringEnCrypt(HttpContext.Current.Session["EA"].ToString()));
                                            //    }
                                            //}
                                            //else
                                            //{
                                            //    YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "pl.aspx?" + tempstr + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(tdrowitemvalue);
                                            //    YHSAndBC.Tables["YHSAndBC"].Rows[i]["TBT_REWRITEURL"] = x + "/pl/";
                                            //}
                                            //"categorylist.aspx" + tempstr;
                                        }
                                    }
        ...
        //        {
        //            EA = HttpContext.Current.Session["EA"].ToString();
        //            //objErrorhandler.CreateLog("inside session EA CreateYouHaveSelectAndBreadCrumb" + EA);
        //        }
        //    }
        //    else
        //    {
        //        //objErrorhandler.CreateLog("inside  EAPATH CreateYouHaveSelectAndBreadCrumb" + EAPATH);
        //        EA = EAPATH;
        //    }
        ...
        //                                //else
        //                                //{
        //                                //    YHSAndBC.Tables["YHSAndBC"].Rows[i]["Url"] = "fl.aspx" + tempstr + "&fid=" + familyid + "&type=" + td.Rows[i]["ItemType"].ToString() + "&value=" + HttpUtility.UrlEncode(td.Rows[i]["Itemvalue"].ToString()) + "&bname=" + HttpUtility.UrlEncode(tsb) + "&searchstr=";
        ...
        //            //    && (IsFromBrand == false))
        //            //{
        //            ////else if ((row["ItemType"].ToString().ToLower() == "model") && (((HttpContext.Current.Request.Url.ToString().ToLower().Contains("fl.aspx")) && (IsFromBrand == false)) || (HttpContext.Current.Request.Url.ToString().ToLower().Contains("pl.aspx")) || ((HttpContext.Current.Request.Url.ToString().ToLower().Contains("productdetails.aspx")) && (IsFromBrand == false)) || (HttpContext.Current.Request.Url.ToString().ToLower().Contains("ps.aspx"))))
        //            ////{
        //            //    _stmpl_records.SetAttribute("TBT_LINKNAME", row["ItemValue"].ToString());
        ...
        public DataTable GetMainMenuClickDetailJson(string Cid, string ReturnType,bool chkExists)
        {
            ...
            try
            {
              ...
              //  tmptbl = GetCategoryAndBrand("MainCategory").Tables[0].Select("CATEGORY_ID='" + Cid + "'").CopyToDataTable();
                tmptbl = GetCategoryAndBrand_Applicationstart("MainCategory").Tables[0].Select("CATEGORY_ID='" + Cid + "'").CopyToDataTable();
                if (tmptbl != null && tmptbl.Rows.Count > 0)
                {
                    CatName = tmptbl.Rows[0]["CATEGORY_NAME"].ToString();
                }
                ...
                if ((blnGetData))
                {
                    ...
                    if (CatName != string.Empty)
                    {
                        ...
                        Fil = new System.IO.FileInfo(strxml + "\\" + Cid + ".txt");
                        Fil1 = new System.IO.FileInfo(strxml + "\\" + Cid + "_Att.txt");
                     ...
                     //       Menu_Category.ReadXml(strxml + "\\" + Cid + ".xml");
                           ...
                           // Attds = JsonConvert.DeserializeObject<DataSet>(o2.ToString());
                            ...
                            using (StreamReader cidattrtxt = File.OpenText(strxml + "\\" + Cid + "_Att.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(cidattrtxt))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                                    Attds = (DataSet)serializer.Deserialize(cidattrtxt, typeof(DataSet));
                                    reader.Close();
                                }
                                cidattrtxt.Dispose();
                            }
                     ...
                     //Attds.ReadXml(strxml + "\\" + Cid + "_Att.xml");
                      ...
                      // objErrorhandler.CreateLog("Categoryinside Easyask" + Cid);
                           ...
                           // Menu_Category.WriteXml(strxml + "\\" + Cid + ".xml");
                            ...
                            if (HttpContext.Current.Session["Category_Attributes"] != null)
                            {
                              ...
                              //  Attds.WriteXml(strxml + "\\" + Cid + "_Att.xml");
                                    string json = JsonConvert.SerializeObject(Attds);
                                    System.IO.File.WriteAllText(strxml + "\\" + Cid + "_Att.txt", json);
                            }
                         }
                    }
                }
                        ...
                        if ((Fil.Exists) && (Fil1.Exists) && (chkExists))
                        {
                         ...
                         //   Menu_Category = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                          ...
                          //  Attds = JsonConvert.DeserializeObject<DataSet>(o2.ToString());
                            ...
                            using (StreamReader cidattrtxt = File.OpenText(strxml + "\\" + Cid + ".txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(cidattrtxt))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
        ...
        public DataTable GetSubMenuClickDetailJson(string Cid, string ReturnType, bool chkExists)
        {
            ...
            try
            {
              ...
              //  tmptbl = GetCategoryAndBrand("SubCategory").Tables[0].Select("CATEGORY_ID='" + Cid + "'").CopyToDataTable();
                tmptbl = GetCategoryAndBrand_Applicationstart("SubCategory").Tables[0].Select("CATEGORY_ID='" + Cid + "'").CopyToDataTable();
                if (tmptbl != null && tmptbl.Rows.Count > 0)
                {
                    CatName = tmptbl.Rows[0]["CATEGORY_NAME"].ToString();
                }
                ...
                if (blnGetData == true)
                {
                    ...
                    if (CatName != "")
                    {
                        ...
                        if (Fil.Exists == true && Fil1.Exists == true && chkExists == true)
                        {
                          ...
                          //  JObject o2 = JObject.Parse(File.ReadAllText(strxml + "\\" + Cid + ".txt"));
                           // Attds = JsonConvert.DeserializeObject<DataSet>(o2.ToString());
                        ...
                        else
                        {
                          ...
                          //To get correct attribute count
                            IRemoteEasyAsk ea = Impl.RemoteFactory.create(EasyAsk_URL, EasyAsk_Port, EasyAsk_WebCatDictionary);
                            IOptions opts = ea.getOptions();
                            opts.setResultsPerPage("1");
                            opts.setSortOrder(m_sort.Equals("-default-") ? "" : m_sort);
                           ...
                           // Menu_Category.WriteXml(strxml + "\\" + Cid + ".xml");
                            ...
                            if (HttpContext.Current.Session["Category_Attributes"] != null)
                            {
                                Attds = (DataSet)HttpContext.Current.Session["Category_Attributes"];
                              //  Attds.WriteXml(strxml + "\\" + Cid + "_Att.xml");
                                string Attdscid = JsonConvert.SerializeObject(Attds);
                                System.IO.File.WriteAllText(strxml + "\\" + Cid + "_Att.txt", Attdscid);
                            }
                        }
                    }
                }
        ...
        private void BuildMainAndSubCategoryTableJson(INavigateResults res, string CatName, string CatId, DataSet ds)
        {
            ...
            Menu_Main_Category.Columns.Add("CUSTOM_NUM_FIELD3", typeof(string));
            Menu_Main_Category.Columns.Add("EA_PATH", typeof(string));
            Menu_Main_Category.Columns.Add("PRODUCT_COUNT", typeof(string));
            // Sub_Category
            //To check Indu
            Menu_Category.Tables.Add(Menu_Sub_Category);
            Menu_Sub_Category.Columns.Add("PARENT_CATEGORY_ID", typeof(string));
            ...
            try
            {
                if (ds != null && ds.Tables.Count > 0 && ds.Tables["CategoryList"] != null && ds.Tables["CategoryList"].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow item in ds.Tables["CategoryList"].Rows)
                    {
                        ...
                        row["CUSTOM_NUM_FIELD3"] = "2";
                        row["EA_PATH"] = HttpContext.Current.Session["EA"].ToString();
                        row["PRODUCT_COUNT"] = item["productcount"].ToString();
        ...
        public DataSet GetCategoryAttributeJson( INavigateResults res, string temptext, string searchString, DataSet Dssdv)
        {
            ...
            {   // If any brand in ea path 
                ...
                if (Dssdv != null && Dssdv.Tables[0].Rows.Count > 0)
                {
                    try
                    {
                        _parentCatID = Dssdv.Tables["categories"].Rows[0][2].ToString();
                    }
                    catch (Exception ex)

                    {
                       // objErrorhandler.CreateLog(Dssdv.Tables.Count + "Table count");
                    }
                }
               ...
               // DataRow[] dr = ((DataSet)HttpContext.Current.Session["MainCategory"]).Tables[0].Select("CATEGORY_ID='" + _parentCatID + "'");
                ...
                DataRow[] dr = mainds.Tables[0].Select("CATEGORY_ID='" + _parentCatID + "'");
                if (dr.Length > 0)
                {
                ...
                if (Dssdv != null && Dssdv.Tables.Count > 0 && Dssdv.Tables["CategoryList"] != null && Dssdv.Tables["CategoryList"].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow item in Dssdv.Tables["CategoryList"].Rows)
                    {
                        ...
                        row["CATEGORY_ID"] = catid;
                        row["Category_Name"] =  item["name"].ToString();
                       // objErrorhandler.CreateLog(row["Category_Name"].ToString());
                        row["Product_Count"] = item["productcount"];
                       // objErrorhandler.CreateLog(row["Product_Count"].ToString());
                        row["brandvalue"] = temptext;
                        row["SearchString"] = searchString;
                        row["CUSTOM_TEXT_FIELD1"] = DateTime.Now.AddDays(-356);
                        row["select"] = "";
            ...
            try
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (HttpContext.Current.Session["YHSCell_dt"] != null)
                    {
                        ...
                        //objErrorhandler.CreateLog("YHSCell_dt" + dt.Rows.Count);
                        for (i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            if (i == dt.Rows.Count - 1)
                            {
                                if(dt.Rows[i]["TBW_ITEM_TYPE"].ToString() == "Item Product")
                                   ...
                                   _stmpl_records.SetAttribute("TBT_LINKNAME", dt.Rows[i]["TBW_ITEM_NAME"].ToString().ToLower());
                            }
                            else
                                _stmpl_records.SetAttribute("TBT_LINKNAME", dt.Rows[i]["TBW_ITEM_NAME"].ToString().ToLower());
                    ...
                    //        _stmpl_records.SetAttribute("TBT_LINKNAME", textInfo.ToTitleCase(dt.Rows[i]["TBW_ITEM_NAME"].ToString().ToLower()));
                            ...
                            _stmpl_records.SetAttribute("TBT_URL", dt.Rows[i]["URL"].ToString());
    ...
    objErrorhandler.CreateLog(ex.ToString());
            ...
            if (dsb != null && dsb.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i <= dsb.Tables[0].Rows.Count - 1; i++)
                {
                    ...
                    else if (row["ItemType"].ToString().ToLower() == "product")
                    {
                        ...
                        {
                            _stmpl_records.SetAttribute("TBT_LINKNAME", row["ItemValue"].ToString().ToLower());
                            //_stmpl_records.SetAttribute("TBT_LINKNAME", textInfo.ToTitleCase(HttpUtility.UrlEncode(row["ItemValue"].ToString()).ToLower()));
                            Itemvalue = row["ItemType"].ToString() + "=" + HttpUtility.UrlEncode(row["ItemValue"].ToString());
                        }
                    }
        ...
        public void Create_NewProducts_Json()
        {
            ...
            dtAllProducts.TableName = "AllProducts";
            dtAllProducts.Columns.Add("Product_id");
            ...
            for (int i = 0; i < tmpds.Tables[0].Rows.Count; i++)
            {
                if (i == 0)
                {
                    prodid = tmpds.Tables[0].Rows[i]["Product_id"].ToString();
                }
                else
                {
                    prodid = prodid + "," + tmpds.Tables[0].Rows[i]["Product_id"].ToString();
            ...
            DataRow dr = dtAllProducts.NewRow();
            dr[0] = prodid;
            dtAllProducts.Rows.Add(dr);


            tmpds.Tables.Add(dtAllProducts);
        ...
        public void CreateProductTag_Json()
        {

            try
            {

                DataSet tmpds = objhelperDb.GetProductTag("All");
                 DataTable distinctValues = tmpds.Tables[0];
                DataTable dtAllProducts = new DataTable();

                dtAllProducts.TableName = "AttributesJson";
                dtAllProducts.Columns.Add("URLAttr");
                dtAllProducts.Columns.Add("AttrValue");
              
          
                for (int i = 0; i <= distinctValues.Rows.Count - 1; i++)
                {
                    DataRow dr = dtAllProducts.NewRow();
                    string URLAttr = objhelper.SimpleURL_Str(distinctValues.Rows[i][0].ToString(), "pl", false);
                    if (URLAttr.Contains('-'))
                    {
                        dr[0] = URLAttr;
                        dr[1] = distinctValues.Rows[i][0].ToString();
                       
                        dtAllProducts.Rows.Add(dr);
                    }

                }
                   DataRow dr1 = dtAllProducts.NewRow();
                   string URLAttr1 = objhelper.SimpleURL_Str("Under $5", "pl", false);
                     dr1[0] = URLAttr1;
                        dr1[1] = "Under $5";                       
                        dtAllProducts.Rows.Add(dr1);

                dr1 = dtAllProducts.NewRow();
                URLAttr1 = objhelper.SimpleURL_Str("$5 - $10", "pl", false);
                     dr1[0] = URLAttr1;
                        dr1[1] = "$5 - $10";
                        dtAllProducts.Rows.Add(dr1);

                dr1 = dtAllProducts.NewRow();
                URLAttr1 = objhelper.SimpleURL_Str("$10 - $20", "pl", false);
                     dr1[0] = URLAttr1;
                     dr1[1] = "$10 - $20";            
                        dtAllProducts.Rows.Add(dr1);

                dr1 = dtAllProducts.NewRow();
                URLAttr1 = objhelper.SimpleURL_Str("$20 - $30", "pl", false);
                     dr1[0] = URLAttr1;
                     dr1[1] = "$20 - $30";                         
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$30 - $40", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$30 - $40";
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$40 - $50", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$40 - $50";
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$50 - $60", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$50 - $60";
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$60 - $70", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$60 - $70";
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$70 - $80", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$70 - $80";
                        dtAllProducts.Rows.Add(dr1);

                        dr1 = dtAllProducts.NewRow();
                        URLAttr1 = objhelper.SimpleURL_Str("$80 - $90", "pl", false);
                        dr1[0] = URLAttr1;
                        dr1[1] = "$80 - $90";
                        dtAllProducts.Rows.Add(dr1);
                        ...
                        DataSet newds = new DataSet();
                         newds.Tables.Add(dtAllProducts);

                         string jsoncid = JsonConvert.SerializeObject(newds);
                        System.IO.File.WriteAllText(strxml + "\\" + "Prod_Tag.txt", jsoncid);
            }
            catch (Exception ex)
            {
                objErrorhandler.CreateLog(ex.ToString());
        ...
        public void CreateAttributeID_JSON()
        {

            try
            {

                DataSet tmpds = objhelperDb.GetDataSetDB("exec [GetAttributeID_JSON] ");

                string jsoncid = JsonConvert.SerializeObject(tmpds);
                System.IO.File.WriteAllText(strxml + "\\" + "AttributeID.txt", jsoncid);
            }
            catch (Exception ex)
            {
                objErrorhandler.CreateLog(ex.ToString());
        ...
        public void CreateAttributeDetails_JSON()
        {

            try
            {

                DataSet tmpds = objhelperDb.GetDataSetDB("exec [GetAttributeDetails_JSON] ");
                ...
                dtAllProducts.Columns.Add("URLAttr");
                dtAllProducts.Columns.Add("AttrValue");
                dtAllProducts.Columns.Add("AttrName");
                dtAllProducts.Columns.Add("AttrId");
                for (int i = 0; i <= distinctValues.Rows.Count-1; i++)
                {
                    DataRow dr = dtAllProducts.NewRow();
                    string URLAttr = objhelper.SimpleURL_Str(distinctValues.Rows[i]["string_value"].ToString(), "pl", false);
                    if (URLAttr.Contains('-'))
                    {
                        dr[0] = URLAttr;
                        dr[1] = distinctValues.Rows[i]["string_value"].ToString();
                        dr[2] = distinctValues.Rows[i]["ATTRIBUTE_NAME"].ToString();
                        dr[3] = distinctValues.Rows[i]["attribute_id"].ToString();
                        dtAllProducts.Rows.Add(dr);
                    }
                ...
                string jsoncid = JsonConvert.SerializeObject(newds);
                System.IO.File.WriteAllText(strxml + "\\" + "Attributes.txt", jsoncid);
            }
            catch (Exception ex)
            {
                objErrorhandler.CreateLog(ex.ToString()); 
        ...
        public void Create_PopularProducts_Json()
        {
           ...
           // DataTable distinctValues = view.ToTable(true, "product_id");
            ...
            DataTable dtnew = new DataTable();
            //   DataTable dtdistinctproduct = new DataTable(); 
            for (int i = 0; i < distinctValues.Rows.Count; i++)
            {
                if (i == 0)
                {
                    prodid = distinctValues.Rows[i]["Product_id"].ToString();
                }
                else if (prodid.Contains(distinctValues.Rows[i]["Product_id"].ToString()) == false)
                {
                    prodid = prodid + "," + distinctValues.Rows[i]["Product_id"].ToString();
                }
                //  DataRow[] foundRows = tmpds.Tables[0].Select("Product_id = '" + tmpds.Tables[0].Rows[i]["Product_id"].ToString() + "'");
                //  dtnew = foundRows.CopyToDataTable();

                // DataRow drnew = dtnew.Rows[0];
                // dtnew = dtnew;
                //dtdistinctproduct.Rows.Clear();
                // dtdistinctproduct.Rows.Add(); 
                //for (int k = 0; k < dtnew.Columns.Count; k++)
                //{
                //    dtdistinctproduct.Rows[i].BeginEdit();  
                //    dtdistinctproduct.Rows[i][k] = drnew[k].ToString();
                //    dtdistinctproduct.Rows[i].EndEdit();  
                //}
            ...
            //tmpds.Tables.Add(dtnew);
            //newds.Tables.Add(dtdistinctproduct);

            string jsoncid = JsonConvert.SerializeObject(tmpds);
            System.IO.File.WriteAllText(strxml + "\\" + "PopularProducts.txt", jsoncid);

        }
        public void Create_PRICE_EA_Json()
        {
            ...
            DataSet tmpds = objhelperDb.GetDataSetDB("select * from VIEW_PICKFPRODUCTPRICE_EA" );
            ...
            if (tmpds != null)
            {
                ...
                string jsoncid = JsonConvert.SerializeObject(tmpds);
                System.IO.File.WriteAllText(strxml + "\\" + "PRICE_EA.txt", jsoncid);
            }

        }
        public void Create_PopularSEARCH_Json()
        {
            ...
            DataSet tmpds = objhelperDb.GetDataSetDB("exec [STP_TBWC_PICK_POPULAR_SEARCH] 0," + userid);
            ...
            DataTable dtAllProducts = new DataTable();
            dtAllProducts.TableName = "AllProducts";
            dtAllProducts.Columns.Add("FAMILY_NAME");
            ...
            string jsoncid = JsonConvert.SerializeObject(tmpds);
            System.IO.File.WriteAllText(strxml + "\\" + "PopularSearch.txt", jsoncid);
        ...
        public DataSet   GetCategoryAndBrand(string ReturnType, bool CreateXml)
        {
            try
            {
                ...
                string CategoryMenutxt = JsonConvert.SerializeObject(CategoryMenu);
                System.IO.File.WriteAllText(strxml + "\\" + "subCatAll.txt", CategoryMenutxt);

                string SubCategorytxt = JsonConvert.SerializeObject(SubCategory);
                System.IO.File.WriteAllText(strxml + "\\" + "subds.txt", SubCategorytxt);

                string MainCategorytxt = JsonConvert.SerializeObject(MainCategory);
                System.IO.File.WriteAllText(strxml + "\\" + "Mainds.txt", MainCategorytxt);
        ...
        public DataSet GetCategoryAndBrand_Applicationstart(string ReturnType)
        {
                ...
                try
                {
                    ...
                    {
                        DataSet main = GetCategoryAndBrand("", true);
                        ...
                        if (main != null && main.Tables.Count > 0 && main.Tables[0].Rows.Count > 0)
                        {
                            ...
                            {
                               GetMainMenuClickDetailJson(main.Tables[0].Rows[i]["CATEGORY_ID"].ToString(), "", false);

                            }
                        }
                      Create_NewProducts_Json();
                      Create_PopularProducts_Json();
                    }
                    ...
                    if (ReturnType == "SubCategoryAll")
                    {
                        using (StreamReader subCatAll = File.OpenText(strxml + "\\" + "subCatAll.txt"))
                        {
                            using (JsonReader reader = new JsonTextReader(subCatAll))
                            {
                                JsonSerializer serializer = new JsonSerializer();

                                // read the json from a stream
                                // json size doesn't matter because only a small piece is read at a time from the HTTP request
                                CategoryMenu = (DataSet)serializer.Deserialize(subCatAll, typeof(DataSet));
                    ...
                    if (ReturnType == "Mainds_Sort")
                    {
                        string strxml1 = HttpContext.Current.Server.MapPath("xml_sort");
                        // System.IO.FileInfo Fil1 = new System.IO.FileInfo(strxml + "\\Mainds_Sort.xml");
                        DataSet dsrecords_dup = new DataSet();
                        dsrecords_dup.ReadXml(strxml1 + "\\Mainds_Sort.xml");
                        return dsrecords_dup;
                    }
                    ...
                    if (ReturnType == "New Products")
                    {
                        ...
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "NewProducts.txt"));
                            // tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                     
                            using (StreamReader dsnewpds = File.OpenText(strxml + "\\" + "NewProducts.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dsnewpds))
                                {
                                    JsonSerializer serializer = new JsonSerializer();

                                    // read the json from a stream
                                    // json size doesn't matter because only a small piece is read at a time from the HTTP request
                                    Newds = (DataSet)serializer.Deserialize(dsnewpds, typeof(DataSet));
                                    reader.Close();
                                }
                                dsnewpds.Dispose();
                            }
                    ...
                    if (ReturnType == "PopularProducts")
                    {
                        DataSet Populards = new DataSet(); 
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dspopular = File.OpenText(strxml + "\\" + "PopularProducts.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dspopular))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                                    Populards = (DataSet)serializer.Deserialize(dspopular, typeof(DataSet));
                                    reader.Close();
                                }
                                dspopular.Dispose();
                            }
                    ...
                    if (ReturnType == "AttributeIDJson")
                    {
                        DataSet AttrIDJson = new DataSet();
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dspopular = File.OpenText(strxml + "\\" + "AttributeID.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dspopular))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                                    AttrIDJson = (DataSet)serializer.Deserialize(dspopular, typeof(DataSet));
                                    reader.Close();
                                }
                                dspopular.Dispose();
                            }
                    ...
                    if (ReturnType == "AttributeValueJson")
                    {
                        DataSet AttrIDJson = new DataSet();
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dspopular = File.OpenText(strxml + "\\" + "Attributes.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dspopular))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                    ...
                    if (ReturnType == "ProductTagJson")
                    {
                        DataSet PTJson = new DataSet();
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dsproduct = File.OpenText(strxml + "\\" + "Prod_Tag.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dsproduct))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                                    PTJson = (DataSet)serializer.Deserialize(dsproduct, typeof(DataSet));
                                    reader.Close();
                                }
                                dsproduct.Dispose();
                            }
                        ...
                        {
                            CreateProductTag_Json();
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            // tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dspopular = File.OpenText(strxml + "\\" + "Prod_Tag.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dspopular))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                                    PTJson = (DataSet)serializer.Deserialize(dspopular, typeof(DataSet));
                                    reader.Close();
                                }
                                dspopular.Dispose();
                            }
                    ...
                    if (ReturnType == "Models")
                    {
                        ...
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dsproduct = File.OpenText(strxml + "\\" + "models.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dsproduct))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                    ...
                    if (ReturnType == "Brands")
                    {
                        ...
                        try
                        {
                            // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                            //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                            using (StreamReader dsproduct = File.OpenText(strxml + "\\" + "Brands.txt"))
                            {
                                using (JsonReader reader = new JsonTextReader(dsproduct))
                                {
                                    JsonSerializer serializer = new JsonSerializer();
                    ...
                    //        // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                    //        //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                    //        using (StreamReader dspopular = File.OpenText(strxml + "\\" + "PopularSearch.txt"))
                    //        {
                    //            using (JsonReader reader = new JsonTextReader(dspopular))
                    //            {
                    //                JsonSerializer serializer = new JsonSerializer();
                    ...
                    //        // o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "PopularProducts.txt"));
                    //        //  tmpds = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                    //        using (StreamReader dspopular = File.OpenText(strxml + "\\" + "autocomplete.txt"))
                    //        {
                    //            using (JsonReader reader = new JsonTextReader(dspopular))
                    //            {
                    //                JsonSerializer serializer = new JsonSerializer();
        ...
        public DataSet GetCategoryAndBrand(string ReturnType)
        {
            ...
            if (HttpContext.Current.Session["MainCategory"] == null || HttpContext.Current.Session["SubCategory"] == null || HttpContext.Current.Session["SubCategoryAll"] == null)
            {
                //System.IO.FileInfo Fil = new System.IO.FileInfo(strxml + "\\subds.txt");
                //System.IO.FileInfo Fil1 = new System.IO.FileInfo(strxml + "\\Mainds.txt");
                //System.IO.FileInfo Fil2 = new System.IO.FileInfo(strxml + "\\subCatAll.txt");
               ...
               // JObject o1;
                ...
                try
                {
                    //o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "subds.txt"));
                    //SubCategory = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                    //o1 = null;
                    //o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "Mainds.txt"));
                    //MainCategory = JsonConvert.DeserializeObject<DataSet>(o1.ToString());

                    //o1 = JObject.Parse(File.ReadAllText(strxml + "\\" + "subCatAll.txt"));
                    //CategoryMenu = JsonConvert.DeserializeObject<DataSet>(o1.ToString());
                 //   using (Stream s = JObject.Parse(File.ReadAllText(strxml + "\\" + "subds.txt")))
                    using (StreamReader subds = File.OpenText(strxml + "\\" + "subds.txt"))
                    {
                        using (JsonReader reader = new JsonTextReader(subds))
                        {
                ...
                //SubCategory.ReadXml(strxml + "\\subds.txt");
                //MainCategory.ReadXml(strxml + "\\Mainds.txt");
                //CategoryMenu.ReadXml(strxml + "\\subCatAll.txt");
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables["CategoryList"] != null && ds.Tables["CategoryList"].Rows.Count > 0)
                {
                    ...
                    if (subdt != null && subdt.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow item1 in subdt.Rows)
                        {
                            ...
                            {
                                //Modified by indu
                                        //To check category contains family
                                        DataTable dtchfamily = objCategoryServices.CheckFamilyExist(2,item1["CATEGORY_ID"].ToString());

                                        if (dtchfamily != null && dtchfamily.Rows[0][0].ToString() != "0")
                                        {
    ...
    querystring.Contains("/mps/"))
        ...
        private DataTable Get_Family_Product_ValuesJson(string DataType, DataTable ds, INavigateResults res, IResultRow item1, String name, DataSet Dssdv,string attributetype,string attributevalue)
        {
            ...
            try
            {
                ...
                if (Dssdv != null && Dssdv.Tables.Count > 0 && Dssdv.Tables["items"] != null && Dssdv.Tables["items"].Rows.Count > 0)
                {
                   ...
                   // ds.Columns.Add("CATEGORY_PATH", typeof(string));
                    ...
                    foreach (DataRow dr in ds.Rows)
                    {
                        ...
                        if (dr["isPromotion"] == "")
                            ...
                            //DataSet tmpds = objhelperDb.GetDataSetDB("exec [STP_GETFAMILY_STARTING_PRICE] " + userid + ",'" + dr["FAMILY_ID"] + "',3");
                    
                            //if (tmpds != null && tmpds.Tables[0].Rows.Count > 0)
                            //{
                            //  //  objErrorhandler.CreateLog("after familyid easyask" + tmpds.Tables[0].Rows[0][0].ToString() +"familyid"+ dr["FAMILY_ID"] );
                    ...
                    try
                    {
                        string fidtmpstr = tmpstr.Replace("'", "");
                        string fidtmpstr_1 = fidtmpstr.Substring(0, fidtmpstr.Length - 1);
                        //objErrorhandler.CreateLog("exec [STP_GETFAMILY_STARTING_PRICE_WAGNER] " + userid + ",'" + fidtmpstr_1 + "',3");
                        DataSet tmpds = objhelperDb.GetDataSetDB("exec [STP_GETFAMILY_STARTING_PRICE_WAGNER] " + userid + ",'" + fidtmpstr_1 + "',3");
                        ...
                        || (httpurl.Contains("mpl.aspx")))
                    {
                        ...
                        if (tmpstr != string.Empty)
                        {
                          ...
                          //  objErrorhandler.CreateLog(strsupplierId + "supplier id"); 
                            if (strsupplierId != "")
                 ...
                 //   objErrorhandler.CreateLog(httpurl+attributetype);
                    try
                    {
                        if (httpurl.Contains("ps.aspx"))
                        {
                            ...
                            else if (attributetype.ToLower() == "category")
                            {
                                ...
                                if (tmpstr != string.Empty)
                                {
                                    ...
                                    //  objErrorhandler.CreateLog(tmpstr + attributevalue + param3);
                                ...
                                //objErrorhandler.CreateLog("CATEGORY_Name=" + attributevalue);
                                //if (HttpContext.Current.Session["MainCategory"] != null)
                                //{
                                //    tmptbl = ((DataSet)HttpContext.Current.Session["MainCategory"]).Tables[0];
                                //    objErrorhandler.CreateLog("CATEGORY_Name=" + attributevalue);
                                //    objErrorhandler.CreateLog(tmptbl.Rows[0][0].ToString()); 
                                //    DataRow[] dr = tmptbl.Select("CATEGORY_Name='" + attributevalue + "'");
                                //    if (dr.Length > 0)
                                //    {
                                //        rtntbl = dr.CopyToDataTable();
                                //        strsupplierId = rtntbl.Rows[0]["CATEGORY_ID"].ToString();
                                //        objErrorhandler.CreateLog(strsupplierId);
                                //        Sqltb = (DataTable)objhelperDb.GetGenericDataDB(WesCatalogId, tmpstr, strsupplierId, "GET_FAMILY_PS_CATEGORY", HelperDB.ReturnType.RTTable);
                                //    }
                                //    else
                                //    {
                                //        tmptbl = ((DataSet)HttpContext.Current.Session["SubCategory"]).Tables[0];
                                //        objErrorhandler.CreateLog("CATEGORY_Name=" + attributevalue);
                                //        DataRow[] drsub = tmptbl.Select("CATEGORY_Name='" + attributevalue + "'");
                                //        if (drsub.Length > 0)
                                //        {
                                //            rtntbl = dr.CopyToDataTable();
                                //            strsupplierId = rtntbl.Rows[0]["CATEGORY_ID"].ToString();
                                //            objErrorhandler.CreateLog(strsupplierId+"subcat");
                                //            Sqltb = (DataTable)objhelperDb.GetGenericDataDB(WesCatalogId, tmpstr, strsupplierId, "GET_FAMILY_CATEGORY", HelperDB.ReturnType.RTTable);
                                //        }
                                //    }
                    ...
                    //DataTable duplicates = ds;

                    //duplicates.Rows.Clear();
                    //objErrorhandler.CreateLog(duplicates.Rows.Count + "duplicates Row count after clear" +ds.Rows.Count +"ds count" );
                                ...
                                foreach (DataRow dr in Sqltb.Rows)
                                {
                                    foreach (DataRow dr1 in ds.Rows)
                                    {
                                        if (dr["PRODUCT_ID"].ToString().ToUpper() == dr1["PRODUCT_ID"].ToString().ToUpper())
                                        {
                                            ...
                                            //if (httpurl.Contains("ps.aspx"))
                                            //{
                                            //    if (( dr1["PARENT_CATEGORY_ID"].ToString().Contains("SPF-") ||
                                            //          dr1["CATEGORY_ID"].ToString().Contains("SPF-")) || dr1["CATEGORY_PATH"].ToString().ToUpper().Contains("SUPPLIER PRODUCT FEED"))
                                            //    {

                                            //   objErrorhandler.CreateLog(dr["PRODUCT_ID"].ToString().ToUpper() + "--pcid=" + dr1["PARENT_CATEGORY_ID"].ToString() + "--cid=" + dr1["CATEGORY_ID"].ToString());
                                            //     //   duplicates.Rows.Add(dr1);  
                                            //       // ds.Rows.Remove(dr1);
                                            //    }
                                            //}
                    ...
                    //objErrorhandler.CreateLog(duplicates.Rows.Count + "duplicates Row count");
                    //foreach (DataRow row in duplicates.Rows)
                    //{
                    //    objErrorhandler.CreateLog(duplicates.Rows.Count + "duplicates Row count"+ ds.Rows.Count +"ds count");
                    //    ds.Rows.Remove(row);
                    //}
                ...
                //    }
                    ...
                    {
                        objErrorhandler.CreateLog(ex1.ToString());   
                    }


                    try
                    {
                      //  string flyid_del = System.Configuration.ConfigurationManager.AppSettings["DEL_FID"].ToString();
                        string pid_del = System.Configuration.ConfigurationManager.AppSettings["DEL_PID"].ToString();
                       // DataRow[] rowsdel = ds.Select("PRODUCT_ID=" + pid_del + "AND Family_Id=" + flyid_del);
                        DataRow[] rowsdel = ds.Select("PRODUCT_ID=" + pid_del);
                        if (rowsdel.Length > 0)
                        {
                            foreach (DataRow rdel in rowsdel)
                                rdel.Delete();
                        }
                    }
                    catch (Exception ex)
        ...
        {
            //objErrorhandler.CreateLog("inside Get_FamilyPage_Product_ValuesJson");
                ...
                if (last >= 0)
                {
                  ...
                  //  _ProductPrice = drs["Price"].ToString();//res.getCellData(0, colProductPrice);
                    ...
                    if (tmpstr != "")
                    {
                        ...
                        //DataSet tmpds1 = objhelperDb.GetDataSetDB("exec [STP_GETFAMILY_XML] " + tmpstr);
                        ...
                        //        DataSet dsgetleftattr = objhelperDb.GetDataSetDB("exec [STP_Attribute_name] '" + x + "'," + tmpstr + "");
                        //    }
                   ...
                   // string tmpfamily_ids = "";
                    ...
                    foreach (DataRow Dr in ds.Rows)
                    {
                        ...
                        //DataSet tmpds = objhelperDb.GetDataSetDB("exec [STP_GETFAMILY_STARTING_PRICE] " + userid + ",'" + Dr["FAMILY_ID"] + "'");

                        //  if (tmpds != null && tmpds.Tables[0].Rows.Count > 0)
                        //  {
                        //      Dr["MIN_PRICE"] = tmpds.Tables[0].Rows[0][0].ToString();
                        //  }
                        //if (Dr["PRODUCT_PRICE"].ToString() == "" || Dr["PRODUCT_PRICE"].ToString() == string.Empty)
                        //    Dr["PRODUCT_PRICE"] = "0";
                        //else
                    ...
                    if (tmpstr != string.Empty)
                    {
                        ...
                        //strfamilyids
                        DataSet Sqltbs = objhelperDb.GetProductPriceEA("", tmpstr, userid);
                            ...
                            foreach (DataRow dr in Sqltbs.Tables[0].Rows)
                            {
                                foreach (DataRow dr1 in ds.Rows)
                                {
                                    if (dr["PRODUCT_ID"].ToString().ToUpper() == dr1["PRODUCT_ID"].ToString().ToUpper())
                                    {
                                        // dr1["QTY_AVAIL"] = dr["QTY_AVAIL"];
                                        // dr1["MIN_ORD_QTY"] = dr["MIN_ORD_QTY"];
                                        // objErrorhandler.CreateLog(dr["PROD_STK_STATUS_DSC"].ToString() + "---" + dr["PRODUCT_ID"].ToString() + "---" + dr["PROD_STOCK_STATUS"].ToString() + "--stflag--" + dr["PROD_STOCK_FLAG"].ToString());
                                        if ((dr["PROD_STK_STATUS_DSC"] != null))
                                        {
                                            dr1["STOCK_STATUS_DESC"] = dr["PROD_STK_STATUS_DSC"].ToString().Trim();
                                        }
                                        if ((dr["PROD_SUBSTITUTE"].ToString() == "") || (dr["PROD_SUBSTITUTE"].ToString() == null))
                                        {
                                            dr1["PROD_STOCK_STATUS"] = dr["PROD_STOCK_STATUS"].ToString().Trim();

                                        }
                                        dr1["PROD_STOCK_FLAG"] = dr["PROD_STOCK_FLAG"].ToString().Trim();
       ...
       string _fmly_Image = null;
            ...
            try
            {
             ...
             _fmly_Image = "";// Dr["Family_Thumbnail"].ToString();//res.getCellData(0, colFmlyImg).ToString();
                    ...
                    string temp_fmly_Image = Dr["Family_Thumbnail"].ToString();// Dr["Family_Thumbnail"].ToString();//res.getCellData(0, colFmlyImg).ToString();
                  ...
                  //  string sqlexec = "exec STP_TBWC_PICKGENERICDATA '" + WesCatalogId + "','" + tmpstr + "','','','','GET_SINGLE_PRODUCT_INVENTORY','" + websiteid + "'";
                   ...
                   string sqlexec = "exec STP_TBWC_PICKFPRODUCTPRICE_EA '','" + tmpstr + "','" + userid + "'";
                    /* new */
                  // string sqlexec = "exec STP_TBWC_PICKFPRODUCTPRICE_EA_WAGNER '','" + tmpstr + "','" + userid + "'";
                  ...
                  // tmpstr = ((_subFamID == "") ? _FamID : _subFamID).ToString();
                   //sqlexec = sqlexec + ";exec STP_TBWC_PICKGENERICDATA '" + WesCatalogId + "','" + Dr["Prod_Id"].ToString() + "','" + tmpstr + "','','','GET_PRODUCT_ATTRIBUTE_WAGNER','" + websiteid + "'";
                            ...
                            if (tmpstr != "")
                            {
                              ...
                              //  else
                               //     Sqltb = (DataTable)objhelperDb.GetGenericDataDB(WesCatalogId, tmpstr, "1", "GET_FAMILY_ATTRIBUTE", HelperDB.ReturnType.RTTable);
                                ...
                                if (Sqltb != null && Sqltb.Rows.Count > 0)
                                {
                                    DataRow[] dtrows = Sqltb.Select("ATTRIBUTE_TYPE<>9");
                                    if (dtrows.Length > 0)
                                    {
                                       // foreach (DataRow dr in Sqltb.Rows)
                                        foreach (DataRow dr in dtrows)
        ...
        public string GetCategoryid(string FamilyId)
        {
            try
            {
                if (HttpContext.Current.Session["FamilyProduct"] != null)
                {
                    ...
                    if (dt.Columns.Contains("Category_Path"))
                    {
                        ...
                        if (foundRows.Length > 0)
                        {
                            return foundRows[0]["category_id"].ToString();

                        }
                        else
                        {
                            return getcategory_id_fromurl();
                        }
        ...
        private string getcategory_id_fromurl()
        {

            DataSet subds = (DataSet)HttpContext.Current.Application["key_SubCategory"];
        ...
        private DataTable Get_ProductPage_Values_Direct(string DataType, DataTable Fds, DataTable ds, INavigateResults res, IResultRow item1, String name, DataSet Dsadv,string Pid,string Fid ,string pro_code)
        {
            Stopwatch swpvaljson = new Stopwatch();
            swpvaljson.Start();
           
            int last = 1;// res.getLastItemJson();
            string _ProCode = string.Empty;
            string _ProductPrice = string.Empty;
            string _FmlyDesc = string.Empty;
            string _ProductDesc = string.Empty;
            ...
            try
            {
                if (last >= 0)
                {
                   ...
                   // var Dr = Dsadv.Tables["items"].Rows[0];
                    _ProCode = "";// Dr["Prod_Code"].ToString();
                    _ProductPrice = "";// Dr["Price"].ToString();
                    _ProductDesc = "";// Dr["Prod_Description"].ToString();

                    _FmlyDesc = "";
                    _FmlylongDesc = "";

                    string FamCount = "";// Dr["Family_Prod_Count"].ToString();
                    string ProCount = "1";// last.ToString();
                    //string temp_subfamily_count = "";// Dr["SubFamily_Count"].ToString();
                    string _subFamID = "";// Dr["SubFamily_Id"].ToString();
                    string _FamID = Fid;//Dr["Family_Id"].ToString();
                    image_string = "";

                    dRow = ds.NewRow();

                    dRow["PRODUCT_ID"] = Pid;// Dr["Prod_Id"].ToString();
                    ...
                    string strsql = "exec STP_TBWC_PICK_FAMILYNAME_WAGNER '" + Fid + "','" + Pid + "'";
                    DataSet fname = objhelperDb.GetDataSetDB(strsql);

                    var dr1 = fname.Tables["Table"].Rows[0];
                    if (dr1["FAMILY_NAME"].ToString() != string.Empty)
                    {
                        dRow["FAMILY_NAME"] = dr1["FAMILY_NAME"].ToString();
                        //mODIFIED bY :iNDU ON fEB & fOR GETING DETAILS FROM SUBFAMILY IF PRESENT
                        dRow["FAMILY_ID"] = dr1["FAMILY_ID"].ToString();
                        if(dr1["FAMILY_ID"].ToString()!=Fid)
                        {
                            _subFamID = dr1["FAMILY_ID"].ToString();
                        }
                    }

                    //object str_fname = objhelperDb.GetGenericDataDB(Fid, "GET_FAMILY_NAME", HelperDB.ReturnType.RTString);
                   // if (str_fname != null)
                   // {
                   //     dRow["FAMILY_NAME"] = str_fname.ToString();
                   // }

                    //if (Dr["SubFamily_Id"].ToString() != string.Empty && Dr["Family_Name"].ToString() != string.Empty)
                    //{
                    //    dRow["FAMILY_ID"] = Dr["SubFamily_Id"].ToString();
                    //    dRow["FAMILY_NAME"] = Dr["SubFamily_Name"].ToString();
                    //}
                    //else
                    //{

                    //    dRow["FAMILY_ID"] = Dr["Family_Id"].ToString();
                    //    dRow["FAMILY_NAME"] = Dr["Family_Name"].ToString();
                    //}
                    ...
                    tmpstr = Pid;// Dr["Prod_Id"].ToString();
                    string userid = HttpContext.Current.Session["USER_ID"].ToString();
                    if (userid == string.Empty || userid == null)
                        userid = System.Configuration.ConfigurationManager.AppSettings["DUM_USER_ID"].ToString();
                   ...
                   string sqlexec = "exec STP_TBWC_PICKFPRODUCTPRICE_EA '','" + tmpstr + "','" + userid + "'";
                    ...
                    tmpstr = ((_subFamID == "") ? _FamID : _subFamID).ToString();
                    sqlexec = sqlexec + ";exec STP_TBWC_PICKGENERICDATA '" + WesCatalogId + "','" + Pid.ToString() + "','" + tmpstr + "','','','GET_PRODUCT_ATTRIBUTE','" + websiteid + "'";
                   ...
                   // sqlexec = sqlexec + ";exec STP_TBWC_PICK_FAMILYATTRIBUTE_WAGNER '" + WesCatalogId + "', '" + Fid + "','" + Pid + "'";
                    DataSet Dsall = objhelperDb.GetDataSetDB(sqlexec);
                    ...
                    if (tmpstr != string.Empty)
                    {
                        ...
                        if (Sqltb != null && Sqltb.Rows.Count > 0)
                        {
                            foreach (DataRow dr in Sqltb.Rows)
                            {
                                ...
                                try
                                {
                                   // objErrorhandler.CreateLog("inside product" + Pid.ToString() + dr["PROD_SUBSTITUTE"].ToString());
                    ...
                    //Modified By Indu To get product code form db
                    //if (pro_code != "")
                    //{
                    //    _ProCode = pro_code;
                    //}
                    ...
                    //{
                        ...
                        _ProCode = objProductServices.GetProductCode(Convert.ToInt32(Pid));
                    //}
                   ...
                   // string category_id = GetCategoryid(Fid);
                //if (HttpContext.Current.Request.RawUrl.Contains("/mpd/") == false)
                //{
                //    try
                //    {
                //        string category_id = getcategory_id_fromurl();
                //        string checkfamilycat = "exec [STP_TBWC_CHECK_FAMILY_CATAGORY_RELATION] '" + Fid + "','" + category_id + "'";
                //        DataSet familycat = objhelperDb.GetDataSetDB(checkfamilycat);
                //        if (familycat != null)
                //        {

                //            if (familycat.Tables[0].Rows[0][0].ToString() == "0")
                //            {
                //                string strvalue = objhelper.SimpleURL_Str(pro_code, "ps.aspx", false);
                //                HttpContext.Current.Response.Redirect("/" + strvalue + "/ps/");
                //            }
            ...
            swpvaljson.Stop();
            objErrorhandler.ExeTimelog = "Get_ProductPage_Product_ValuesJson = " + swpvaljson.Elapsed.TotalSeconds.ToString();
        ...
        public DataSet GetAttributeProducts(string DataPage, string SearchStr, string AttributeType, string AttributeValue, string Brand, string resultPerPage, string CurrentPageNo, string NextPage, string EA)
        {
            ...
            {
    return GetAttributeProductsJsonDirect(DataPage, SearchStr, AttributeType, AttributeValue, Brand, resultPerPage, CurrentPageNo, NextPage, EA);
              //  objErrorhandler.CreateLog(DataPage);
              //  return GetAttributeProductsJson(DataPage, SearchStr, AttributeType, AttributeValue, Brand, resultPerPage, "1", NextPage, EA);
            }
            else
            {
        ...
        {
           // Stopwatch swgapjson = new Stopwatch();
            Stopwatch swpvaljson = new Stopwatch();
           // Stopwatch sweaurl = new Stopwatch();
           ...
           // swgapjson.Start();
            ...
            ea = Impl.RemoteFactory.create(EasyAsk_URL, EasyAsk_Port, EasyAsk_WebCatDictionary);
              opts = ea.getOptions();
               ...
               //     objErrorhandler.CreateLog("Familypagecnt", flpagecnt); 
                ...
                if (DataPage == "ProductList" || DataPage == "CategoryProductList" || DataPage == "ByBrand" || DataPage == "ps" || DataPage =="PowerSearch")
                {
                    if (HttpContext.Current.Session["SortOrder"] != null && HttpContext.Current.Session["SortOrder"] != "")
                    {
                        ...
                        else  if  ( HttpContext.Current.Session["SortOrder"].ToString() == "catalog")
                        {
                            opts.setSortOrder("fsort,true");
                            //opts.setReturnSKUs(true);
                        }
                ...
                int PriceCode = 1;// GetPriceCode();
                //objErrorhandler.CreateLog("B4 Price code" + PriceCode.ToString());
                if (PriceCode != -1)
                {
                    opts.setCallOutParam("&eap_PriceCode=" + PriceCode.ToString());
                    //objErrorhandler.CreateLog("&eap_PriceCode=" + PriceCode.ToString());
                }
              //  opts.setCallOutParam("&eap_PriceCode=" + PriceCode.ToString());
                ...
                {
                  //  objErrorhandler.CreateLog(" inside  AttributeFamPro");
                    AttributePro.Tables.Add(AttributeFamPro);
                    AttributeFamPro.Columns.Add("PRODUCT_ID", typeof(string));
                    AttributeFamPro.Columns.Add("STRING_VALUE", typeof(string));
                    AttributeFamPro.Columns.Add("NUMERIC_VALUE", typeof(string));
                    ...
                    //objErrorhandler.CreateLog(" after  AttributeFamPro");
                ...
                if (EA == string.Empty)
                {
                    if (int.Parse(CurrentPageNo) <= 0)
                    {
                        if (SearchStr != string.Empty && AttributeValue == string.Empty && AttributeType == string.Empty)
                        {
                            ...
                            {
                                if ((SearchStr.Contains(" under")) || (SearchStr.Contains(" over")))
                                {
                                    SearchStr = "'" + SearchStr + "'";
                                    res = ea.userSearch("AllProducts////WESAUSTRALASIA", SearchStr);
                                }
                        ...
                        else
                        {
                            ...
                            {
                              //  sweaurl.Start();
                                //objErrorhandler.CreateLog(" before  ProductId");
                                if (HttpContext.Current.Session["EA"] != null)
                                {
                                    if (HttpContext.Current.Session["EA"].ToString().EndsWith("Prod Id=" + AttributeValue))
                                    {
                                    ...
                                    //objErrorhandler.CreateLog(" after  ProductId");
                                }
                              //  sweaurl.Stop();
                              //  objErrorhandler.ExeTimelog = "Easyask result url = " + sweaurl.Elapsed.TotalSeconds.ToString();
                              //  objErrorhandler.createexecutiontmielog(); 
                               
                            }
                            else if (AttributeType == "MBrand")
                            {
                                temp = "" + AttributeType + " = '" + HttpUtility.UrlEncode(AttributeValue) + "'";
                                temp1 = "" + AttributeType + " = ";
                                if (EA != null)
                                {
                                    ...
                                    res = ea.userAttributeClick(HttpUtility.UrlEncode("AllProducts////WESAUSTRALASIA"), temp);
                                    //HttpContext.Current.Session["EA"] = res.getCatPath();
               ...
               //objErrorhandler.CreateLog("Easyask " +AttributeValue +" "+HttpContext.Current.Request.RawUrl )   ;    

                    if (DataPage == "ProductPage")
                    {
                        //if (!(HttpContext.Current.Session["EA"].ToString().EndsWith("Prod Id=" + AttributeValue)))
                        //{
                        //    HttpContext.Current.Session["EA"] = HttpContext.Current.Session["EA"].ToString() + "////UserSearch1=Prod Id=" + AttributeValue;
                        //}
                        HttpContext.Current.Session["EA"] = res.getCatPathJson();
                    }
                    else
                ...
                else
                {
                    ...
                    if (int.Parse(CurrentPageNo) <= 0)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                objErrorhandler.CreateLog(" inside else after  ProductId");
                                if (EA != null)
                                {
                                    if (EA.ToString().EndsWith("Prod Id=" + AttributeValue))
                                    {
                            ...
                            else if (AttributeType == "BrandStore")
                            {
                                temp = "" + AttributeType + " = '" + HttpUtility.UrlEncode(AttributeValue) + "'";
                                temp1 = "" + AttributeType + " = ";
                                if (EA != null)
                    ...
                    //objErrorhandler.CreateLog("before EA" + EA);
                    EA = res.getCatPathJson();

                  //  objErrorhandler.CreateLog("after EA" + EA);
                ...
                if (DataPage.ToLower() != "ps" &&  DataPage =="PowerSearch" && DataPage != "ProductPage")
                {
                    ...
                    if (last < 0)
                    {
                     ...
                     string url=   HttpContext.Current.Request.RawUrl.ToString();
                        ...
                        if (atrvalue != "")
                        {
                            if (HttpContext.Current.Session["IsnewURl"] == null || HttpContext.Current.Session["IsnewURl"] != "1")
                            {
                            ...
                            else
                            {
                                ...
                                url = HttpContext.Current.Request.RawUrl.ToString().Replace(atrvalue, "").Replace("//", "");
         ...
         //       if(DataPage != "ProductPage")
                ...
                if (DataPage != "FamilyPage" && DataPage != "ProductPage")
                {
                    if (dsadv != null && dsadv.Tables.Count > 0 && dsadv.Tables["itemdescription"] != null && dsadv.Tables["itemdescription"].Rows.Count > 0)
                    {
                        ...
                        HttpContext.Current.Session["totalitemcount"] = totalitemcount;
                    }
                    ...
                    if (totalitemcount == 0 && HttpContext.Current.Session["IsnewURl"] != null && HttpContext.Current.Session["IsnewURl"].ToString()=="1")
                    {
                        string url = HttpContext.Current.Request.RawUrl.ToString();
                        string[] fstring = url.Split('/');
                        string atrvalue = fstring[1];
                        url = HttpContext.Current.Request.RawUrl.ToString().Replace(atrvalue, "").Replace("//", "/");
                        HttpContext.Current.Session["IsnewURl"] = null;
                        HttpContext.Current.Response.Redirect(url, false);
                    }
      ...
      //  objErrorhandler.CreateLogEA(HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"].ToString() + "," + HttpContext.Current.Request.UserAgent + "," + res.getCatPathJson() + "," + ((HttpContext.Current.Session["USER_ID"] != null) ? HttpContext.Current.Session["USER_ID"].ToString() : "0"));
                ...
                else if (DataPage == "ProductPage")
                {
                    ...
                    Get_ProductPage_Values_Direct(DataPage, AttributeFam, AttributeFamPro, res, null, null, dsadv, AttributeValue, NextPage,CurrentPageNo);
                }
                else if (DataPage == "ByBrand")
                {
                    //Get_BrandModel_Product_Values(DataPage, AttributeFamPro, res);                        
                    Get_Family_Product_ValuesJson(DataPage, AttributeFamPro, res, null, null, dsadv,AttributeType,AttributeValue);
                }
                else
                {

                    //objErrorhandler.CreateLog("before  Get_Family_Product_ValuesJson");
                    Get_Family_Product_ValuesJson(DataPage, AttributeFamPro, res, null, null, dsadv, AttributeType, AttributeValue);
                }
                ...
                HttpContext.Current.Session["FamilyProduct"] = AttributePro;
               // swgapjson.Stop();
              //  objErrorhandler.ExeTimelog = "GetAttributeProductsJson = " + swgapjson.Elapsed.TotalSeconds.ToString();
               // objErrorhandler.createexecutiontmielog(); 
        ...
        public DataSet GetAttributeProductsJsonDirect(string DataPage, string SearchStr, string AttributeType, string AttributeValue, string Brand, string resultPerPage, string CurrentPageNo, string NextPage, string EA)
        {
            ...
            try
            {
                ...
                if (EA == string.Empty)
                {
                    ...
                    if (AttributeType == "ProductId")
                    {
                        if (HttpContext.Current.Session["EA"].ToString().EndsWith("Prod Id=" + AttributeValue))
                        {
                           // objErrorhandler.CreateLog(HttpContext.Current.Session["EA"].ToString()+" 1---EA");
                            HttpContext.Current.Session["EA"] = HttpContext.Current.Session["EA"].ToString().Replace("Prod Id=" + AttributeValue, "");
                        }
                        else
                        {
                            if(HttpContext.Current.Session["EA"].ToString().Contains("Prod Id=") == true)
                                {
                                    HttpContext.Current.Session["EA1"] = HttpContext.Current.Session["EA1"].ToString();
                                 //   objErrorhandler.CreateLog(HttpContext.Current.Session["EA1"].ToString() + "2---EA1");
                                }
                                else
                                {
                                    HttpContext.Current.Session["EA1"] = HttpContext.Current.Session["EA"].ToString();
                                    //objErrorhandler.CreateLog(HttpContext.Current.Session["EA"].ToString() + "3---EA1");
                                }
                        }
                    }
                    ...
                    if (DataPage == "ProductPage")
                    {
                       // if (!(HttpContext.Current.Session["EA"].ToString().EndsWith("Prod Id=" + AttributeValue)))
                       // {
                            HttpContext.Current.Session["EA"] = HttpContext.Current.Session["EA1"].ToString() + "////UserSearch1=Prod Id=" + AttributeValue;
                      //  }
                    }
                   // else
                   //     HttpContext.Current.Session["EA"] = res.getCatPathJson();
                ...
                if (DataPage == "ProductPage")
                {
                  // objErrorhandler.CreateLog("B4   Get_ProductPage_Values_Direct" + DateTime.Now.ToString("hh.mm.ss.ffffff"));
                 Get_ProductPage_Values_Direct(DataPage, AttributeFam, AttributeFamPro, null, null, null, dsadv, AttributeValue, NextPage, CurrentPageNo);
              //  objErrorhandler.CreateLog("after   Get_ProductPage_Values_Direct" + DateTime.Now.ToString("hh.mm.ss.ffffff"));
           // objErrorhandler.CreateLog("B4   CreateYouHaveSelectAndBreadCrumb" + DateTime.Now.ToString("hh.mm.ss.ffffff"));
                    CreateYouHaveSelectAndBreadCrumb(true);
                // objErrorhandler.CreateLog("after   CreateYouHaveSelectAndBreadCrumb" + DateTime.Now.ToString("hh.mm.ss.ffffff"));
                }
                HttpContext.Current.Session["FamilyProduct"] = AttributePro;
                return AttributePro;
            }
        ...
        //            }
        //            else if (HttpContext.Current.Request.Url.OriginalString.Contains("pl.aspx"))
        //            {
        //                Create_Menu_Table_Columns();
        //                updateBreadCrumb(res.getBreadCrumbTrail(), "", "");
        //                IList<INavigateCategory> list = res.getDetailedCategories();
        ...
        //                        {
        //                            HttpContext.Current.Session["BreadCrumbName"] += separator + "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">" + path_value + "</a>";
        //                            href = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">";
        //                            if (HttpContext.Current.Session["Link"] == null)
        //                            {
        //                                HttpContext.Current.Session["Link"] = "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode("ppaNFtmS8Au7qIvaOCRHUp5RGlmGw65lKAOdRc+AWE7wD1EsnO+ebUWpKbZWV/Nuik1daBT3bK1yvp40MZ9Cig==") + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            }
        ...
        //                            HttpContext.Current.Session["Link"] = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">";
        //                            Htmlitems1.Add(htmlItems);
        //                        }
        //                        else
        //                        {
        //                            HttpContext.Current.Session["BreadCrumbName"] += separator + "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">" + path_value + "</a>";
        //                            href = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">";
        //                            if (HttpContext.Current.Session["Link"] == null)
        //                            {
        //                                HttpContext.Current.Session["Link"] = "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode("ppaNFtmS8Au7qIvaOCRHUp5RGlmGw65lKAOdRc+AWE7wD1EsnO+ebUWpKbZWV/Nuik1daBT3bK1yvp40MZ9Cig==") + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                                // href = "<a href=\"ps.aspx?&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            }
        //                            htmlItems = "<li class='ea-remove-nav-value' ><table><tr><td valign='middle'; align='left'>" + HttpContext.Current.Session["Link"].ToString() + "<img src='images/remove.png' style='border:none;'></a></td><td align='left'>" + href + hCAV("Family Name", path_value) + "</a></td></tr></table></li>";
        //                            HttpContext.Current.Session["Link"] = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(path_value) + "\">";
        //                            Htmlitems1.Add(htmlItems);
        //                        }
        //                    }
        //                    else
        ...
        //                        if (HttpContext.Current.Request.QueryString["fcnt"] != null)
        //                        {
        //                            HttpContext.Current.Session["BreadCrumbName"] += separator + "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">" + GetValue + "</a>";
        //                            href = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            htmlItems = "<li class='ea-remove-nav-value' ><table><tr><td valign='middle'; align='left'>" + HttpContext.Current.Session["Link"].ToString() + "<img src='images/remove.png' style='border:none;'></a></td><td align='left'>" + href + hCAV(label, GetValue) + "</a></td></tr></table></li>";
        //                            HttpContext.Current.Session["Link"] = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;fcnt=" + HttpContext.Current.Request.QueryString["fcnt"].ToString() + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            Htmlitems1.Add(htmlItems);
        //                        }
        //                        else
        //                        {
        //                            HttpContext.Current.Session["BreadCrumbName"] += separator + "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">" + GetValue + "</a>";
        //                            href = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            htmlItems = "<li class='ea-remove-nav-value' ><table><tr><td valign='middle'; align='left'>" + HttpContext.Current.Session["Link"].ToString() + "<img src='images/remove.png' style='border:none;'></a></td><td align='left'>" + href + hCAV(label, GetValue) + "</a></td></tr></table></li>";
        //                            HttpContext.Current.Session["Link"] = "<a href=\"fl.aspx?&amp;fid=" + Family_Id + "&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            Htmlitems1.Add(htmlItems);
        //                        }
        //                    }
        ...
        //                    {
        //                        separator = "&nbsp;/&nbsp;";
        //                        HttpContext.Current.Session["BreadCrumbName"] += separator + "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">" + GetValue + "</a>";
        //                        if (HttpContext.Current.Session["Link"] == null)
        //                        {
        //                            HttpContext.Current.Session["Link"] = "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode("ppaNFtmS8Au7qIvaOCRHUp5RGlmGw65lKAOdRc+AWE7wD1EsnO+ebUWpKbZWV/Nuik1daBT3bK1yvp40MZ9Cig==") + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                            // href = "<a href=\"ps.aspx?&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                        }
        //                        href = "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">";
        //                        htmlItems = "<li class='ea-remove-nav-value' ><table><tr><td valign='middle'; align='left'>" + HttpContext.Current.Session["Link"].ToString() + "<img src='images/remove.png' style='border:none;'></a></td><td align='left'>" + href + hCAV(label, GetValue) + "</a></td></tr></table></li>";
        //                        HttpContext.Current.Session["Link"] = "<a href=\"pl.aspx?&amp;Path=" + HttpUtility.UrlEncode(objhelper.StringEnCrypt(node.getPath())) + "&amp;BreadCrumb_Name=" + HttpUtility.UrlEncode(node.getValue()) + "\">"; 
        //                        Htmlitems1.Add(htmlItems);
        //                    }
        //                }
        //                else
