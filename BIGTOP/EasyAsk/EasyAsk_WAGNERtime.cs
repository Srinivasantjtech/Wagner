...
namespace TradingBell.WebCat.EasyAsk
{
    ...
    public class EasyAsk_WAGNER
    {
                                ...
                                if (attrName.Equals("Model"))//For Model Name will split
                                {
                                    ...
                                    if (attrvalue.ToLower().Contains(temptext.ToLower()))
                                    {
                                        ...
                                        if (model[0].ToString().ToLower().Contains(temptext.ToLower()))
                                        {
                                            ...
                                            row["URL_RW_PATH"] = objhelper.SimpleURL_Str( model[1].ToString(), "ct.aspx",false);   
                                            Category_Attributes_DS.Tables[i + 1].Rows.Add(row);
                                        }
                                    }
                                }
            ...
            try
            {
                ...
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (i = 0; i <= ds.Tables[0].Rows.Count - 1; i++)
                    {
                        ...
                        _stmpl_records.SetAttribute("TBT_REMOVEURL", row["RemoveUrl"].ToString());
                        _stmpl_records.SetAttribute("TBT_URL", row["Url"].ToString());
                        _stmpl_records.SetAttribute("TBT_EAPATH", row["EAPath"].ToString());
                        _stmpl_records.SetAttribute("TBT_ATTRIBUTE_TYPE", row["ItemType"].ToString());
                        ...
                        try
                        {
                            ...
                            if ((pagename.Contains("pl.aspx")) && (catpath.Length >= 5))
                            {
                                ...
                                HttpContext.Current.Session[catpath[3] + "wa-" + a.ToString()] = ds.Tables[0].Rows[i]["EAPATH"].ToString();
        ...
        public string GetBreadCrumb_Simple_MS(string templatepath, Boolean withHome)
        {
            ...
            if (dsb != null && dsb.Tables[0].Rows.Count > 0)
            {
                ...
                for (i = 0; i <= dsb.Tables[0].Rows.Count - 1; i++)
                {
                  ...
                  if (catpath[2].ToLower() != catpath1[1].ToLower())
                  {
                      catpath[2] = catpath1[1];
                        ...
                        if (newpagename.Contains("pl.aspx"))
                        {
                            ...
                            {
                                a = a + 1;
                                breadcrumEA = catpath[0] + "////" + catpath[1] + "////" + catpath[2] + "////" + catpath[3] + "////" + "mwa-" + a;
                                HttpContext.Current.Session[catpath[3] + "mwa-" + a.ToString()] = dsb.Tables[0].Rows[i]["EAPATH"].ToString();
                            }
                            else if (catpath.Length > 3)
                            {
                                breadcrumEA = catpath[0] + "////" + catpath[1] + "////" + catpath[2] + "////" + catpath[3];
                            }
                        ...
                        else if (newpagename.Contains("fl.aspx"))
                        {
                            ...
                            else
                            {
                                ...
                                a = a + 1;
                                breadcrumEA = catpath[0] + "////" + catpath[1] + "////" + catpath[2] + "////" +
                                    catpath[3] + "////" + Familyname + "////" + _fid + "////" + "mwa-" + a;
                        ...
                        else if (newpagename.Contains("bb.aspx"))
                        {
                            ...
                            {
                                a = a + 1;
                                breadcrumEA = catpath[0] + "////" + catpath[1] + "////" + catpath[2] + "////" + istsb + "////" + istsm + "////" + "wa-" + a;
                        ...
                        else if ((newpagename.Contains("ps.aspx")) || (newpagename == ""))
                        {
                            ...
                            if (catpath.Length > 4)
                            {
                                ...
                                breadcrumEA = catpath[0] + "////" + catpath[1] + "////" + dsb.Tables[0].Rows[0]["ItemValue"].ToString() + "////" + "////" + dsb.Tables[0].Rows[1]["ItemValue"].ToString() + "////" + "mwa-" + a;
        ...
        {
            if (HttpContext.Current.Session["MainCategory"] == null || HttpContext.Current.Session["SubCategory"] == null )
            {
    ...
    querystring.Contains("/mps/"))
        ...
        private DataTable Get_Family_Product_ValuesJson(string DataType, DataTable ds, INavigateResults res, IResultRow item1, String name, DataSet Dssdv)
        {
            ...
            try
            {
                ...
                if (Dssdv != null && Dssdv.Tables.Count > 0 && Dssdv.Tables["items"] != null && Dssdv.Tables["items"].Rows.Count > 0)
                {
                   ...
                   // ds.Columns.Add("CUSTOM_NUM_FIELD3", typeof(string));
                    ...
                    foreach (DataRow dr1 in ds.Rows)
                    {
                        ...
                        //if (tmpstrPid.Contains(dr1["PRODUCT_ID"].ToString().ToUpper()) == false)
                        //    tmpstrPid = tmpstrPid + dr1["PRODUCT_ID"].ToString().ToUpper() + ",";
                    ...
                    if (tmpstrPid != string.Empty)
                    {
                        ...
                        DataSet tmpDs = new DataSet();
                        tmpDs = objhelperDb.GetProductPrice("", tmpstrPid, userid);
                        if (tmpDs != null)
                        {
                            Sqltb = tmpDs.Tables[0];
                            if (Sqltb != null)
                ...
                //int colFmlyID = Dssdv.Tables["Items"].Columns["Family_Id"].Ordinal;//res.getColumnIndexJson("Family Id");
                //int colSubFmlyID = Dssdv.Tables["Items"].Columns["SubFamily_Id"].Ordinal; //res.getColumnIndexJson("SubFamily Id");
                //int colFmlyName = Dssdv.Tables["Items"].Columns["Family_Name"].Ordinal; //res.getColumnIndexJson("Family Name");
                //int colFmlyDesc = Dssdv.Tables["Items"].Columns["Family_ShortDescription"].Ordinal; //res.getColumnIndexJson("Family ShortDescription");
                //int colFmlylongDesc = Dssdv.Tables["Items"].Columns["Family_Description"].Ordinal; //res.getColumnIndexJson("Family Description");
                //int colFmlyImg = Dssdv.Tables["Items"].Columns["Family_Thumbnail"].Ordinal; //res.getColumnIndexJson("Family Thumbnail");

                //int colProductID = Dssdv.Tables["Items"].Columns["Prod_Id"].Ordinal; //res.getColumnIndexJson("Prod Id");
                //int colProductCode = Dssdv.Tables["Items"].Columns["Prod_Code"].Ordinal; //res.getColumnIndexJson("Prod Code");
                ////  int colProductCode = res.getColumnIndex("Wag Prod Code");
                //int colProductPrice = Dssdv.Tables["Items"].Columns["Price"].Ordinal; //res.getColumnIndexJson("Price");
                //int colProductDesc = Dssdv.Tables["Items"].Columns["Prod_Description"].Ordinal; //res.getColumnIndexJson("Prod Description");
                //int colProductImg = Dssdv.Tables["Items"].Columns["Prod_Thumbnail"].Ordinal; //res.getColumnIndexJson("Prod Thumbnail");

                //int colProductCount = Dssdv.Tables["Items"].Columns["Prod_Count"].Ordinal; //res.getColumnIndexJson("Prod Count");
                //int colFamilyProdCount = Dssdv.Tables["Items"].Columns["Family_Prod_Count"].Ordinal; //res.getColumnIndexJson("Family Prod Count");
                //int colSubFamilyCount = Dssdv.Tables["Items"].Columns["SubFamily_Count"].Ordinal; //res.getColumnIndexJson("SubFamily Count");
                //int colminPrice = Dssdv.Tables["Items"].Columns["minPrice"].Ordinal; //res.getColumnIndexJson("minPrice");
                ...
                //        //for (int i = res.getFirstItemJson() - 1, col = 0; i < last; i++, col++)
                //       // {
                //        foreach( DataRow dr in Dssdv.Tables["Items"].Rows) 
                //        {
                //            sno = sno + 1;
                //            dRow = ds.NewRow();

                //            dRow["FAMILY_ID"] = dr[colFmlyID].ToString();// res.getCellDataJson(i, colFmlyID);
                //            dRow["SUB_FAMILY_ID"] = dr[colSubFmlyID].ToString();// res.getCellDataJson(i, colSubFmlyID);
                //            dRow["FAMILY_NAME"] = dr[colFmlyName].ToString();// res.getCellDataJson(i, colFmlyName);
                //            //dRow["DESCRIPTION1"] = res.getCellData(i, colFmlyDesc);
                //            //dRow["LongDESCRIPTION"] = res.getCellData(i, colFmlylongDesc);
                //            dRow["PRODUCT_ID"] = dr[colProductID].ToString();//res.getCellDataJson(i, colProductID);
                //            dRow["PRODUCT_CODE"] = dr[colProductCode].ToString();// res.getCellDataJson(i, colProductCode);

                //            _ProductPrice = dr[colProductPrice].ToString();//res.getCellDataJson(i, colProductPrice);
                //            if (_ProductPrice == "" || _ProductPrice == string.Empty)
                //                dRow["PRODUCT_PRICE"] = "0";
                //            else
                //                dRow["PRODUCT_PRICE"] = _ProductPrice.Substring(1);

                //            dRow["MIN_PRICE"] = dr[colminPrice].ToString();// res.getCellDataJson(i, colminPrice);

                //            string temp_family_count = dr[colFamilyProdCount].ToString();// res.getCellData(i, colFamilyProdCount);

                //            string temp_product_count = dr[colProductCount].ToString();//  res.getCellData(i, colProductCount);
                //            string temp_subfamily_count = dr[colSubFamilyCount].ToString();// res.getCellData(i, colSubFamilyCount);
                //            string temp_fmly_Image = dr[colFmlyImg].ToString();// res.getCellData(i, colFmlyImg).ToString();
                //            string temp_product_Image = dr[colProductImg].ToString();// res.getCellData(i, colProductImg).ToString();
                ...
                //            //    image_string = "noimage.gif";
                //            //}
                //            _ProCode = dr[colProductCode].ToString();//res.getCellData(i, colProductCode);
                //            _ProductPrice = dr[colProductPrice].ToString();//res.getCellData(i, colProductPrice);

                //            _FmlyDesc = dr[colFmlyDesc].ToString();//res.getCellData(i, colFmlyDesc);
                //            _ProductDesc = dr[colProductDesc].ToString();//res.getCellData(i, colProductDesc);
                //            _FmlylongDesc = dr[colFmlylongDesc].ToString();// res.getCellData(i, colFmlylongDesc);
                //            dRow["SUBCATNAME_L1"] = "";
                //            dRow["SUBCATNAME_L2"] = "";
                //            dRow["CATEGORY_NAME"] = "";
                //            dRow["PARENT_CATEGORY_NAME"] = "";
                ...
                if (last >= 0)
                {
                  ...
                  //  _ProductPrice = drs["Price"].ToString();//res.getCellData(0, colProductPrice);
                   ...
                   // {
                    ...
                    //ds.Columns.Add("SORT_ORDER", typeof(int));
                    ...
                    if (tmpstr != string.Empty)
                    {
                      ...
                      //  Sqltb = (DataTable)objhelperDb.GetGenericDataDB(tmpstr, "GET_PRODUCT_INVENTORY", HelperDB.ReturnType.RTTable);
                       // DataSet  Sqltbs = objhelperDb.GetProductPrice("", tmpstr, userid);
                        DataSet Sqltbs = objhelperDb.GetProductPrice(strfamilyids, tmpstr, userid);
        ...
        private DataTable Get_ProductPage_Product_ValuesJson(string DataType, DataTable Fds, DataTable ds, INavigateResults res, IResultRow item1, String name,DataSet  Dsadv)
        {
            ...
            try
            {
                if (last >= 0)
                {
                    ...
                    dRow["MIN_ORD_QTY"] = "-1";
                    dRow["STOCK_STATUS_DESC"] = "";
                    dRow["PROD_STOCK_STATUS"] = "";
                    dRow["PROD_STOCK_FLAG"] = "";
                    dRow["FAMILY_PROD_COUNT"] = FamCount;
                    dRow["PROD_COUNT"] = ProCount;
                        ...
                        else
                        {
                            if (AttributeType.ToLower() == "category")
                            {
                                if (HttpContext.Current.Session["EA"] != null)
                                {
                                    ...
                                    //HttpContext.Current.Session["EA"] = res.getCatPath();
                                    sw.Stop();
                                    objErrorhandler.CreateLog("ea call Time for categoryproducts" + "=" + sw.Elapsed + "=" + AttributeValue);
                                    objErrorhandler.CreateLog("ea path" + HttpContext.Current.Session["EA"].ToString() + "////" + AttributeValue);
                                }
