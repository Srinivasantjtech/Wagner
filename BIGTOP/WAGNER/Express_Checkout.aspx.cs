    ...
    public partial class Express_Checkout : System.Web.UI.Page
    {
       ...
       //         BtnL3Continue.Attributes.Add("onclick", clickHandler);
        ...
        //        BtnGetStartContinue.Style.Add("display", "block");                                                //comment the line when testing is done
                ...
                if (HttpContext.Current.Session["USER_ID"] != null && HttpContext.Current.Session["USER_ID"].ToString() != "" && Convert.ToInt32(HttpContext.Current.Session["USER_ID"].ToString()) > 0 && HttpContext.Current.Session["USER_ID"].ToString() != "777")
                {
                ...
                if (HttpContext.Current.Session["USER_ID"] != null && HttpContext.Current.Session["ORDER_ID"] != null)
                {
...

                    {
                        ...
                        var request = new TransactionRequest
                        {
                            ...
                            MerchantAccountId = "mjff7p7mgb4qmp77",
                            ...
                            {
                                PostalCode = oOrderInfo.BillZip.ToString(),
                                FirstName = oOrderInfo.BillFName,
                                LastName = oOrderInfo.BillLName,
                                StreetAddress = oOrderInfo.BillAdd1,
                                Locality = oOrderInfo.BillCity,
                                Company = oOrderInfo.BillCountry
