...
public partial class search_searchrsltproducts : System.Web.UI.UserControl
{
  ...
  //  string _fid = "";
    ...
    //                _stmpl_records.SetAttribute("PRODUCT_EA_PATH", HttpUtility.UrlEncode(objSecurity.StringEnCrypt(_EAPath + "////UserSearch1=fl Id=" + drpid["FAMILY_ID"].ToString())));
           ...
           // string tmpProds = string.Empty;
            ...
            if (dscat.Tables["FamilyPro"].Rows.Count  > 0)
            {
                ...
                foreach (DataRow drpid in dscat.Tables["FamilyPro"].Rows)
                {
                    ...
                    _stmpl_records.SetAttribute("PRODUCT_EA_PATH", HttpUtility.UrlEncode(objSecurity.StringEnCrypt(_EAPath + "////UserSearch1=fl Id=" + drpid["FAMILY_ID"])));
                ...
                if (HttpContext.Current.Session["SortOrder"] != null && HttpContext.Current.Session["SortOrder"] != "")
                {
                    ...
                    {
                        _stmpl_container.SetAttribute("SortBy", "Catalog Sort");
                    }
                }
                else
                {
          ...
          //  string tmpProds = string.Empty;
            ...
            if (dscat.Tables["FamilyPro"].Rows.Count > 0)
            {
               ...
               // int icolstart11 = 0;
                ...
                if (Tosuit_ModelImage != string.Empty && Tosuit_ModelImage.ToString() != nul && Tosuit_ModelImage.ToString() != "")
                {
                    _stmpl_container.SetAttribute("TBT_TOSUITE_MODEL_IMAGE", Tosuit_ModelImage.ToString().Replace("\\", "/"));
