...
<script language="javascript" type="text/javascript">
    ...
    function searchurl() {
        ...
        if (ddlattrvalue != "") {
            ...
            $.ajax({
                type: "POST",
                url: "/GblWebMethods.aspx/SearchCtr_str",
                data: "{'strpath':'" + ddlattrvalue + "'}",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (result) {
                   
                    window.location = result.d+"/ps/";
...
<input type="hidden" id="hdnForClear" runat="server" />
           ...
           <asp:Button ID="Button1" runat="server" class="srch-btn"  OnClientClick="return searchurl();"  Width="55px" />
