<%@ Page Language="C#" MasterPageFile="~/MicroSite.Master" AutoEventWireup="true" Inherits="MCheckOut" EnableEventValidation="false"
    Title="Untitled Page"  Culture="en-US" UICulture="en-US" Codebehind="MCheckOut.aspx.cs" %>
...
<%@ Register Src="UC/MICROSITE/OrderDet.ascx" TagName="OrderDet" TagPrefix="uc1" %>
...
//            x1.style.display = "none";
    ...
    function SetinitSP() {
        ...
        //if (res == true) {
        //    document.getElementById("chk").value = "true";
        //    setTimeout(SetTimeOutAlert, 100);
        //}
    }
    </script>
<%-- <script type="text/javascript">
    ...
    function Controlvalidate(ctype) {
        ...
        if (ctype == "cvv") {
            ...
            if (cvv != null && cvv.value == "") {
               ...
               <h4 class="blue_color_text bolder padding_left_right_15 col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_left_right_mob margin_bottom_15">Please enter your details below to complete your purchase</h4> 
...
<span>
    <%
        string image = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/tab_img.png";
    %>
    <img  src="<%= image %>" class="pull-right" alt=""></span>
</span></h4>
...
<div class="panel-body">
                ...
                %>
                 <% if (objOrderServices.IsNativeCountry(OrderIDaspx) == 0)
                    { %>
                  		<div class="accordion_head_green white_color">
                            <%
                                  string image1 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/checkout_tick.png";
                                %>
                             <img src="<%=image1 %>" class="margin_right" alt=""/>
                   ...
                   <div class="accordion_head_yellow gray_40"><strong>Please Note :</strong> As you are purchasing from outside of Australia, We will calculate shipping charges and advise you shortly by email with further details.
                   </div>
                   <%} %>
      ...
      <div class="accordion_head">Enter your Purchase Order No.</div>

         <div class="col-lg-6">
              <div class="form-group padding_15 margin_bottom_none">
                <label class="col-sm-4 control-label font_normal" for="inputEmail3">Order No.</label>
                <div class="col-sm-8">
                  <asp:TextBox  Width="100%" MaxLength="12"  ID="ttOrder" runat="server"  placeholder="Order No" class="form-control checkout_input"  />
                  <asp:Label Width="250px" ID="txterr" runat="server" ForeColor="red" />
                </div>
                <div class="clear"></div>
              </div>
            </div>
            <div class="accordion_head clear">Shipping</div>
             
              
              

                   <div class="col-lg-12 col-xs-12 padding_left_right_mob">
              <div class="col-lg-6">
                <div class="form-group padding_15 margin_bottom_none">
                  <label class="col-sm-4 control-label font_normal" for="inputEmail3">Select Shipment Method</label>
                  <div class="col-sm-8">
              ...
              <div class="col-lg-6">
                <div class="form-group padding_15 margin_bottom_none">
                  <label class="col-sm-12 control-label font_normal" for="inputEmail3">
                   <asp:HyperLink ID="HyperLink1" runat="server" onclick="MouseHover();" CssClass="HyperLinkStyle" style="color:#333;" data-target=".bs-example-modal-lg" data-toggle="modal">
                
                       <%
                           string image = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/micrositeimages/ex.png";
                        %>
                  <img src="<%= image %>" alt="" class="margin_right" onclick="MouseHover();" style="cursor: pointer;" data-target=".bs-example-modal-lg" data-toggle="modal"/> <span onclick="MouseHover();" style="cursor: pointer;" data-target=".bs-example-modal-lg" data-toggle="modal"> Learn More About Shipment Method Options </span>
                        </asp:HyperLink></label>
                  <div class="clear"></div>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group padding_15 margin_bottom_none">
                  <label class="col-sm-4 control-label font_normal" for="inputEmail3">Bill To :</label>
                  <div class="col-sm-8">                   
                     <textarea id="Ta3" cols="34" rows="5"  style="min-height:210px;overflow:hidden;"  class="width_100 resize"  disabled="disabled" tabindex="-1" runat="server"    name="Ta3"></textarea>
                  </div>
                  <div class="clear"></div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group padding_15 margin_bottom_none">
                  <label class="col-sm-4 control-label font_normal" for="inputEmail3">Delivery To :</label>
                  <div class="col-sm-8">
         
                      <textarea id="Ta2" cols="34"  style="min-height:210px;overflow:hidden;" class="width_100 resize"   readonly="readonly" disabled="disabled" tabindex="-1" runat="server" rows="5"  name="Ta2"></textarea>
                  </div>
                  <div class="clear"></div>
                </div>
              </div>
            ...
            <div class="accordion_head clear">Comments / Notes</div>
            <div class="col-lg-12 col-xs-12 padding_left_right_mob">
              <div class="col-lg-12 padding_15">
             
                <asp:TextBox ID="TextBox1"  runat="server" Rows="5" Columns="30" Font-Size="12px" class="width_100 resize" Width="100%"  Height="72px" Font-Names="arial"  MaxLength="240"  onkeyDown="return checkMaxLength(this,event,'240');" 
                                TextMode="MultiLine">
                            </asp:TextBox>
              </div>
            </div>
              <div class="accordion_head clear">Your Order Contents</div>

             <div class="col-lg-12 col-xs-12 padding_left_right_mob">
              <div class="table-responsive col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_15">                                            
              <asp:Panel ID="PnlOrderContents" Visible="true" runat="server" >
                  ...
                  <%
                    ...
                    <td>             <span style="display:none;" id="TaxAmount">
                                <%       
                          ...
                          //              decimal totamtanor = oOrderInfo.ProdTotalPrice;
                                       ...
                                       // Response.Write(cSymbol + " " + oOrderInfo.TaxAmount);
                                        ...
                                        RetTaxa_nor = objOrderServices.CalculateTaxAmount(subtot, ShippingValue, OrderID.ToString());
                                        Response.Write(CurSymbol + " " + RetTaxa_nor);
                                    }
                                  ...
                                  <span style="display:none;" id="taxamtcoupickup">
                                   <%   //decimal totamtTaxCP =  oOrderInfo.ProdTotalPrice;
                                    ...
                                    //    RetTax_CP = objHelperServices.CDEC(objHelperServices.FixDecPlace(RetTax_CP));
                                       Response.Write(CurSymbol + " " + TotalTaxAmount); 
                                    %>
                                  </span>

                                  <span style="display:none;" id="taxamtwithcouriercrge">
                                       <%  
                                           decimal RetTax_WC = objOrderServices.CalculateTaxAmount(subtot, ShippingValue, OrderID.ToString());
                                           //decimal totamtTax = ShippingValue + oOrderInfo.ProdTotalPrice;
                                       //    decimal totamtTax = ShippingValue ;
                                       ...
                                       //// totamtTax = RetTax_WC + ShippingValue + oOrderInfo.ProdTotalPrice;
                                       // RetTax_WC =TotalTaxAmount +objHelperServices.CDEC(objHelperServices.FixDecPlace(RetTax_WC));
         ...
         <tr>
                    ...
                    <td>          <strong id="ICtotalamount" style="display:none;">
                         ...
                         //               decimal totnor = oOrderInfo.ProdTotalPrice;
                                        ...
                                        decimal RetTax_nor =TotalTaxAmount + objHelperServices.CDEC(totnor * (tax_nor / 100));
                              ...
                              //          decimal totamtnor = TotalTaxAmount + oOrderInfo.ProdTotalPrice;
                                        decimal totamtnor = RetTax_nor + totnor + subtot;
                                        if (objOrderServices.IsNativeCountry(OrderID) == 0)
                                            Response.Write(CurSymbol + " " + oOrderInfo.ProdTotalPrice);    
                                        else
                                   ...
                                   <strong id="totalcoupickup" style="display:none;">
                                    <%
                                        ...
                                        decimal totcoupu = TotalTaxAmount + subtot;
                               //         decimal totcoupu = TotalTaxAmount + oOrderInfo.ProdTotalPrice;
                  ...
                  <asp:Panel ID="PnlOrderInvoice" runat="server" Visible="false">
                   <uc1:OrderDet ID="OrderDet2" runat="server" />
                    ...
                    <div class="col-lg-12 text-right checkout_btn">
                        <asp:Button ID="ImageButton1" runat="server" Text="Edit/Update Order"  OnClick="ImageButton1_Click" class="btn-lg blue_color border_none border_radius_none white_color semi_bold font_14 mar_right_30" />
                        <asp:Button runat="server" ID="ImageButton2" Text="Continue" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14"  OnClientClick="return checkorderid()" OnClick="ImageButton4_Click" />                         
                    </div>
...
<div class="modal-footer">
       ...
       <div id="divonlinesubmitordererror" runat="server" aria-hidden="false" aria-labelledby="myLargeModalLabel" role="dialog" tabindex="-1" style="background: none repeat scroll 0% 0% rgba(0, 0, 0, 0.6); display: block;" class="modal fade bs-example-modal-lg in">
    <div class="modal-dialog modal-lg">
    <div class="modal-content">
  ...
  <div class="modal-dialog  margin_top_popup20 ">
    <div class="modal-content  border_radius_none">
        ...
        <div class="modal-body"> <div class="close-selected">

                <asp:ImageButton ID="btnclose" runat="server"  OnClick="btnCancelerroritems_Click" />
    ...
    <div id="PopDiv" runat="server" aria-hidden="false" aria-labelledby="myLargeModalLabel" role="dialog" tabindex="-1" style="background: none repeat scroll 0% 0% rgba(0, 0, 0, 0.6); display: none;" class="modal fade bs-example-modal-lg in">
   

  <div class="modal-dialog  margin_top_popup20 modal-lg" style="margin-top:5%;">
    <div class="modal-content  border_radius_none">
        ...
        <div class="modal-body">
         <div class="close-selected">
                                                       <asp:ImageButton ID="ImageButton3" runat="server" 
                                                        OnClientClick="MouseOut();"  CausesValidation="false" />
        ...
        <div class="modal-footer">
          <asp:Button ID="btnOk" runat="server" Text="Close" CssClass="btn-lg padding_top btn-danger border_none border_radius_none white_color semi_bold font_14 mar_right_30  mob_100 margin_left"   OnClientClick="MouseOut();" CausesValidation="false"  />
          ...
          <h4 class="panel-title"    onclick="OnclickTab('Pay')"  style="cursor:pointer;" id= "h3Pay"  runat="server"> 
           ...
           <span >
                <%
                    string image = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/tab_img.png";
                %>
               <img src="<%=image %>" class="pull-right"  alt=""/></span> </span>
           </h4>
		  ...
		  <div class="panel-body">
			<div runat="server" id="divCC" >
              ...
              <div class="clear"></div>
                ...
                <div runat ="server" id="div2" class="accordion_head_yellow gray_40" style="font-size:12px;text-align:center; font-weight:bold;margin-bottom:12px;" >
                </div>
                 <div class="cl"></div>
                <div class="lgnd-holder paycolor" runat ="server" id="div1"> 
             <%  
                 OrderServices objOrderServices = new OrderServices(); 
 ...
 <div class="col-lg-12 margin_bottom_15">
      <%--             <label class="checkbox-inline">   
         <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnPayPalAPIPayLink_Click" CausesValidation="false" ><label>                
                                ...
                                <% 
                                     ...
                                     if (objSecurePayService.CheckSecurePay() == true && TotAmt <= 100)
                                     {
                                 %>
                                <label class="checkbox-inline">   
             <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnSecurePayLink_Click" CausesValidation="false" ><label> 
                            
                                <asp:Image ID="ImagePaySP" runat="server"  style="margin-top: -5px;cursor: pointer;" alt=""/>
                                </label></asp:LinkButton></label>
                                <%} %>
               ...
               <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" ><label>
                                ...
                                <asp:Image ID="ImagePay" runat="server" style="margin-top: -5px;cursor: pointer;" alt=""/>
                                </label></asp:LinkButton></label>
 ...
 <div class="col-lg-12 margin_bottom_15">     
               ...
               <%-- <label class="checkbox-inline">
                ...
                <img class="mob_mar_top" src="/images/micrositeimages/pay_check.png" alt=""> </label>--%>
                    ...
                    <p class=" margin_top_30 margin_bottom mar_left_20 blue_color_text"><strong>Pay using your Credit Card or Paypal Account</strong></p>
              <p class="margin_bottom mar_left_20">You will be redirected to paypal website to complete payment transaction</p>
                <div class="col-lg-12">
                    <div class="form-group col-lg-5">
                    <h3 class="green_clr bolder">Total Amount $  <asp:Label runat="server" ID="lblpaypaltotamt" CssClass="totalamt"  /> 
                    </h3>           
                    </div>
                </div>
                   <asp:Button runat="server" ID="btnPay" Text="Pay Now" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 "  OnClick="btnPay_Click" OnClientClick="Setinit(this.id)"   />       

                    <asp:Button runat="server" ID="btnPayApi" Text="Pay Now" style="width:100px;" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 " Visible="false"  OnClick="btnPayApi_Click" OnClientClick="Setinit(this.id)" />       


                 
                 <asp:Button runat="server" ID="BtnProgress" Text="Processing Payment. Please Wait.." style="display:none;visibility:visible;float:left;" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 " Enabled="false"   />       
           ...
           <div runat="server" id="PaySPDiv">
                  <div class="col-lg-8 margin_top_20 col-sm-8" style="text-align:left;">
           ...
           <asp:DropDownList ID="drppaymentmethod" runat="server" width="200px" CssClass="cardinput" onchange="Controlvalidate('dd')"   Visible =false />     
            ...
            <div class="form-group col-lg-12">
                ...
                <div class="col-lg-4">
                <p class="payment-error"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
               ...
               <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                ...
                <div class="cvv-left">
                 ...
                 <asp:Label runat="server" ID="lblcardcvvnumber" style="font-size:16px;"  >CVV Number &nbsp;&nbsp;<span class="redspan">*</span> </asp:Label>
                  <asp:TextBox runat="server" ID="txtCardCVVNumber" Width="100px"  CssClass="form-control checkout_input" MaxLength="4" OnBlur="Controlvalidate('cvv')"/>    
                 </div>
                 <div class="cvv-image">
                ...
                <%
                    string image2 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/question-icon.png";
                %>
                  <img src="<%= image2 %>" alt="" class="margin_right" onclick="MouseOverCCpopClick();" style="cursor: pointer;" data-target=".bs-example-modal-lg1" data-toggle="modal"/>
                        </asp:HyperLink>
                    </div>
    ...
    DropShadow="true" runat="server" TargetControlID="myLink" RepositionMode="None">
            ...
            <div class="form-group col-lg-12">
                ...
                <asp:DropDownList NAME="drpExpmonth"  ID="drpExpmonth" runat="server"  CssClass="form-control checkout_input">           
                    ...
                    <div class="col-lg-3 margin_top5" >
              ...
              <p class="payment-error">
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                   ...
                   <div class="col-lg-12">
                    <div class="form-group col-lg-5">
                    <h3 class="green_clr bolder">Total Amount $  <asp:Label runat="server" ID="lblAmount" CssClass="totalamt"  /> 
                    </h3>           
                    </div>
                </div>
            ...
            <div class="cl"></div>
               <div class="form-group col-lg-6"> 
                ...
                <asp:Button runat="server" ID="btnSP"  Text="Pay Now" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 " OnClick="btnSecurePay_Click" OnClientClick="javascript:SetinitSP()" />       

                  <asp:Button runat="server" ID="BtnProgressSP" Text="Processing Payment. Please Wait" style="display:none;visibility:visible;float:left;" class="btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 " Enabled="false"   />     
                 
                 
                  
         <div id="div6" style="font-size:12px margin-left:30px;color:Red" runat="server"  >
       </div>
            </div>
            ...
            <div class="cl"></div>
                ...
                <div class="accordion_head clear">Shipping & Order Details</div>
                <div class="col-lg-6">
              <div class="form-group padding_15 margin_bottom_none">
                <label class="col-sm-12 control-label font_normal" for="inputEmail3"><strong>Bill To</strong></label>
                <div class="col-sm-12">
                  <ul class="list-group margin_top border_1"  style="height:210px;">
               ...
               <div class="col-lg-6">
              <div class="form-group padding_15 margin_bottom_none">
                <label class="col-sm-12 control-label font_normal" for="inputEmail3"><strong>Ship To</strong></label>
                <div class="col-sm-12">
                  <ul class="list-group margin_top border_1"  style="height:210px;">
                ...
                <div class="clear"></div>
                    ...
                    <div class="accordion_head clear">Order Contents</div>
                 <div class="col-lg-12 col-xs-12 padding_left_right_mob">
              <div class="table-responsive col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_15">                                            
                     <uc1:OrderDet ID="OrderDet1" runat="server" />
                     <div class="col-lg-12 text-right">
                  
                       <asp:Button ID="ImgBtnEditShipping" runat="server" Text="Edit / Update Order"  style="width:auto !important" class="btn-lg blue_color border_none border_radius_none white_color semi_bold font_14 mar_right_30" OnClick="ImgBtnEditShipping_Click"  CausesValidation="false" />
                    </div>
...
<div class="panel panel-default" id="liFinalReview" runat="server">
 ...
 <h4 class="panel-title"  onclick="OnclickTab('paid')"  style="cursor:pointer;"  id= "hpaid"  runat="server" > 
  ...
  Completed<span  id="spanpaid"  runat="server">
      <%
          string image3 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/tab_img.png";
        %>
  <img src="<%= image3 %>" class="pull-right" alt=""/></span> </span>
   </h4>
    ...
    <h4 class="panel-title"   id= "hpaid1"  runat="server" >  <span  class="collapsed"  > Completed </span> </h4>
        ...
        <div runat="server" id="paiddiv">
          ...
          <div class="panel-body" >
		<div class="accordion_head_green white_color" runat="server" id="PayOkDiv" >
              <%
                  string image4 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/checkout_tick.png";
                %>
                    <img src="<%=image4 %>" class="margin_right" style="float:left;" alt=""/>
                ...
                <div style="height:10px;"></div>
                  ...
                  <div class="col-lg-6">
              <div class="form-group padding_15 margin_bottom_none">
                <label class="col-sm-12 control-label font_normal" for="inputEmail3"><strong>Order Details</strong></label>
                <div class="col-sm-12">
                  <ul class="list-group margin_top border_1"  style="height:150px;">
              ...
              <div class="col-lg-6">
              <div class="form-group padding_15 margin_bottom_none">
                <label class="col-sm-12 control-label font_normal" for="inputEmail3"><strong>Payment Information</strong></label>
                <div class="col-sm-12">
                     <ul class="list-group margin_top border_1" style="height:150px;">
  ...
  <h1>How to find the security code on a credit card</h1>
    ...
    <p><strong> Visa, MasterCard, Discover, JCB, and Diners Club</strong></p>
        <p> The security code is a three-digit number on the back of your credit card, immediately following your main card number.</p>
         <%
             string image4 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/Mcard.jpg";
        %>
              <img src="<%= image4 %>"/>
        ...
        <%
            string image5 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/Acard.jpg";
        %>
            <img src="<%= image5 %>"/>
        ...
        <div class="modal-footer">
          <asp:Button ID="Button1" runat="server" Text="Close" CssClass="btn-lg padding_top btn-danger border_none border_radius_none white_color semi_bold font_14 mar_right_30  mob_100 margin_left"  OnClientClick="MouseOutCCpopClick();"   CausesValidation="false"/>
