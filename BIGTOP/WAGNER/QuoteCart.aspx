                    ...
                    <table id="Dynamic Content" width="558" cellpadding="0" cellspacing="0" class="BaseTable"
                        ...
                        <tr class="TableRow">
                            ...
                            <td class="TableRow" align="left">
                                <%  Response.Write("<a href =pd.aspx?&Pid=" + pid + "&fid=" + FId.ToString() + ">" + rItem["CATALOG_ITEM_NO"].ToString() + "</a>");%>
                            </td>
                        ...
                        <tr class="TableRow">
                            ...
                            <%--<td class="TableRow" align="left" style="width: 200px"><% Response.Write("<a href =pd.aspx?Pid=" + pid + ">" + rItem["CATALOG_ITEM_NO"] + "</a>");%></td>--%>
                            <td class="TableRow" align="left">
                                <%  Response.Write("<a href =pd.aspx?&Pid=" + pid + "&fid=" + FId.ToString() + ">" + rItem["CATALOG_ITEM_NO"].ToString() + "</a>");%>
                            </td>
                            <td class="Numeric" align="left">
