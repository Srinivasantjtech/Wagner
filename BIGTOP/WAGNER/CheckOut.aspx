...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 ...
 <script type="text/javascript">
     $(document).ready(function () {
         if (window.location.href.indexOf('CancelOrder') > 0) {
             // ... do something
             $("#ctl00_maincontent_CancelOrderPopup").show();
             $("#PayType1").focus();
             $('html, body').animate({ scrollTop: $('#PayType1').offset().top }, 'slow');
             $(window).scrollTop($('#PayType1').offset().top);
         }
...
<asp:HiddenField ID="hidSourceID" runat="server" />
    ...
    <style>
        ...
        .cancelorder_popup .modal-dialog {
            width: 470px;
           top: 30%;
        }
        }

        .cancelorder_popup .modal-header {
    ...
    <script type="text/javascript">
        ...
        function cancelOrderPopup() {
            ...
            $("#<%=CancelOrderPopup.ClientID%>").show();
            $("#<%=btnDeleteOrder.ClientID%>").removeAttr("disabled");
            $("#<%=btnCancelDeleteOrder.ClientID%>").removeAttr("disabled");
        }
        function cancelDeleteOrder() {
            
            console.log(window.location.href.indexOf("CancelOrder"))
            if (window.location.href.indexOf("CancelOrder") > -1) {
                $("#<%=btnDeleteOrder.ClientID%>").attr("disabled", "disabled");
                return true;
            }
            else {
                $("#<%=CancelOrderPopup.ClientID%>").hide();
                return false;
            }
        }
        ...
        function deleteOrder() {
            //$("#<%=btnDeleteOrder.ClientID%>").attr("disabled", "disabled");
            $("#<%=btnCancelDeleteOrder.ClientID%>").attr("disabled", "disabled");
            //return true;
        }
        ...
        //oOrdInfo.ShipMethod.Replace("Counter Pickup","Shop Counter Pickup");
        $(document).ready(function () {
...
//             $("#<%=payment_popup.ClientID%>").show();
             ...
             document.getElementById('lblsp').style.display="none";
...
<span   ><img  src="/images/tab_img.png" class="pull-right" alt=""></span>
  ...
  <%--<a aria-controls="collapseOne" aria-expanded="true" href="#collapseOne" class="checkoutpanel" data-parent="#accordion" data-toggle="collapse">--%>
                    <div id="headingOne" role="tab" class="panel-heading" style="background-color: #0069b2;color:#fff;">
                      ...
                      <span>
                        <%
                            string image6 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/select-downarrow_wht.png";
                        %>
                      <img class="pull-right" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/select-downarrow_wht.png"/>
                      </span></span>
                        </h4>
                    </div>
                   <%-- </a>--%>
                ...
                %>
                 <% if (objOrderServices.IsNativeCountry(OrderIDaspx) == 0)
                    { %>
                  		<div class="accordion_head_green white_color">
                           <%
                        string image7 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/checkout_tick.png";
                            %>
                             <img src="<%=image7 %>" class="margin_right" alt=""/>
              ...
              <div class="form-group">
                 <label for="inputEmail3" class="control-label" id="Label17">
                   <a href="#" class="checkoutlink" data-target=".lgn-orderinfo" data-toggle="modal" role="button">
                               <%
                                   string image7 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/info.png";
                                %>
                              <img class=" margin_rgt15" src="<%=image7%>"/> Learn More About Shipment Method Options</a>
                  ...
                  <div class="modal-dialog custom">
                        <div class="modal-content">
                         <div class="close-selected">
                          <asp:ImageButton ID="btnclose1" runat="server" OnClientClick="MouseOut();" />
                          ...
                          <div class="modal-header green_bg">
                            <h4 id="H2" class="text-center">
                                <%
                                    string image9 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/Order__info.png";
                                %>
                            <img class="popsucess" alt="img" src="<%=image9%>"/>Shipment Method Options</h4>
                          </div>
                        ...
                        <div class="modal-content">
                         <div class="close-selected">
                          ...
                          <div class="modal-header green_bg">
                            ...
                            <%
                                string image11 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/Order__info.png";
                            %>
                            <img class="popsucess" alt="img" src="<%=image11%>"/>Shop Counter Pickup</h4>
                          </div>
                          <div class="modal-body">
                              <div class="col-lg-20 col-sm-20">
                              <div class="popuptext">
 ...
 <div class="panel panel-default" id="liPayOption" runat="server">
     <div id="headingtwo" role="tab" class="panel-heading" style="background-color: #0069b2;color:#fff;">
          <h4 class="panel-title"    onclick="OnclickTab('Pay')"  style="cursor:pointer;" id= "h3Pay"  runat="server"> 
           ...
           <span >
                <%
                    string image12 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/select-downarrow_wht.png";
            %>
                <img class="pull-right" src="<%=image12%>"/></span> </span>
           </h4>
		  ...
		  <div class="panel-body">
            ...
            <div class="accordion_head_grey clear">Payment Type</div>
                <div runat ="server" id="div2" class="accordion_head_yellow gray_40" style="font-size:12px;text-align:center; font-weight:bold;margin-bottom:12px;background: #FFF200; padding: 12px 17px;" >
                 ...
                 <div class="cl"></div>
                  <div style="width:100%;height:100%;background-color:transparent;display:none;position:absolute" id="divdis" > </div>
      ...
      <%--             <label class="checkbox-inline">   
         <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnPayPalAPIPayLink_Click" CausesValidation="false" ><label>                
                                ...
                                <label class="checkbox-inline lspace0" >
                                 <%
                                         string image = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/master_check.png";
                                %>
             <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnSecurePayLink_Click" CausesValidation="false"  ><label>                
                                <asp:Image ID="ImagePaySP" runat="server" ImageUrl='<%= image %>'  style="margin-top: -5px;cursor: pointer;" alt="cc"/>
                                </label></asp:LinkButton></label>
                                <%} %>
                                 <label class="checkbox-inline lspace0" >
                                    <%
                                        string image1 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/paypal_uncheck.png";
                                    %>
               <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" ><label>
                                <asp:Image ID="ImagePay" runat="server" ImageUrl='<%=image1 %>'  style="margin-top: -5px;cursor: pointer;" alt="cc"/>
                                </label></asp:LinkButton></label>
...
<div id="PayType1">
 ...
 <label class="checkbox-inline lspace0" style="color:white" id="lblsp">   
                               .     
             <asp:LinkButton id="LinkButton3"  runat="server" OnClientClick="btnSecurePayLink();return false;"  >      
                                <img src="http://cdn.wes.com.au/WAG/images/3d_Secure-Check.png" id="btnnewsecurepay"  style="margin-top: -5px;cursor: pointer;" alt="cc"  />
                                </asp:LinkButton> </label>
                               
                                <%--<%} %>--%>
                                 <label class="checkbox-inline lspace0" style="color:white" id="lblpp">
                                  .
               <asp:LinkButton  id="LinkButton4" runat="server"
                   OnClientClick="btnPayPalPayLink();return false;" >

                    <img id="btnnewpaypal" src="images/paypal_uncheck.png" style="margin-top: -5px;cursor: pointer;" alt="cc" />
               </asp:LinkButton>
                               ...
                               <div runat="server" id="PaypalApiDiv" style="display:none" >
 <div class="form-group dblock">     
             ...
             <%  
              ...
              <p class="margin_bott15">You will be redirected to paypal website to complete payment transaction</p>
                   ...
                   <asp:Button runat="server" ID="btnPay" Text="Pay Now" class="btn btn-primary mr10"  OnClick="btnPay_Click" OnClientClick="Setinit(this.id)"   />       

                    <asp:Button runat="server" ID="btnPayApi" Text="Pay Now" style="width:100px;" class="btn btn-primary mr10" Visible="false"  OnClick="btnPayApi_Click" OnClientClick="Setinit(this.id)" />       

                    <button id="btncancelorder" class="btn btn-success" type="button" onclick="cancelOrderPopup();" style="background-color:#f5f5f5;color:#333;border-color: #c5c5c5;">Cancel Order </button>
 ...
 <div class="row" runat="server" id="dropin">
    <div class="col-sm-20 nolftpadd">
                    <div class="form-group col-lg-8 nolftpadd">
                     <h3 class="green_clr">Total Amount $ <asp:Label runat="server" ID="lblbramount" CssClass="totalamt"  /> 
                    </h3>           
                    </div>
                </div>
    <div class="col-xs-20" >
      ...
      <div id="dropin-container" ></div>
                           ...
                           <div id="divsucess" style="display:none;text-align:center" class="accordion_head_green clear" style="margin-bottom:0px!important">
        Transaction Approved! <br />Your Order will now be processed, Thanks for shopping at BIGTOP Online! <br />
         Payment Method: Credit Card
                               <div id="divrefno" class="accordion_head_green clear"></div>
     </div>
    <div id="divFailed" style="display:none;text-align:center;background: #FFF200;font-size:12px" class="accordion_head_yellow gray_40">
       Transaction failed!
           <div id="diverrorno"> Please Try again or use a different card / payment method.</div>
     </div>
                         <div class="row">
   ...
   <%--   <div class="input-group nonce-group hidden">
      ...
      <div class="input-group pay-group" runat="server" id="loading">
        ...
        <input disabled id="pay-btn" class="btn btn-success mr10"  onclick="return false;" type="submit" value="Loading..." style="float:left;"/>
         <input id="cancel-order" class="btn btn-primary"  onclick="cancelOrderPopup();return false;" type="submit" value="Cancel Order" style="float:left;padding: 6px 12px;background-color:#f5f5f5;color:#333;border-color: #c5c5c5;display:none"/>  
      </div>
    </div>
  </div>
    </div>
                              <div runat="server" id="PaySPDiv" visible="false">
...
<div class="form-group col-lg-4 col-sm-20 nolftpadd clearfix">
                <div class="cvv-left" >
                    ...
                    <span class="mandatory checkouterror">
                       <a href="#" class="checkoutlink" data-target=".bs-example-modal-lg1" data-toggle="modal" role="button">
                           <%
                            ...
                            %>
                              <img class=" margin_rgt15" src="<%= image2%>"/></a>
...
<div class="form-group col-lg-8 nolftpadd">
            ...
            <div class="cl"></div>
                       ...
                       <div id="CancelOrderPopup" runat="server" aria-hidden="false" aria-labelledby="myLargeModalLabel" role="dialog" tabindex="-1" style="background: none repeat scroll 0% 0% rgba(0, 0, 0, 0); display: block;" class="modal fade bs-example-modal-lg in cancelorder_popup">
        <div class="modal-dialog modal-dialog-centered margin_top_popup20 " role="document">
            <div class="modal-content  border_radius_none" style="border: 1px solid #8a8a8a">
                  <div class="modal-header text-center" style="border-radius: 4px;padding:12px 7px;">
                     <h4 class="modal-title">Order Delete Confirmation</h4>
                </div>

                <div class="modal-body text-center" style="padding:30px 25px">
                    <p class="alert-red" style="margin:5px 0 15px 0;font-size:16px;font-weight: 600;color: #707070;">Are you sure you wish to Cancel this Order?  </p>
                    <div style="margin: 30px 0 0 0;">
                       <asp:Button ID="btnDeleteOrder" runat="server" Text="Yes, Delete Order" CssClass="btn btn-primary mr10" OnClientClick="deleteOrder();return true" OnClick="btnDeleteOrder_Click" />
                    <asp:Button ID="btnCancelDeleteOrder" runat="server" Text="No" CssClass="btn btn-primary"  OnClientClick="return cancelDeleteOrder();" OnClick="btnCancelDeleteOrder_Click" style="padding: 6px 40px; background-color:#f5f5f5; border-color:#c5c5c5; color:#666;font-weight: bold;" />
                     </div>
                </div>
            </div>
        </div>
...
<div class="table-responsive col-lg-20 col-sm-20">                                           
                     ...
                     <div class="col-lg-20 text-right">
                       ...
                       <asp:Button ID="ImgBtnEditShipping" runat="server" Text="Edit / Update Order"  style="width:auto !important; display:none" CssClass="btn btn-primary" OnClick="ImgBtnEditShipping_Click"  CausesValidation="false" />
                    </div>
...
<div class="panel panel-default" id="liFinalReview" runat="server">
 ...
 <h4 class="panel-title"  onclick="OnclickTab('paid')"  style="cursor:pointer;"  id= "hpaid"  runat="server" > 
  ...
  Completed<span  id="spanpaid"  runat="server">
      <%
          string image4 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()+"images/select-downarrow_wht.png";
        %>
  <img src="<%=image4%>" class="pull-right" alt=""/></span> </span>
   </h4>
                        ...
                        <div class="modal-content">
                          <div class="modal-header green_bg">
                            <h4 id="H3" class="text-center">
                             <%
                                 string image13 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/Order__info.png";
                            %>
                            <img class="popsucess" alt="img" src="<%=image13%>"/>CVV Help</h4>
                          </div>
                          <div class="modal-body">
     ...
     <script>
          function btnPayPalPayLink()
          {
              try {
                  ...
                  document.getElementById("btnnewpaypal").src = "http://cdn.wes.com.au/WAG/images/paypal_check.png";
                  document.getElementById("btnnewsecurepay").src = "http://cdn.wes.com.au/WAG/images/3d_Secure-Uncheck.png";
                  // document.getElementById("ctl00_maincontent_SecurePayAcc").style.display = "none";
                  document.getElementById("ctl00_maincontent_PaypalApiDiv").style.display = "block";
...
{}
         ...
         function btnSecurePayLink() {
             try {
                 ...
                 document.getElementById("btnnewpaypal").src = "http://cdn.wes.com.au/WAG/images/paypal_uncheck.png";
                 document.getElementById("btnnewsecurepay").src = "http://cdn.wes.com.au/WAG/images/3d_Secure-Check.png";
                 // document.getElementById("ctl00_maincontent_SecurePayAcc").style.display = "block";
                 document.getElementById("ctl00_maincontent_PaypalApiDiv").style.display = "none";
                // document.getElementById("pay-btn").style.display = "inline-block";
                 var divOkdrp = document.getElementById('braintreesecurepay');
...
//         alert(x);
       ...
       //  var totamt = document.getElementById('lblpaypaltotamt');
    ...
    //if (document.getElementById("ctl00_maincontent_ImagePaySP").src == "http://cdn.wes.com.au/WAG/images/3d_Secure-Check.png")
         ...
         if (document.getElementById("btnnewsecurepay").src == "http://cdn.wes.com.au/WAG/images/3d_Secure-Check.png") 
         {
            var totamt = document.getElementById('ctl00_maincontent_lblpaypaltotamt');
                 //   alert(totamt);
         ...
         var amt = parseFloat(amt1);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                     ...
                     // document.getElementById('navcart').innerHTML = "<a class=dropdown-toggle href=orderDetails.aspx?CartItem=0 rel=nofollow>Cart:0 items - $ 0.00 <b class=glyphicon glyphicon-menu-down></b></a>;
                     document.getElementById('navcart').style.display = "none";
                     document.getElementById('navcart - div').style.display = "none";
