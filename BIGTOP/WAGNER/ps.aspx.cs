...
public partial class PowerSearchPage : System.Web.UI.Page
{
   ...
   // int _resultpage = 10;
    ...
    //    catch (Exception ex)
    //    {
    //        // objErrorHandler.CreateLog(ex.ToString() + "PowerSearch");
    //    }
    //}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["CATALOG_ID"] = objHelperServices.GetOptionValues("DEFAULT CATALOG");
        Session["DO_PAGING"] = objHelperServices.GetOptionValues("SEARCH_DO_PAGING");
        Session["RECORDS_PER_PAGE"] = objHelperServices.GetOptionValues("SEARCH_RECS_PER_PAGE");
        Session["INVENTORY_LEVEL_CHECK"] = objHelperServices.GetOptionValues("INVENTORY_LEVEL_CHECK");
        Session["SEARCH_CATEGORY_COLS"] = objHelperServices.GetOptionValues("SEARCH_CATEGORY_COLS");
        Session["iPageNo"] = 1;
            //**********************End**************
        if(IsPostBack)        
        {
    ...
    protected void Page_SaveStateComplete(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.QueryString["srctext"] != null)
            {
                ...
                Page.Title = Request.QueryString["srctext"];
                skeyword = Request.QueryString["srctext"];
                urlstring = skeyword;
                ...
                Page.MetaDescription = skeyword + ", Bigtop, wagneronline.com.au";

                string srctext = Request.QueryString["srctext"];
            ...
            else if ( Request.QueryString["Value"] != null )
            {
                ...
                Page.MetaDescription = _AttValue + ", Bigtop, wagneronline.com.au";
                if (_searchstr != "")
                {
                    ...
                    Page.MetaKeywords = skeywordattvalueandsearchstrRe + " | " + "Bigtop, wagneronline.com.au";
                    Page.MetaDescription = skeywordattvalueandsearchstrRe + ", Bigtop, wagneronline.com.au";
            ...
            if (ds.Tables[0].Rows.Count > 2)
            {
                ...
                Page.Title = stitle;
                Page.MetaKeywords = skeyword + " | " + "Bigtop, wagneronline.com.au";
                Page.MetaDescription = skeyword + ", Bigtop, wagneronline.com.au";
            }
    ...
    public static string Assignattr(string strvalue)
    {
        ...
        HttpContext.Current.Session["hfclickedattr_ps"] = strvalue;
