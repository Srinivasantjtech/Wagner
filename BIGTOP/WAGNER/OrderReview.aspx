...
<table align="center" width="558" border="0" cellspacing="0" cellpadding="5">
        <tr> <td align="left" class="tx_1"> <a href="/Home.aspx" style="color:#0099FF" class="tx_3">Home</a><font style="font-family: Arial, Helvetica, sans-serif; font-weight:bolder; font-size: small; font-style: normal"> / </font>Order Review </td> </tr>
    ...
    <table align=center width="558" >
        ...
        <!--Content -->
            <tr> <td colspan="2"> <WebCat:Invoice ID ="ucInvoice" runat ="server" /> </td> </tr>
        <!--Content End up here-->    
        <!--Proceed to next Page-->
           <tr> <td align="right" colspan="4"> <table> <tr class="TableRow" > <td style="width: 102px; height: 26px"> <asp:Button ID="btnCancel" runat="server" class="btnNormalSkin" meta:resourcekey="btnCancel" OnClick="btnCancel_Click" /> </td> <td style="height: 26px" align="right"> <asp:Button ID="btnNext" runat ="Server" class="btnNormalSkin" meta:resourcekey="btnNext" OnClick="btnNext_Click" Width="69px"/>&nbsp;</td> </tr> <tr class="TableRow"> <td align="left" colspan="2" style="height: 26px"> <asp:Label ID="lblmsghere" runat="server" Class="lblGraySkin" meta:resourcekey="lblMessage" Width="176px"></asp:Label></td> </tr> </table> </td> </tr>
