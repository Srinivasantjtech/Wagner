...
<table id ="tblBase"  class="BaseTblBorder" align ="left" width="100%" border ="0px" cellpadding="3" cellspacing="0">
 <tr><td class="TableRowHead" colspan ="7" align="left"><asp:Label id="lblQuoteID" runat="server" Text="" > ></asp:Label></td></tr>
<tr> <td colspan ="7"><table class ="BaseTable1" cellpadding="3" cellspacing="1" width="558">
<tr class="TableRowHead"><td class="TableRowHead" align ="center" style="width: 210px">Item No.</td>
<td class="TableRowHead" align ="center" width ="100px">Quantity</td><td class="TableRowHead" align ="center" width ="100px">Cost</td><td class="TableRowHead" align ="center" width ="100px">Amount</td> </tr>
                        ...
                        %>
                          <tr class="TableRow">
                                <td class="TableRow" style="width: 210px" align="left"><%Response.Write("<a href =pd.aspx?&Pid="+ pid + "&fid=" + FId.ToString() + ">" + rItem["CATALOG_ITEM_NO"].ToString() + "</a>"); %></td>
                       ...
                       %>                                               
      <tr><td colspan="3" class="NumericField" style="height: 25px">Sub Total</td><td class="NumericField" style="height: 25px">
                                <% 
                                    ProdSubTotal = objQuoteServices.GetQuoteTotalCost(QuoteID);
                                    Response.Write(CurSymbol + " " + ProdSubTotal); %></td></tr>
                        <tr><td colspan="3" class="NumericField"><strong>Total</strong></td><td class="NumericField">
                                <strong><% Response.Write(CurSymbol + " " + objQuoteServices.GetCurrentProductTotalCost(QuoteID));    %></strong>
