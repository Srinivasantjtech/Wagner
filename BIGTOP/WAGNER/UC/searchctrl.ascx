...
<%--<script type="text/javascript" src="<%=System.Configuration.ConfigurationManager.AppSettings["CurrentUrl"].ToString()%>scripts/jquery-1.4.1.min.js?v=<%=System.Configuration.ConfigurationManager.AppSettings["JSVersion"].ToString()%>" ></script>--%>
 ...
 <script type="text/javascript" language="javascript">
     ...
     function getValue_ps(a) {
         ...
         $.ajax({
             type: "POST",
             url: "/GblWebMethods.aspx/setsession_ps",
    ...
    function geturl() {
        ...
        if (e.options[e.selectedIndex].text != 'Select Category') {
            ...
            $.ajax({
                type: "POST",
                url: "/GblWebMethods.aspx/setsession_ps",
                data: "{'urlpath':'" + url + "','strpath':'" + strURL1 + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                  alert
                    window.location = "/" + data.d + "/" + ddlattrvalue +"/ps/";
                },
                error: function (xhr, status, error) {
                    var err = eval("(" + xhr.responseText + ")");
...
//                }
        ...
        $(window).scroll(function () {
            ...
            var z = $(document).height() - $(window).height() - 100;
            ...
            if (varloadloader == "true") {
                ...
                if ($(window).scrollTop() >= 0) {
                    z = $(document).height() - $(window).height() - 100;
                    z = z - (z / 2);
...
<div class="container">
  ...
  <%-- <div class="row middle">--%>
    <div class="row">
    	<div class="col-md-4 col-lg-4 leftsidebar" id="sidebar">
        ...
        <div class="dropdown-menu">
          <ul class="">
            ...
            <li>
              ...
              <li>
                <a onclick="SetSortOrder('relevance');" style="cursor:default" >Relevance</a>            
            </li>
                <li>
                <a onclick="SetSortOrder('popularity');" style="cursor:default" >Popular</a>            
            </li>
          </ul>
        </div>
      </li>
