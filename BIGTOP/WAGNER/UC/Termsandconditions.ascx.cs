...
public partial class UC_Termsandconditions : System.Web.UI.UserControl
{
    ...
    public string ST_termsandconditions()
    {
        try
        {
        ConnectionDB objConnectionDB = new ConnectionDB();
        HelperServices objHelperServices = new HelperServices();
        TBWTemplateEngine tbwtEngine = new TBWTemplateEngine("TERMSANDCONDITIONS", Server.MapPath(objHelperServices.GetOptionValues("SHOPPTING TEMPLATE PATH").ToString()), objConnectionDB.ConnectionString);
