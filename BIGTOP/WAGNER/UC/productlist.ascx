...
<script type="text/javascript">
    ...
    function getValue_PL(a) {
        ...
        $.ajax({
            type: "POST",
            url: "/GblWebMethods.aspx/setsession",
...
<script type="text/javascript" language="javascript">
    ...
    function SetSortOrder(orderVal, a) {
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="mob_sort">
                            ...
                            <li>
                                <a onclick="SetSortOrder('ltoh');" style="cursor:default" ping="$TBT_REWRITEURL_REL$">Price Low to High</a>

                            </li>
                            <li>
                                <a onclick="SetSortOrder('htol');" style="cursor:default" ping="$TBT_REWRITEURL_REL$">Price High to Low</a>
