...
public partial class UI_QuickOrder : System.Web.UI.UserControl
{
    ...
    {
        BtnAddToCart.ImageUrl = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/but_submit.gif";
                    ...
                    if (chkExistsItem == 0)
                    {
                        if (objOrderServices.AddOrderItem(oItemInFo) != -1)
                        {
                            ...
                            if (dsOrder != null)
                            {
                                ...
                                decimal Tax = 0;//CalculateTaxAmount(ProdTotalPrice);
