         ...
         try
         {
          ...
          //   StringTemplateGroup _stg_records1 = null;
             ...
             for (int i = 0; i <= dsbc.Tables[0].Rows.Count - 1; i++)
             {
                 ...
                 if (rowItemType.Equals ("brand"))
                 {

                     _istsb = rowItemValue;// row["ItemValue"].ToString();
                 }

                 else if (rowItemType.Equals ( "family"))
                 {
                 ...
                 //}
                 else if (rowItemType.Equals ( "product"))
                 {
                 ...
                 else if ((rowItemType == "category" && i != 0) && (!rowItemType.Equals ( "model")) && (!rowItemType.Equals ("brand")) && ((Requrl.Contains("bb.aspx"))))
                 {
                     TBW_ITEM_NAME = rowitemtypetostring + "=" + rowItemValue;
                 ...
                 else if ((!rowItemType.Equals ("category")) && (!rowItemType.Equals ("model")) && ((Requrl.Contains("fl.aspx")) || (Requrl.Contains("pl.aspx")) || (Requrl.Contains("pd.aspx")) || (Requrl.Contains("ps.aspx")) && ((!rowItemType.Equals ("user search")) && !(rowItemType.Contains("usersearch")))))
                 {
                     TBW_ITEM_NAME = rowitemtypetostring + "=" + rowItemValue;

                 }
     //else if ((rowItemType != "brand") && (rowItemType != "category") && ((Requrl.Contains("ct.aspx")) || (Requrl.ToLower().Contains("microsite.aspx"))))
                 else if ((!rowItemType.Equals("brand")) && (!rowItemType.Equals ("category")) && ((Requrl.Contains("ct.aspx")) || (Requrl.ToLower().Contains("microsite.aspx"))))
                 {
                     TBW_ITEM_NAME = rowitemtypetostring + "=" + rowItemValue;
                 ...
                 else if ((rowItemType.Equals ("model")) && ((Requrl.Contains("fl.aspx")) || (Requrl.Contains("pl.aspx")) || (Requrl.Contains("pd.aspx")) || (Requrl.Contains("ps.aspx"))))
                 {
                 ...
                 else if ((!rowItemType.Equals ("category")) && (!rowItemType.Equals ("user search")) && (!(rowItemType.Contains("usersearch"))) && (!rowItemType.Equals ("model")) && (Requrl.Contains("ps.aspx") || Requrl.Contains("pl.aspx")))
                 {
                     TBW_ITEM_NAME = rowitemtypetostring + "=" + rowItemValue;
                 }
                 //else if ((rowItemType == "user search") && (row["url"].ToString().ToLower().Contains("ps.aspx")) && (Requrl.Contains("fl.aspx")))
                 else if ((!rowItemType.Equals ("user search")) && (row["url"].ToString().ToLower().Contains("ps.aspx")) && (Requrl.Contains("fl.aspx")))
                 {
                     TBW_ITEM_NAME = "UserSearch" + "=" + rowItemValue;
                 }
                 //else if (((rowItemType != "brand")) && ((rowItemType != "model")) && ((row["Url"].ToString().Contains("bb.aspx"))))
                  else if (((!rowItemType.Equals("brand")) )&& (!rowItemType.Equals ("model")) && ((row["Url"].ToString().Contains("bb.aspx"))))
                 {
