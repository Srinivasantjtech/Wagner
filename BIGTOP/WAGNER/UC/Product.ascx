...
<script language="javascript" type="text/javascript">
    ...
    function MailReset() {
        ...
        document.getElementById("counter_DU").value = "600";
    }
    function strtrim(s) {
        s = s.replace(/(^\s*)|(\s*$)/gi, "");
        s = s.replace(/[ ]{2,}/gi, " ");
    ...
    function shippinginfoload() {
        ...
        var shipload = document.getElementById("shipping");
        if (shipload != null) {
            $.ajax({
                type: "POST",
    ...
    function AskaQuestionLoad() {
        ...
        var shipload = document.getElementById("messages");
        if (shipload != null) {
            $.ajax({
                type: "POST",
    ...
    function BulkBuyLoad() {
        var testval = "bulkbuy";
        var bulkbuyLoad = document.getElementById("bulkbuy");
        if (bulkbuyLoad != null) {
            $.ajax({
                type: "POST",
...
<script language="javascript" type="text/javascript">
 ...
 <script type="text/javascript">
     ...
     function contactus()
     {
         ...
         $("#myTab li:nth-child(2)").addClass("active").show();

         $(".tab-content div").removeClass("active");
         var activeTab = $("#myTab li:nth-child(2)").find("a").attr("href");
