...
<asp:HiddenField ID="hidSourceID" runat="server" />
    ...
    $(document).ready(function () {
       ...
       $(document).ready(function () {
        ...
        //    $("#BtnL2Continue").click(function () {
        //        try

        //        {
        //            $('html,body').animate({
        //                scrollTop: $(".ship_method").offset().top
        //            },
        //                'slow');
        //        }
                 ...
                 <% 
                	...
                	<div class="accordion_head_green white_color clearfix" style="text-align:center">
                       ...
                       <div class="col-xs-19" style="text-align:center">
                           <img src="images/checkout_tick.png" class="mr15" alt=""/>
...
<%--                          <% if (lblshipcost.Text != "" && lblshipcost.Text != "0")
                        ...
                        %>
                                   <span style="display:none;" id="shipping_charge_domestic_value">
                                     <asp:Label ID="lblshipcost" runat="server" Text="" Visible ="false"></asp:Label>
               ...
               <div class="clearfix">
                ...
                <div class="headingwrap active clearfix mt20 mb20" id="divl4payment" runat="server">
                    ...
                    <h4 class="numaric_heading inlineblk">Submit Order</h4>
                      <div class="col-sm-19 pv15 br_dark m10"  runat="server">
                          <div class="form-group mb10 clearfix">
                            <label class="col-md-7 pl0">Purchase Order No :</label>
                            <div class="col-md-10 mpl0">
                          <asp:TextBox  Width="100%" MaxLength="12"  ID="txtintporelease_No" runat="server" 
                            ...
                            <div id="div_linkint"  >Payment Method: To Be Advised
                                    </div>
                   ...
                   <%}
                      ...
                      {     %>
                        ...
                        <p class="text-center">
                            ...
                            <asp:Button runat="server" ID="btnPay" Text="Make Payment" class="ph30 f16 btn primary-btn-blue "  OnClick="btnPay_Click" OnClientClick="Setinit(this.id)"   />        <br />
                  ...
                  <div class="modal-dialog custom">
                        <div class="modal-content">
                         <div class="close-selected">
                                                       <asp:ImageButton ID="btnclose1" runat="server" data-dismiss="modal" 
                                                       src="/Images/close_btn.png"    /> <%--OnClientClick="MouseOut();"--%>
