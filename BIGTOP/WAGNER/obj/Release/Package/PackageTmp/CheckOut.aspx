  ...
  <%--<a aria-controls="collapseOne" aria-expanded="true" href="#collapseOne" class="checkoutpanel" data-parent="#accordion" data-toggle="collapse">--%>
                    <div id="headingOne" role="tab" class="panel-heading" style="background-color: #0069b2;color:#fff;">
                      ...
                      <span>
                        ...
                        %>
                      <img class="pull-right" src="<%=image6%>"/>
                      </span></span>
                        </h4>
                    </div>
                   <%-- </a>--%>
                  ...
                  <div class="modal-dialog custom">
                        <div class="modal-content">
                         <div class="close-selected">
                             <%
                                 string image8 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "Images/close_btn.png";
                        %>
               ...
               <div class="modal-dialog custom">
                        <div class="modal-content">
                         <div class="close-selected">
                             ...
                             <%
                                 string image10 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "Images/close_btn.png";
                        %>
                          <asp:ImageButton ID="ImageButton3" runat="server" 
                                                       src="<%=image10 %>"   OnClientClick="CloseSCP();" />
        ...
        <tr>
            <td align="left">
                ...
                <table id="tblBasebill" width="560" class="BaseTblBorder" align="left" border="0"
                    ...
                    <tr>
                        <td colspan="100%" background="<%=System.Configuration.ConfigurationManager.AppSettings["CurrentUrl"].ToString()%>images/17.gif" class="TableRowHead">
        ...
        <tr>
            <td align="left">
                <table id="tblBase" width="560" class="BaseTblBorder" border="0px" cellpadding="3"
                    cellspacing="0">
                    <tr>
                        <td class="TableRowHead" background="<%=System.Configuration.ConfigurationManager.AppSettings["CurrentUrl"].ToString()%>images/17.gif">
