<%@ Page Language="C#" MasterPageFile="~/mainpage.master" AutoEventWireup="true"
    Inherits="RetailerEditUserProfile" Title="Untitled Page" Culture="en-US"
    UICulture="en-US" CodeBehind="RetailerEditUserProfile.aspx.cs" %>
                    ...
                    <td align="center">
                        <table width="558" cellspacing="0" align="center">
                                    ...
                                    <div class="box1">
                                        ...
                                        <table id="user" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="width: 30%">
                                                    <span class="form_1">
                                                        ...
                                                        <asp:Label ID="Label10" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                                            Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td style="width: 30%;">
                                                    <span class="form_2">
                                                        <asp:TextBox autocomplete="off" ID="txtFname" ReadOnly="false" runat="server" MaxLength="40"
                                                            CssClass="input_dr" Width="203px"></asp:TextBox></span>
                                                </td>
                                                <td>
                                             ...
                                             <tr>
                                                <td style="width: 30%">
                                                    <span class="form_1">
                                                        ...
                                                        <asp:Label ID="Label19" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                                            Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td style="width: 30%;">
                                                ...
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfvLname" runat="server" ControlToValidate="txtLname"
                                                        Display="Dynamic" meta:resourcekey="rfvLname" ValidationGroup="Mandatory" Class="vldRequiredSkin"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        <asp:Label ID="lblAdd1" Class="lblNormalSkin" runat="server" meta:resourcekey="lblAdd1"></asp:Label><asp:Label
                                                            ID="Label1" runat="server" Class="lblRequiredSkin" Visible="true" Text="*" Width="1px"></asp:Label></span>
                                                </td>
                                                <td>
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtAdd1" CssClass="input_dr"
                                                            runat="server" MaxLength="30" Width="203px"></asp:TextBox></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        <asp:Label ID="lblAdd2" Class="lblNormalSkin" runat="server" meta:resourcekey="lblAdd2"></asp:Label></span>
                                                </td>
                                                <td>
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtAdd2" CssClass="input_dr"
                                                            runat="server" MaxLength="30" Width="203px"></asp:TextBox></span>
                                                </td>
                                                <td>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        <asp:Label ID="lblAdd3" Class="lblNormalSkin" runat="server" meta:resourcekey="lblAdd3"></asp:Label></span>
                                                </td>
                                                <td>
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtAdd3" CssClass="input_dr"
                                                            runat="server" MaxLength="30" Width="203px"></asp:TextBox>
                                                    </span>
                                                </td>
                                                <td>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        <asp:Label ID="lblCity" Class="lblNormalSkin" runat="server" meta:resourcekey="lblCity"></asp:Label><asp:Label
                                                            ID="Label2" runat="server" Class="lblRequiredSkin" Visible="true" Text="*" Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtCity" CssClass="input_dr"
                                                            runat="server" MaxLength="30" Width="203px"></asp:TextBox>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="height: 28px">
                                                    <span class="form_1">
                                                        ...
                                                        <asp:Label ID="Label3" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                                            Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td style="height: 28px">
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" Visible="false" autocomplete="off" ID="drpState" CssClass="input_dr"
                                                            runat="server" MaxLength="20" Width="203px"></asp:TextBox>
                                                        <asp:DropDownList ID="ddlstate" runat="server" Width="210px" Class="DropdownlistSkin"
                                                            Enabled="true">
                                                        </asp:DropDownList>
                                                    </span>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfvtxtstate" meta:resourcekey="rfvState"
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        ...
                                                        <asp:Label ID="Label4" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                                            Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="form_2">
                                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtZip" CssClass="input_dr"
                                                            runat="server" MaxLength="10" Width="203px"></asp:TextBox></span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        ...
                                                        <asp:Label ID="Label6" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                                            Width="1px"></asp:Label>
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="form_1">
                                                        <asp:Label ID="lblSubscribe" Class="lblNormalSkin" runat="server" Text="Subscribe mail"></asp:Label>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span class="form_1" style="text-align: left;">&nbsp;
                            ...
                            <tr>
                                <td>
                                    <span class="form_1">
                                        ...
                                        <asp:Label ID="Label5" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                            Width="1px"></asp:Label>
                                    </span>
                                </td>
                                <td>
                                    <span class="form_2">
                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtPhone" CssClass="input_dr"
                                            runat="server" MaxLength="16" Width="203px"></asp:TextBox>
                                    </span>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 67%">
                                    <span class="form_2">
                                        <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtFax" CssClass="input_dr"
                                            runat="server" MaxLength="16" Width="203px"></asp:TextBox></span>
                                </td>
                                <td>
                ...
                <div class="box1">
                    ...
                    <table id="Table1" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="width: 30%">
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label7" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label>
                                </span>
                            </td>
                            <td style="width: 30%">
                                <span class="form_2">
                                    <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtbilladd1" runat="server"
                                        CssClass="input_dr" MaxLength="30" Width="203px"></asp:TextBox></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="form_2">
                                    <asp:TextBox ReadOnly="false" autocomplete="off" ID="txtbilladd2" runat="server"
                                        CssClass="input_dr" MaxLength="30" Width="203px"></asp:TextBox>
                                </span>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label9" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label>
                                </span>
                            </td>
                            <td>
                                <span class="form_2">
                                    <asp:TextBox Visible="false" ReadOnly="false" autocomplete="off" ID="drpBillState"
                                        runat="server" CssClass="input_dr" MaxLength="20" Width="203px"></asp:TextBox>
                                    <asp:DropDownList ID="ddlbillstate" runat="server" Enabled="true" Width="210px" Class="DropdownlistSkin">
                                    </asp:DropDownList>
                                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label11" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="rfvbZip" Class="vldRequiredSkin" runat="server" ControlToValidate="txtbillzip"
                                    meta:resourcekey="rfvZip" Display="Dynamic" ValidationGroup="Mandatory"></asp:RequiredFieldValidator><asp:FilteredTextBoxExtender
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    <asp:Label ID="lblbillCountry" runat="server" meta:resourcekey="lblbillCountry" Class="lblNormalSkin"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
                                    <asp:DropDownList ID="drpBillCountry" runat="server" Enabled="true" Width="210px"
                                        Class="DropdownlistSkin" AutoPostBack="True" OnSelectedIndexChanged="drpBillCountry_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label12" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label>
                                </span>
                            </td>
                            <td>
                ...
                <div class="box1">
                    ...
                    <table id="Table2" width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td colspan="3">
                                <asp:CheckBox ID="ChkShippingAdd" runat="server" Visible="true" AutoPostBack="true"
                                    Enabled="true" Class="CheckBoxSkin" Checked="false" meta:resourcekey="ChkShipTitle"
                        ...
                        <tr>
                            <td style="width: 30%">
                                <span class="form_1">
                                    <asp:Label ID="lblshipadd1" runat="server" meta:resourcekey="lblshipaddress1" Class="lblNormalSkin"></asp:Label><asp:Label
                                        ID="Label13" runat="server" Class="lblRequiredSkin" Visible="true" Text="*" Width="1px"></asp:Label></span>
                            </td>
                            <td style="width: 30%">
                                <span class="form_2">
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    <asp:Label ID="lblshipadd2" runat="server" meta:resourcekey="lblshipaddress2" Class="lblNormalSkin"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    <asp:Label ID="lblshipcity" runat="server" meta:resourcekey="lblshipCity" Class="lblNormalSkin"></asp:Label><asp:Label
                                        ID="Label14" runat="server" Class="lblRequiredSkin" Visible="true" Text="*" Width="1px"></asp:Label>
                                </span>
                            </td>
                            <td>
                                <span class="form_2">
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label15" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
                                    <asp:TextBox Visible="false" ReadOnly="false" autocomplete="off" ID="drpShipState"
                                        runat="server" CssClass="input_dr" MaxLength="20" Width="203px"></asp:TextBox>
                                    <asp:DropDownList ID="ddlshipstate" runat="server" Enabled="true" Width="210px" Class="DropdownlistSkin">
                                    </asp:DropDownList>
                                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    <asp:Label ID="lblshipCountry" runat="server" meta:resourcekey="lblshipCountry" Class="lblNormalSkin"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
                                    <asp:DropDownList ID="drpShipCountry" Enabled="true" runat="server" Width="210px"
                                        Class="DropdownlistSkin" AutoPostBack="True" OnSelectedIndexChanged="drpShipCountry_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="form_1">
                                    ...
                                    <asp:Label ID="Label17" runat="server" Class="lblRequiredSkin" Visible="true" Text="*"
                                        Width="1px"></asp:Label></span>
                            </td>
                            <td>
                                <span class="form_2">
