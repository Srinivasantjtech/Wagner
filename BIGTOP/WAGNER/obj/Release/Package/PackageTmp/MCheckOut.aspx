      ...
      <%--             <label class="checkbox-inline">   
         <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnPayPalAPIPayLink_Click" CausesValidation="false" ><label>                
             ...
             <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnSecurePayLink_Click" CausesValidation="false" ><label> 
                            <%
                                string image6 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/pay1ch.png";
                                       %>
                                <asp:Image ID="ImagePaySP" runat="server" ImageUrl="<%= image6 %>"  style="margin-top: -5px;cursor: pointer;" alt="cc"/>
                                </label></asp:LinkButton></label>
                                <%} %>
               ...
               <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" ><label>
                       <%
                           string image7 = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/pay2uch.png";
                        %>
                                <asp:Image ID="ImagePay" runat="server" ImageUrl="<%=image7%>"  style="margin-top: -5px;cursor: pointer;" alt="cc"/>
                                </label></asp:LinkButton></label>
