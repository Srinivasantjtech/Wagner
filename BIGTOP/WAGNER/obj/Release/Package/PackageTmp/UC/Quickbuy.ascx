...
<input id="HidItemCode" type="hidden" clientidmode="Static" accesskey="HidItemCode"     runat="server" />
...
<table width="180px" height="110px" border="0" cellspacing="0" cellpadding="0"><tr><td class="back_5">
<table width="180" border="0" align="left" cellpadding="0" cellspacing="0"><tr><td width="138px" height="30" class="tx_6" align="left">&nbsp;&nbsp;&nbsp;&nbsp;QUICK BUY</td>
<td align="center"> &nbsp;<img src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/ico_11.gif" width="14" height="17" /> </td></tr> </table> </td> </tr>
 <tr><td class="back_tb_cost"><table width="180" border="0" cellpadding="5" cellspacing="0" class="tx_1">
<tr><td height="90px"><asp:UpdatePanel runat="server" ID="updpnlQB" UpdateMode="Conditional">
<ContentTemplate><table width="150px" align="left" cellpadding="5" cellspacing="0" border="0">
 <tr> <td colspan="2"><table id="tblitembox" cellpadding="0" cellspacing="0" border="0">
<tr class="tx_4table"> <td align="left"> <strong>Item Number</strong></td><td align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;Qty</strong></td></tr>
 <tr><td colspan="2">&nbsp;</td></tr>
<tr><td align="left"><input type="text" id="txitem1" <%=(!IsEcomenabled() ? "ReadOnly" : "")%> style="width: 85px;
background-color: #FFFFFF; color: #000000;" size="17" value="Item#" onblur="FillValue1(this)"
onfocus="Focus1(this)" /></td>
<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="txqty1" <%=(!IsEcomenabled() ? "ReadOnly" : "")%>
style="width: 30px; background-color: #FFFFFF; color: #000000;" size="2" onblur="javascript:return Check1(1);" /></td></tr>
<tr><td colspan="2">&nbsp; </td></tr>
<tr><td align="left"> <input type="text" id="txitem2" <%=(!IsEcomenabled() ? "ReadOnly" : "")%> style="width: 85px;
 background-color: #FFFFFF; color: #000000;" size="17" value="Item#" onblur="FillValue1(this)"
 onfocus="Focus1(this)" /></td>
 <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="txqty2" <%=(!IsEcomenabled() ? "ReadOnly" : "")%>
style="width: 30px; background-color: #FFFFFF; color: #000000;" size="2" onblur="javascript:return Check1(2);" /></td></tr>
<tr><td colspan="2"> &nbsp;</td> </tr> <tr><td align="left">
<input type="text" id="txitem3" <%=(!IsEcomenabled() ? "ReadOnly" : "")%> style="width: 85px;
background-color: #FFFFFF; color: #000000;" size="17" value="Item#" onblur="FillValue1(this)"
onfocus="Focus1(this)" /></td>
<td align="right">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="txqty3" <%=(!IsEcomenabled() ? "ReadOnly" : "")%>
style="width: 30px; background-color: #FFFFFF; color: #000000;" size="2" onblur="javascript:return Check1(3);" /></td></tr>
<tr><td colspan="2">&nbsp;</td></tr></table></td></tr>
<tr><td align="center"><asp:ImageButton ID="BtnAddToCart" Width="154px"
Height="27px" runat="server" OnClientClick="return ValidateQCQty1();" OnClick="btnAddtoCart_ServerClick" /></td></tr>
<tr><td align="left"><% if (IsEcomenabled()){ %><a id="A1" href="~/BulkOrder.aspx?txtcnt=20" class="tx_14" runat="server">Bulk Order
Forms</a> <%} %></td></tr></table></ContentTemplate>
<Triggers><asp:AsyncPostBackTrigger ControlID="BtnAddToCart" EventName="Click" /></Triggers></asp:UpdatePanel></td></tr>
<cc2:msgBox ID="MsgBox1" runat="server"></cc2:msgBox></table></td></tr></table>
