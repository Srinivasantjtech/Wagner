...
<div id="logindiv"  runat="server" class="col-lg-6 col-md-6 cus_login padding_left_right login_height">
 <div class="customer_login">Customer Login <img src="$CDN$images/MicroSiteimages/cross_blu.png" class="pull-right"></div>
...
<div id="registerdiv"  runat="server" class="col-lg-6 col-md-6 new_cus_bg padding_left_right">
 ...
 <div class="new_customer">New Customer Sign Up<img src="$CDN$images/MicroSiteimages/cross_green.png" class="pull-right"></div>
...
<div class="modal-footer">
         <a href="" class="gray_40 font_weight"> <img src="$CDN$images/MicroSiteimages/pdf.png" class="margin_right"></a> <asp:HyperLink ID="hlink" class="gray_40 font_weight" runat="server" NavigateUrl="~//Home.aspx" Text="Continue Browsing Web Site"/>
         </div>
        </div>
      </div>
  </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <%--    <button aria-label="Close" data-dismiss="modal" class="close white_bg" type="button">
        ...
        <div class="col-lg-12"><img src="$CDN$images/MicroSiteimages/oops.png"></div>
        <div class="col-lg-12">
