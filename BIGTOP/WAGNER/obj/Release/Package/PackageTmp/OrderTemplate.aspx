<%@ Page Language="C#" MasterPageFile="~/mainpage.master" AutoEventWireup="true" Inherits="OrderTemplate" Title="Untitled Page"  Culture="en-US" UICulture="en-US" ValidateRequest="false" Codebehind="OrderTemplate.aspx.cs" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="maincontent" Runat="Server"> <uc1:BulkOrder ID="BulkOrder1" runat="server" /> </asp:Content>
