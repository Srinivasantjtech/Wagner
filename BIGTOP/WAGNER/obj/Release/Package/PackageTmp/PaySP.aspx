...
<div runat ="server" id="div3" >
          ...
          <div class="form-col-2-8">
                ...
                <div class="form-col-2-8">
           	  <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnSecurePayLink_Click"  CausesValidation="false" style="cursor:pointer;" ><label style="cursor:pointer;"><img style="margin-bottom:-10px" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/pay1ch.png" ></label>  </asp:LinkButton>            
            </div>
                ...
                {%>
           	  ...
           	  <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" style="cursor:pointer;"><label style="cursor:pointer;"><img style="margin-bottom:-13px" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/pay2uch.png" ></label></asp:LinkButton>
              <%} %>
            </div>
              <div class="cl"></div>   
           ...
           <asp:DropDownList ID="drppaymentmethod" runat="server" width="200px" CssClass="cardinput" onchange="Controlvalidate('dd')"   Visible =false />     
            ...
            <%-- <div class="form-col-2-8">
             ...
             <div class="cl"></div>--%>
          <div class="form-col-2-8" style="margin-top: 21px;">
                 <asp:Label runat="server" ID="Label1" style="font-size:14px;" >Name on Card &nbsp;&nbsp;<span class="redspan">*</span> </asp:Label>
                </div>
                <div class="form-col-2-8" style="margin-top: 30px;">
                  <asp:TextBox runat="server" ID="txtCardName"  CssClass="cccardinput"    MaxLength="50"  OnBlur="Controlvalidate('cn')"  />
                </div>
                <div class="form-col-2-8" style="margin-top: 30px;">
              ...
              <div class="form-col-2-8" style="margin-top: 0px;">
                <asp:Label runat="server" ID="lblcardnumber" style="font-size:14px;"   >Card Number &nbsp;&nbsp;<span class="redspan">*</span> </asp:Label>
              </div>
              <div class="form-col-2-8" >
               <asp:TextBox runat="server" ID="txtCardNumber" CssClass="cccardinput"   MaxLength="19" OnBlur="Controlvalidate('cno')" />
              </div>
              <div class="form-col-2-8" >
               ...
               <div class="cl"></div>
            	...
            	<div class="form-col-2-8"  style="margin-top: 0px;">
                 <asp:Label runat="server" ID="lblcardcvvnumber" style="font-size:14px;"  >CVV Number &nbsp;&nbsp;<span class="redspan">*</span> </asp:Label>
                </div>
                <div class="form-col-1-8" >
                  <asp:TextBox runat="server" ID="txtCardCVVNumber" Width="100px" CssClass="cccardinput" MaxLength="4" OnBlur="Controlvalidate('cvv')"/>         
                </div>
                <div class="form-col-2-8" >
              ...
              <span style="font-size: 10px;color: #0033CC; float: left;margin-top: 4px;">  
              <asp:LinkButton ID="myLink" CssClass="modal" style="color: #01AEF0;text-decoration: none;"  runat="server"  >
              <img style="cursor: pointer;" alt="help" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/question-icon.png"/> 
    ...
    DropShadow="true" runat="server" TargetControlID="myLink" RepositionMode="None">
          ...
          <div class="form-col-2-8"  style="margin-top: 0px;">
                   <asp:Label runat="server" ID="lblexpirationdate"  style="font-size:14px;" >Card Expiry &nbsp;&nbsp;<span class="redspan">*</span> </asp:Label>
                </div>
                <div class="form-col-1-8">
                <asp:DropDownList NAME="drpExpmonth"  ID="drpExpmonth" runat="server"  CssClass="cccardselect">           
                ...
                <div class="form-col-1-8">
                <asp:DropDownList NAME="drpExpyear"  ID="drpExpyear" runat="server" CssClass="cccardselect">          
                    </asp:DropDownList>
                    </div>
                <div class="form-col-2-8">
...
<%--                class="button normalsiz btngreen fleft"        --%>
                <asp:Button runat="server" ID="btnPay"  style="width:100px;"  class="ccpaybtn" OnClick="btnSecurePay_Click" OnClientClick="javascript:Setinit()" />       
