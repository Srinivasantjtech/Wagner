...
<table id ="tblBase"  class="BaseTblBorder" align ="left" width="100%" border ="0px" cellpadding="3" cellspacing="0">
       ...
       <tr>
            <td class="TableRowHead" background = "<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/17.gif" colspan ="7"><asp:Label id="lblQuoteID" runat="server" Text="" > ></asp:Label></td>
       </tr>
            ...
            <td colspan ="7">
                <table class ="BaseTable1" cellpadding="3" cellspacing="1" width="650">
                        <tr class="TableRowHead">
                           <td background = "<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/17.gif" class="TableRowHead" align ="center" style="width: 210px">Item No.</td>
                           <td background = "<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/17.gif" class="TableRowHead" align ="center" width ="100px">Qty</td>
                            <td background = "<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/17.gif" class="TableRowHead" align ="center" width ="100px">Cost</td>
                            <td background = "<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/17.gif" class="TableRowHead" align ="center" width ="100px">Amount</td>
                        </tr>
