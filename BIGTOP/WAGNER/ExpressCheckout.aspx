...
<%--<script language="JavaScript" type="text/javascript">    var message = "Right click not allowed this page!";
    ...
    <script type="text/javascript">
        ...
        function btnPayPalPayLink()
        {
            ...
            document.getElementById("ctl00_maincontent_ImagePay").src = "http://cdn-staging.wes.com.au/BIGTOP/images/paypal_check.png";
            document.getElementById("ctl00_maincontent_ImagePaySP").src = "http://cdn-staging.wes.com.au/BIGTOP/images/3d_Secure-UnCheck.png";
...
{}
        ...
        function btnSecurePayLink() {
            ...
            document.getElementById("ctl00_maincontent_ImagePaySP").src = "http://cdn-staging.wes.com.au/BIGTOP/images/3d_Secure-Check.png";
 ...
 setupForm();
//  var lblsp = document.getElementById('lblsp');
//    lblsp.setAttribute('disabled', 'disabled');
...
{}
 ...
 $("#<%=BtnL3Continue_Int.ClientID %>").click(function () {
                if (document.forms[0].elements["<%=drpSM1.ClientID%>"].value == "International Shipping - TBA") {


                    document.getElementById('ctl00_maincontent_BtnL3Continue').value = "Processing...";
                    $("#ctl00_maincontent_BtnL3Continue").attr("disabled", true);
                    return true;
                }
            });
	          ...
	          <div class="wrapleft pr40 mpr0 pb20" runat="server" id="Level1">  
                ...
                <div class="checkoutleft" id="letstartdivlogin" runat="server">
                    ...
                    <%--    <div  class="text-center">OR</div>
                         <p class="text-center">
                         <div id="myContainer" class="text-center"></div>
                        </p>--%>
                    </form>
                </div>
   ...
   <asp:RequiredFieldValidator ID="rfvddlstate" Display="Dynamic"  runat="server" Text="Select State/Province" ErrorMessage="Required" ControlToValidate="drpstate1" ValidationGroup="Mandatory_Express_Level2" InitialValue="" ForeColor="Red"></asp:RequiredFieldValidator>
          ...
          AutoPostBack="True" > </asp:DropDownList>
                            ...
                            <div class="form-group mb10 clearfix">
                                ...
                                <div class="col-md-12 mpl0">
                               <asp:TextBox runat="server" ID="txtDELIVERYINST" Text="" class="form-control" MaxLength="30" onkeyup="javascript:keyboardup1(this);" ></asp:TextBox>
                                </div>
                            </div>
						</div>
                ...
                <div class="checkoutleft">
                    ...
                    <asp:RequiredFieldValidator Display="Dynamic" ID="rfvdrpSM1" InitialValue="Please Select Shipping Method" ControlToValidate="drpSM1" runat="server" ErrorMessage="Please Select Shipping Method" ValidationGroup="Mandatory_Express_Level3"  SetFocusOnError="true" ForeColor="Red" />
                        ...
                        <asp:Button runat="server" ID="BtnL3Continue" OnClick="BtnL3Continue_Click" Text="Continue" class="ph30 f16 btn primary-btn-green"    ValidationGroup="Mandatory_Express_Level3" UseSubmitBehavior="true"  />   
                         <asp:Button runat="server" ID="BtnL3Continue_Int"  OnClick="BtnL3Continue_Click" Text="Submit Order" class="ph30 f16 btn primary-btn-green"    ValidationGroup="Mandatory_Express_Level3" UseSubmitBehavior="false" Visible="false" />   
</p>
                ...
                <div class="clearfix">
                   ...
                   <div class="form-group row p15 text-left clearfix">
                         <div class="col-sm-20 pv15 br_dark">
                            ...
                            <p class="mb0">
                            	Pickup from bigtop -  Warehouse <br />
...
<div class="form-group col-lg-8 nolftpadd">
            ...
            <div class="cl"></div>
                   ...
                   <%}
                      ...
                      {     %>
                        <div class="col-sm-20 mp0 nolftpadd" id="divpp" style="display:block; text-align:center; margin-bottom:15px; border:1px solid #ccc;">
                            <div class="form-group text-center">
                                ...
                                <h3 class="blue_text"><b>Total Amount &nbsp $ <asp:Label runat="server" ID="lblpaypaltotamt" CssClass="totalamt"  /> </b></h3>
                                   ...
                                   <div class="text-center" id="divppbuttons" style="display:none">
                          <div id="paypal-button"></div>
<div id="paypal-credit-button"></div>
                                </div>
                            <input id="device_data" type="hidden" />
                            <div id="divppproc"  class="input-group pay-group" style="display:none">
         
        <input id="Submit1" class="btn btn-success" onclick="return false;" type="submit" value="Processing..Please Wait.." disabled="disabled"/>
                           ...
                           <div id="divsucess_pp" style="display:none;text-align:center" class="accordion_head_green clear" >
        Transaction Approved! <br/> Your Order will now be processed, Thanks for shopping at BIGTOP Online! <br />
         Payment Method: PayPal
                               <div id="divrefno_pp" class="accordion_head_green clear"></div>
     </div>
     <div id="divFailed_pp" style="display:none;text-align:center;background: #FFF200;font-size:14px"  class="accordion_head_yellow gray_40">
       Transaction failed!
           <div id="diverrorno_pp">Please Try again or use a different card / payment method.</div>
     </div>
                         <%} %>
...
<script type="text/javascript">
    $(function () {
	 ...
	 <!-- Event snippet for PayNow-Button-Tracking conversion page In your html page, add the snippet and call gtag_report_conversion when someone clicks on the chosen link or button. --> <script> function gtag_report_conversion(url) { var callback = function () { if (typeof(url) != 'undefined') { console.log(url); window.location = url; } }; gtag('event', 'conversion', { 'send_to': 'GTM-5R78S54/-bTxCKf5stYBEO65r_UD', 'transaction_id': '', 'event_callback': callback }); return false; } </script>
...
if (document.getElementById("ctl00_maincontent_lblShippingMethod").innerHTML == "Standard Shipping") {
    ...
    var totamt = document.getElementById('totamtwithcouriercrge');
    ...
    //alert(amt);
       ...
       //if (document.getElementById("ctl00_maincontent_ImagePaySP").src == "https://cdn.wes.com.au/BIGTOP/images/3d_Secure-Check.png")
         if (document.getElementById("ctl00_maincontent_ImagePaySP").src == "http://cdn-staging.wes.com.au/BIGTOP/images/3d_Secure-Check.png") 
         {
...
//                                disableForm();
//                                 document.getElementById('divppproc').style.display = "block";
//                                 document.getElementById('divppbuttons').style.display = "none";

//                                
//                                 
//                                 SaleTrans_Paypal(payload.nonce);
//                             });
//                         },
//                     }, '#paypal-button');
...
//              });
            ...
            // document.getElementById("overlay").style.cursor = "progress";
...
////// }
// $('#ctl00_maincontent_Level4').children().off('click');
}
...
//}
// $('#ctl00_maincontent_Level4').children().on('click');
}
payBtn.addEventListener('click', function (event) {
    ...
    dropin.requestPaymentMethod(function (err, payload) {
        ...
        if (!payload.liabilityShifted) {
            ...
            // document.getElementById("lblsp").style.display = "none";
            document.getElementById("lblsp").classList.add("disabledlabel");
//            document.getElementById("ctl00_maincontent_LinkButton2").disabled = true;
            //            $("#<%=LinkButton2.ClientID %>").off('click');
           // $("#lblsp").children().attr("disabled", "disabled");
document.getElementById("lblpp").style.display = "none";
...
//            if (x == 1) {
                ...
                //  x[0].innerHTML = '<span  onclick=hide()>Choose another way to pay</span>';
                x[0].outerHTML = '<div  data-braintree-id="toggle" class="braintree-large-button braintree-toggle" tabindex="0" style="background:white;border:none;display;none" "></div>';
...
//                enableFrm();
//                document.getElementById("ctl00_maincontent_loading").style.display = "none";
//                document.getElementById("lblsp").style.display = "block";
//            }
       }
...
//         var amt = parseFloat(amt1);
                  //  alert(devicedata);
                   // var device_data = document.getElementById('device_data').val;
                    //  alert(device_data);
         ...
         $.ajax({
             type: "POST",
             url: "ExpressCheckout.aspx/SaleTrans_Paypal",
             data: "{'nounce':'" + a + "','Amount':'" + amt + "','devicedata':'" + devicedata + "'}",
             contentType: "application/json; charset=utf-8",
             dataType: "json",
             success: function (data) {
                 if (data.d.includes("Error") == false) {

                     var divOk = document.getElementById('divsucess_pp');
                     divOk.style.display = "block";
                     enableFrm();
                     disableFormedit();
                     document.getElementById('ctl00_maincontent_PayType').style.display = "none";
                     var divOkdrp = document.getElementById('divpp');
                     document.getElementById('divrefno_pp').style.display = "block";
                     document.getElementById('divrefno_pp').innerHTML = "Order Reference ID:" + data.d;
                     divOkdrp.style.display = "none";
                     document.getElementById('divppproc').style.display = "none";
                     
                     document.getElementById('divFailed_pp').style.display = "none";
                     document.getElementById('diverrorno_pp').style.display = "none";
                     ...
                     enablePayNow();
                     var divOk = document.getElementById('divFailed_pp');
                     document.getElementById('diverrorno_pp').style.display = "block";
                     //document.getElementById('diverrorno_pp').innerHTML = data.d
                     divOk.style.display = "block";
                     document.getElementById('ctl00_maincontent_PayType').style.display = "vlock";
                     document.getElementById('divsucess_pp').style.display = "none";

                     document.getElementById('divrefno_pp').style.display = "none";
                     document.getElementById("lblsp").style.display = "block";
                     // dropin.clearSelectedPaymentMethod();
                     enableFrm();
...
//         var amt = parseFloat(amt1);
                    ...
                    //var ttOrder = document.getElementById('ctl00_maincontent_ttOrder').value;
                   // alert(ttOrder);
                    $.ajax({
                        type: "POST",
                        ...
                        success: function (data) {
                            ...
                            if (data.d.includes("Error") == false) {
                                ...
                                // document.getElementById('navcart').innerHTML = "<a class=dropdown-toggle href=orderDetails.aspx?CartItem=0 rel=nofollow>Cart:0 items - $ 0.00 <b class=glyphicon glyphicon-menu-down></b></a>;
                                document.getElementById('navcart').style.display = "none";
                                var y = document.getElementsByClassName("braintree-large-button");
                                y[0].innerHTML = '';
                                y[0].outerHTML = '';
                                // document.getElementById('navcart - div').style.display = "none";
                            ...
                            else if (data.d.includes("Invalid User Data") == true) {
                                alert("Invalid User Data .Please Fill Mandatory Fields")
                                window.location.href = "Orderdetails.aspx";
                            }
                            else if (data.d.includes("Order Amount Missmatch") == true) {
                                alert("Sorry there is mismatch in Total Amount.Please Checkout Again")
                                window.location.href = "orderdetails.aspx";
                            }
//                            else if (data.d.includes("Order No already exists") == true) {
//                                alert("Order No already exists, please Re-enter Order No")
//                            }
                            else {
                                ...
                                document.getElementById("lblsp").style.display = "inline-block";
                                document.getElementById("lblpp").style.display = "inline-block";
                                var x = document.getElementsByClassName("braintree-large-button");
                                x[0].outerHTML = '<div data-braintree-id="toggle" class="braintree-large-button braintree-toggle" tabindex="0" style="background:white;border:none" onclick="hide()"><span onclick="hide()">Choose another way to pay</span></div>';
                                enableFrm();
...
<script>
    paypal.use(['login'], function (login) {
        login.render({
            "appid": "ASvOVqyqxc-yuMXaYFBc3KyqixfkUi1kaYultQ_6vF0Ol2eNYfHuz6TAsbEscPvN4Ysp4IkLzLsmZET7",
            "authend": "sandbox",
            "scopes": "email",
            ...
            "buttonSize": "md",
            "fullPage": "true",
            "returnurl": "http://www.staging.wagneronline.com.au/expresscheckout.aspx"
        });
    });
</script>--%>
