<%@ Page Title="" Language="C#" MasterPageFile="~/Mainpage.master" AutoEventWireup="true" CodeBehind="ppapi.aspx.cs" Inherits="ppapi" %>
...
<div runat ="server" id="div1" >
 ...
 <asp:LinkButton ID="LinkButton1" runat="server" OnClick="btnSecurePayLink_Click"  CausesValidation="false" ><label><img style="margin-top: -5px;cursor: pointer;" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/pay1uch.png"></label>
</asp:LinkButton>            
</div>--%>
        <div class="form-col-2-8">
           	    <asp:LinkButton ID="LinkButton3" runat="server" OnClick="btnPayPalAPIPayLink_Click" CausesValidation="false" ><label><img style="margin-top: -5px;cursor: pointer;" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/pay3ch.png"></label></asp:LinkButton>
            </div>
            <div class="form-col-2-8">
           	    <asp:LinkButton ID="LinkButton2" runat="server" OnClick="btnPayPalPayLink_Click" CausesValidation="false" ><label><img style="margin-top: -5px;cursor: pointer;" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/pay2uch.png"></label></asp:LinkButton>
            </div>
          
            <div class="cl"></div>
            <div class="form-col-8-8">
              <img style="margin-bottom:15px" alt="cc" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/paypalEC.png">
