...
using System.Threading;
    public partial class IPNHandler : System.Web.UI.Page
    {
       ...
       // public int PaymentID = 0;
                           ...
                           // objErrorHandler.CreateLog(conformres["Status"].ToString() + "-"+ Session["USER_ROLE"].ToString());
                            ...
                            else
                            {
                                ...
                                if (objOrderServices.GetOrderStatus(objIPNinfo.Order_id) != OrderServices.OrderStatus.COMPLETED.ToString() && objOrderServices.GetOrderStatus(objIPNinfo.Order_id) != OrderServices.OrderStatus.Payment_Successful.ToString() && objOrderServices.GetOrderStatus(objIPNinfo.Order_id) != OrderServices.OrderStatus.Order_Received.ToString())
                                {
                                  ...
                                  objErrorHandler.CreatePayLog("before IPNHandler" + objIPNinfo.Order_id);
                                  if ((objIPNinfo.Website_Id == 3 && oOrderInfo.isppppp != 1) || (objIPNinfo.Website_Id == 4 && oOrderInfo.isppppp != 1))
                                    {
                                        HttpContext.Current.Session["ispaidpaypal"] = objIPNinfo.Order_id.ToString() + "#####" + "Pay" + "#####" + "Paid";
                                        objErrorHandler.CreateOrderSummarylog("inside ipn handler" + objIPNinfo.Order_id);
                                        objOrderServices.UpdateOrderStatus(objIPNinfo.Order_id, (int)OrderServices.OrderStatus.Payment_Successful);
                                    ...
                                    {
                                        objOrderServices.UpdateOrderStatus(objIPNinfo.Order_id, (int)OrderServices.OrderStatus.Online_Payment);
                                      objErrorHandler.CreatePayLog( ("before SentSignal inside ipnhadler page"+ "paymentid"+objIPNinfo.Payment_id.ToString() + "orderid:"+objIPNinfo.Order_id.ToString()));
                                        int Rtn = objOrderServices.SentSignal(objIPNinfo.Payment_id.ToString(), objIPNinfo.Order_id.ToString(), "190");
                                    }
        ...
        public void SendMail_AfterPaymentPP(int OrderId, int OrderStatus, bool isau)
        {
            string toemail = "";
            try
            {
                ...
                if (sHTML != "")
                {
                    ...
                    smtpclient.Credentials = new System.Net.NetworkCredential(objHelperServices.GetOptionValues("MAIL SERVER USERNAME").ToString(), objHelperServices.GetOptionValues("MAIL SERVER PASSWORD").ToString());
                    //Added by indu
                    DataTable dtcheckmailsend = objOrderServices.CheckMailLog_Email(objIPNinfo.Order_id, MessageObj.To.ToString());
                      if (dtcheckmailsend == null || dtcheckmailsend.Rows.Count == 0)
                      {
                          objErrorHandler.CreatePayLog_Final("Important IPNHadler before smtpclientsend-" + oOrderInfo.OrderID + "--" + MessageObj.To);
                          smtpclient.Send(MessageObj);
                          objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                          objErrorHandler.CreatePayLog_Final("Important IPNHandler after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                    ...
                    if (Convert.ToInt16(oUserInfo.USERROLE) == 1 || Convert.ToInt16(oUserInfo.USERROLE) == 2)
                    {
                      ...
                      DataTable dtcheckmailsend1 = objOrderServices.CheckMailLog_Email(objIPNinfo.Order_id,Emailadd);
                      if (dtcheckmailsend1== null || dtcheckmailsend1.Rows.Count == 0)
                      {
                          ...
                          objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                          objErrorHandler.CreatePayLog_Final("Important IPNHandler1 after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                        }
                        if (Adminemails != "")
                        {
                            ...
                            if (emailid.Length > 0)
                            {
                                foreach (string id in emailid)
                                {
                                    if (ApprovedUserEmailadd.ToUpper().ToString() != id.ToUpper().ToString() && Emailadd.ToUpper().ToString() != id.ToUpper().ToString())
                                    {
                                        ...
                                        DataTable dtcheckmailsend1 = objOrderServices.CheckMailLog_Email(objIPNinfo.Order_id, MessageObj.To.ToString());
                      if (dtcheckmailsend1== null || dtcheckmailsend1.Rows.Count == 0)
                      {
                         
                                        smtpclient.Send(MessageObj);
                                        objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                                        objErrorHandler.CreatePayLog_Final("Important IPNHandler2 after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                                    }
                                }
                            }
                      ...
                      if (dtcheckmailsend1== null || dtcheckmailsend1.Rows.Count == 0)
                      {
                                    ...
                                    smtpclient.Send(MessageObj);
                                    objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                                    objErrorHandler.CreatePayLog_Final("Important IPNHandler3 after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                                }
                                //MessageObj.CC.Add(emails.ToString());
                            }
                    ...
                    else
                    {
                      ...
                      if (dtcheckmailsend1== null || dtcheckmailsend1.Rows.Count == 0)
                      {
                                        ...
                                        smtpclient.Send(MessageObj);
                                        objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                                        objErrorHandler.CreatePayLog_Final("Important IPNHandler4 after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                                    }
                                }
                            }
                      ...
                      if (dtcheckmailsend1== null || dtcheckmailsend1.Rows.Count == 0)
                      {
                                    ...
                                    smtpclient.Send(MessageObj);
                                    objHelperServices.Mail_Log("PP", oOrderInfo.OrderID, MessageObj.To.ToString(), "");
                                    objErrorHandler.CreatePayLog_Final("Important IPNHandler5 after smtpclientsend-" + objIPNinfo.Order_id + "--" + MessageObj.To);
                      }
                                    //MessageObj.CC.Add(emails.ToString());
                                }
                            }
