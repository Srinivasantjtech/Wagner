...
AjaxControlToolkit.ModalPopupExtender modalPop = new AjaxControlToolkit.ModalPopupExtender();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Page.Title = "Wagner-Retailer Registration";
        if (!IsPostBack)
        {
            txtcompname.Focus();
            LoadCountryList();
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (cText.Text.Trim() == "")
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "Javascript", "javascript: checkEnableSubmit(); ", true);
        }
        else if (cVerify.UserValidated)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "Javascript", "javascript: checkselectedlist(); ", true);
    ...
    public int SaveUserProfile()
    {
        try
        {
            ...
            string Newpassword = objcrpengine.StringEnCrypt_password(TxtPassword.Text);
