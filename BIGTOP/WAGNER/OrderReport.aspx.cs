...
public partial class OrderReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            imgPrint.Src = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + imgPrint.Src;
            imgLogo.Src = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + imgLogo.Src;
        if (!IsPostBack)
        {
