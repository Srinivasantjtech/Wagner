...
<img id="imgPrint" runat="server"  />
<%--</a>--%>
   </asp:LinkButton> 
</p>
<h4 class="modal-title margin_top" id="myLargeModalLabel">
<img class="img-responsive pull-left margin_top_20" id="imgLogo" runat="server" alt="logo" /></h4>
<div class="clear"></div>
</div>
<div class="pull-right col-lg-4 col-sm-5 col-md-4 line_height_24 margin_top"><strong>Address :</strong> 
    Wagner Electronic Services <br /> 
 84-90 Parramatta Road,<br />
 Summer Hill, NSW, 2130, <br />  
 Australia <br />
              <hr class="hr_margin"/>
              <strong>Phone :</strong> (+61) 02 9798 9233</br>
              <hr class="hr_margin">
