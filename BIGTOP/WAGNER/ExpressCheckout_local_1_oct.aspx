...
<asp:HiddenField ID="hidSourceID" runat="server" />
    <script type="text/javascript">
        ...
        function btnPayPalPayLink()
        {
            ...
            document.getElementById("ctl00_maincontent_ImagePay").src = "/images/paypal_check.png";
            document.getElementById("ctl00_maincontent_ImagePaySP").src = "/images/master_uncheck.png";
        ...
        function btnSecurePayLink() {
            ...
            document.getElementById("ctl00_maincontent_ImagePaySP").src = "/images/master_check.png";
        ...
        function CRGE() {
            if (document.getElementById("ctl00_maincontent_lblShippingMethod") != null) {
                ...
                if (document.getElementById("ctl00_maincontent_lblShippingMethod").innerHTML == "Standard Shipping") {
                    document.getElementById("ctl00_maincontent_shipping_charge_domestic_value").style.display = 'block';
                    document.getElementById("ctl00_maincontent_shipping_charge_domestic_zero").style.display = 'none';
                }
                else {
                    document.getElementById("ctl00_maincontent_shipping_charge_domestic_value").style.display = 'none';
                    document.getElementById("ctl00_maincontent_shipping_charge_domestic_zero").style.display = 'block';
                }
            }
            else {
...
<%--                          <% if (lblshipcost.Text != "" && lblshipcost.Text != "0")
                        ...
                        %>
                                   <span style="display:none;" id="shipping_charge_domestic_value" runat="server">
                                    $ <asp:Label ID="lblshipcost" runat="server" Text="" Visible ="true"></asp:Label>
                                 ...
                                 <span style="display:none;" runat="server" id="shipping_charge_domestic_zero">
                        ...
                        <div class="form-group pt10 mb30 clearfix">
                            <div class="col-md-14 col-xs-17 pl0 mp0">
                              <%--  <select class="form-control">
                                 ...
                                 <asp:DropDownList NAME="drpSM1" ID="drpSM1" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="drpSM1_SelectedIndexChanged">
                 ...
                 if (objOrderServices.IsNativeCountry_Express(OrderID) == 1)
               {
                   ...
                   else
                   {
                       totamt = Convert.ToDecimal(lblAmount.Text);
                              ...
                              %> 
                                <label class="checkbox-inline lspace0">   
                                 <%--   OnClick="btnSecurePayLink_Click"--%>
             <asp:LinkButton ID="LinkButton2" runat="server" OnClientClick="btnSecurePayLink();return false;" CausesValidation="false" ><label>                
               ...
               <asp:LinkButton ID="LinkButton1" runat="server"  CausesValidation="true" OnClientClick="btnPayPalPayLink();return false;" ><label>
