...
public partial class ExistCustomerRegistration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtaccno.Attributes.Add("onkeypress", "javascript:return blockspecialcharacters(event);");
        txtpino.Attributes.Add("onkeypress", "javascript:return blockspecialcharacters(event);");
        txtcompname.Attributes.Add("onkeypress", "javascript:return blockspecialcharacters(event);");
        txtcompno.Attributes.Add("onkeypress", "javascript:return blockspecialcharacters(event);");
        ...
        txtposition.Attributes.Add("onkeypress", "javascript:return blockspecialcharacters(event);");
    ...
    public double  SaveUserProfile()
    {
        ...
        //    oRegInfo.LastInvNo = txtpino.Text.ToString();
        //    oRegInfo.WesAccNo = txtaccno.Text.ToString();
    ...
    private void SendExistingCustomer()
    {
        try
        {
            ...
            string message = "";
            MessageObj.Subject = "WESonline-Form-ExistingCustomer";
            MessageObj.IsBodyHtml = true;
            message = message + "<tr><td>WES Account No</td><td>&nbsp;</td><td>" + txtaccno.Text.ToString() + "</td></tr>";
            message = message + "<tr><td>Last Purchase Invoice Number</td><td>&nbsp;</td><td>" + txtpino.Text.ToString() + "</td></tr>";
    ...
    public void SendNotification()
    {
        ...
        if (objNotificationServices.IsNotificationActive(NotificationVariablesServices.NotificationList.CUSTOMERREGISTRATION.ToString()))
        {
            ...
            try
            {
                ...
                TmplCont = "CUSTOMERREGISTRATIONUPDATE";
                ...
                objNotificationServices.NotifySubject = objNotificationServices.GetEmailSubject("CUSTOMERREGISTRATIONUPDATE");
                objNotificationServices.NotifyMessage = EmailCont;
                objNotificationServices.NotifyIsHTML = objNotificationServices.IsHTMLNotification("CUSTOMERREGISTRATIONUPDATE");
