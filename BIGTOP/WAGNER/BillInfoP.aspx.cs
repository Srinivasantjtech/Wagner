...
using StringTemplateGroup = Antlr3.ST.StringTemplateGroup;
    ...
    public partial class BillInfoP : System.Web.UI.Page
    {
        ...
        PayPalAPIService objPayPalService = new PayPalAPIService();
         ...
         protected string EncryptSP(string ordid)
    {
            ...
            try
            {
                ...
                if (httpRequestVariables()["Token"] != null && httpRequestVariables()["PayerID"] != null)
                {
                 ...
                 //   var response = HttpContext.Current.Session["payAPIresponse"] as NameValueCollection;
                    objPayPalService.DoECStatus(httpRequestVariables());
                ...
                if (!IsPostBack)
                {
                    ...
                    bool isipn = false;
                    if (HttpContext.Current.Session["payAPIresponse"] != null && HttpContext.Current.Session["payAPIresponse"] != "")
                    {

                        if (HttpContext.Current.Session["payAPIresponse"] == "SUCCESS")
                        {
                            ...
                            if (objOrderServices.IsNativeCountry(OrderID) == 1)
                                SendMail(OrderID, (int)OrderServices.OrderStatus.Payment_Successful, false);
        ...
        private void LoadIds()
        {
            ...
            //    id = DecryptSP(id);
            //}
            if (HttpContext.Current.Session["P_API_Oid"] != null)
                id = HttpContext.Current.Session["P_API_Oid"].ToString();
