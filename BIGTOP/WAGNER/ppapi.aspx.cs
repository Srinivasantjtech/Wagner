...
using System.Text;
    ...
    public partial class ppapi : System.Web.UI.Page
    {
        ...
        protected void btnPay_Click(object sender, EventArgs e)
        {
            ...
            LoadIds();
            renUrl = renUrl.Replace("ppapi", "BillInfoP");
            renUrl = renUrl + "?key=" + EncryptSP(OrderID.ToString()) ;
            ...
            string Requeststr = objPayPalService.PayPalSetECRequest(OrderID, PaymentID, oOrderInfo, renUrl);
