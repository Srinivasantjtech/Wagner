<%@ Page Language="C#" MasterPageFile="~/Mainpage.master" AutoEventWireup="true" Inherits="ProductDetails" Title="Untitled Page" Codebehind="ProductDetails.aspx.cs" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" Runat="Server"><uc1:Product ID="Product1" runat="server" /></asp:Content>
