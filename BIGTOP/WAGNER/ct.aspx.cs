    ...
    protected void Page_SaveStateComplete(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    DataSet ds = (DataSet)Session["BreadCrumbDS"];
                    string dsroeitemtype = ds.Tables[0].Rows[0]["ItemType"].ToString().ToLower();

                    if (dsroeitemtype == "category")
                    {
                    ...
                    if (dsroeitemtype == "brand")
                    {
                      ...
                      //  Page.MetaKeywords = pagetitle + "," + stcategory;
                       // Page.MetaDescription = stcategory + "," + "Cellular Phone Models and Accessories";
                        ...
                        Page.MetaKeywords = pagetitle + " | " + stcategory + " - Bigtop , wagneronline.com.au";
                    }
            ...
            Page.Title = TextTitle + " | " + "Bigtop Online Stores";  
        }
        catch
        { }
