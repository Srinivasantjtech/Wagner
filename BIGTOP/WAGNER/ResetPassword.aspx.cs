...
public partial class ResetPassword : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            Page.Title = "Bigtop-ResetPassword";

            imgordinfo.Src = System.Configuration.ConfigurationManager.AppSettings["cdn"].ToString() + "images/Order__info.png";
            imgforgot.Src = System.Configuration.ConfigurationManager.AppSettings["cdn"].ToString() + "images/forgot.png.jpg";
 ...
 // int chkvalue = objUserServices.UpdateNewPassword(txtLoginName.Text, UserID, System.Convert.ToInt32(txtCompanyID.Text), txtEmailAddress.Text, TempPwd, txtConfirmPassword.Text);
                ...
                Response.Redirect("ConfirmMessage.aspx?Result=RESETPASSWORD");
            }
        }
        else
        {
