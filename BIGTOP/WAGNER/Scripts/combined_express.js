...
//Start of animate_on_scroll.json
...
function urlredirect_enter(e) {
    ...
    var ddlattrvalue = '';
    try {
        ddlattrvalue = document.getElementById("txtsear1").value.replace("\"", "`~");

    }
    catch (err) {
        ddlattrvalue = document.getElementById("txtsearch_automenu").value.replace("\"", "`~");
    }
    if (ddlattrvalue == "") {
        ddlattrvalue = document.getElementById("txtsearch_automenu").value.replace("\"", "`~");
    }
...
function urlredirectK_src(e) {
    ...
    document.getElementById("txtsear1").value = ddlattrvalue;
    if (ddlattrvalue != "") {
        if (ddlattrvalue != "Quick Product Search" || ddlattrvalue != "Quick Product Search! Enter key words or product Codes!") {
...
//Start of css/zoom/js/cloudzoom.js
...
//End of css/zoom/js/cloudzoom.js




//Start of scripts/jquery.accordion.js
...
//End of scripts/jquery.accordion.js
