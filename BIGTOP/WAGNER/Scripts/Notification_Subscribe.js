...
//function subscribeUser() {
//       const appServerKey = applicationServerPublicKey;
//    navigator.serviceWorker.register('service-worker-wagner.js').then(
//      function(serviceWorkerRegistration) {
        
//          serviceWorkerRegistration.pushManager.subscribe({applicationServerKey: appServerKey}).then(
//            function(pushSubscription) {
//                console.log(pushSubscription);
//                var markers =pushSubscription;
