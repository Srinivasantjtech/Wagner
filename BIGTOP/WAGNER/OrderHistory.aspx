                        ...
                        <td style="background-color: <%=bgcolor%>; width: 14%;" align="center">
                            ...
                            <% 
                                ...
                                {                                    
                                    ...
                                    <a id="A1" style="color: #3399FF" href="PayOnlineCC.aspx?<%= EncryptSP(oDr["ORDERID"].ToString()) %>">
                        ...
                        <td style="background-color: <%=bgcolor%>; color: #3399FF" width="8%;" align="center">
                            ...
                            %>
                               ...
                               <a class="HyperLink2" id="A2" style="color: #3399FF; cursor: pointer;" onclick="GetInvoice('<%=EncryptKeyString%>','<%=InvNo%>');" >
                                ...
                                <div id="<%=InvNo%>" style="display:none;" >
                                    <img id="imginv" runat="server" src="images/Invloading.gif" alt=""/></div>
            ...
            <div class="containerOrdhis">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;">
                    <tr>
                        ...
                        <td width="10px">
                        <asp:ImageButton ID="ImageButton2" runat="server" OnClick="btncancel_Click" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/btn_images/11_32_2.png" ImageAlign="Right" />                        
                         </td>
