...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   <%-- <script language="javascript" type="text/javascript" src="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Scripts/jquery-1.5.1.min.js"></script>--%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <tr>
     <td width="100%">
            <table id="tblBase" width="100%" border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" align="center">  
            <tr> <td align="center"> Transaction Type </td> <td align="center"> Order No or Invoice No </td> <td align="center"> From Date </td> <td align="center"> To Date </td> <td align="left"> Created User </td> <td > &nbsp; </td> <td > &nbsp; </td> </tr>
<tr>
<td align="left"> <asp:DropDownList runat="server" ID="CboTranType" BackColor="White" CssClass="inputtxt" Width="100px"> <asp:ListItem Selected="True" >Payment</asp:ListItem> <asp:ListItem>Failed Transaction</asp:ListItem> </asp:DropDownList> </td>
<td > <asp:TextBox runat="server" ID="OrderNo" Width="115px" BackColor="White" CssClass="inputtxt" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox> </td> <td align="center"> <asp:TextBox runat="server" ID="FromdateTextBox" Width="90px" BackColor="White" Height="19px" CssClass="inputtxt" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox> </td>
<td align="center"> <asp:TextBox runat="server" ID="TodateTextBox" Width="90Px" BackColor="White" Height="19px" CssClass="inputtxt" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px"></asp:TextBox> </td> <td width="25%" align="left"> <asp:DropDownList runat="server" ID="CreatedUserDropDownlist" BackColor="White" CssClass="inputtxt" Width="190px"> </asp:DropDownList> </td>
<td width="10%" align="center" valign="middle"> <asp:Button runat="server" ID="SearchButton" CssClass="inputbtn" Text="Search" OnClick="SearchButton_Click" /> </td> <td width="10%" align="center" valign="middle"> <asp:Button runat="server" ID="ResetButton" CssClass="inputbtn" Text="Reset" OnClick="ResetButton_Click" /> </td> <td width="1" align="center" valign="middle"> </td></tr>
<tr> <td colspan="7"> <asp:Label runat="server" ID="MsgLabel" Width="250px"> &nbsp; </asp:Label> </td> </tr></table></td></tr>  
<tr>
        <td width="100%"  >
            <table  width="100%" id="test1" border="0" cellpadding="3" cellspacing="0" style="font-family: Arial;
               ...
               <tr class="rowEven"> <td align="left" > Cust. Order Date </td> <td align="left" > Cust. Order No. </td> <td align="left"> Invoice Date </td> <td align="right" > Invoice No </td> <td align="left" > User </td> <td align="left" > view Order / Invoice </td> <td align="left" > Value </td> <td align="left" > Payment Txn Id. </td> <td align="left" > Payment Date /Time. </td> </tr> 
