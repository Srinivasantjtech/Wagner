...
public partial class SubProducts : System.Web.UI.Page
{
    ...
    public string GetProducts()
    {
        ...
        string ProdImgPath = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()+"/ProdImages";
        string str1 = "";
        ...
        if (oDs != null)
        {
            ...
            Retval = "";
            string strFile = System.Configuration.ConfigurationManager.AppSettings["VirtualPathJPG"].ToString();
            foreach (DataRow oDr in oDs.Tables["PRODUCTS"].Rows)
            {
                ...
                {
                    Retval += string.Format("<tr><td><img src=\"{0}/{1}\" class=\"tx_img\" /></td>", ProdImgPath,System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()+"images/noimage.gif");
                }
                ...
                //Retval += string.Format("<td class=\"tx_7_blue1\"><a href=\"pd.aspx?pid={0}&fid={1}\">More Info</a></td></tr>", oDr["PRODUCT_ID"], oDr["FAMILY_ID"]);

                //Retval += string.Format("<td class=\"tx_7_blue1\"><a href=\"ps.aspx?srctext={0}\">More Info</a></td></tr>", oDr["CODE"]);
