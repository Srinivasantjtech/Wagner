<%@ Page Language="C#" MasterPageFile="~/Mainpage.master" AutoEventWireup="true" Inherits="OrderDetailsExpress" Title="Untitled Page"
     Culture="en-US" UICulture="en-US" Codebehind="OrderDetailsExpress.aspx.cs" %>
...
<%if (Request.QueryString["popup"] == null)
        ...
        <script language="javascript" type="text/javascript">
            ...
            function PopupAdd(FamilyID, ProductID, MinQty, MaxQty, refocus) {
                ...
                if (Qty >= MinQty) {
                    ...
                    var href = window.parent.location = "/OrderDetailsExpress.aspx?&bulkorder=1&Pid=" + ProductID + "&Qty=" + document.forms[0].elements["Returnname"].value;
                }
            }
            ...
            function Send() {
                window.location.href = "/OrderDetailsExpress.aspx";
                if (pid != "") {
                ...
                window.location.href = '/OrderDetailsExpress.aspx?&bulkorder=1&SelPid=' + pid + '&SelProdPrice=' + UntPrice;
            }
            ...
            function SendRemoveProducts() {
                ...
                if (String(pid) != "") {
                    ...
                    window.location.href = "/OrderDetailsExpress.aspx?&bulkorder=1&SelPid=" + pid + "&SelProdPrice=" + UntPrice + "&ProdPrice=" + ProdPrice;
                    return true;
                }
                else {
                    UntPrice = 0;
                    if (document.forms[0].elements["ChkAllSel"].checked == true) {
                        ...
                        SelProdPrice = 0;
                        ProdPrice = "";
                        window.location.href = "/OrderDetailsExpress.aspx?&bulkorder=1&SelPid=AllProd";
                        return true;
                    }
                    else {
                        var elem = document.forms[0].elements;
      ...
      { %>
        <asp:UpdatePanel ID="updorddet" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                 ...
                 <div class="table-responsive col-sm-20">
                    ...
                    <% string TempNotFoundItem = "";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;rma=NF&amp;item=<%=_NotFoundItem%>&amp;cla_id=<%=_ClaItem_ID%>" style="font-weight: bold;
                                                ...
                                                <tr>
                                                              ...
                                                              <td>
                                                                <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;rma=NF&amp;item=<%=_replaceItem%>&amp;cla_id=<%=_ClaItem_ID%>" class="btn primary-btn-blue">Delete Item</a>
                                                            </td>
                                                            </tr>
                                    <%
                                                                    }
                        ...
                        <tr>
                                                           ...
                                                           <%--    <table>
                                                                 ...
                                                                 <%--   <td>--%>
                                                                   ...
                                                                   <%-- </td>
                                                                    <td align="left">--%>
                                                                <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;rma=NF&amp;item=<%=_replaceItem%>&amp;cla_id=<%=_ClaItem_ID%>" class="btn primary-btn-blue">Delete Item
                                                                </a>
                                                                 <%-- </td>--%>
                                                             ...
                                                             <td>
                                                                      ...
                                                                      <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;flgAddItem=chkAddItem&amp;rma=NF&amp;ORDER_ID=<%=OrderID%>&amp;Pid=<%=SubstuyutePid.ToString().Trim()%>&amp;Qty=<%=_ordQty %>&amp;item=<%=_replaceItem%>&amp;cla_id=<%=_ClaItem_ID%>"  class="btn primary-btn-green">
                                                                      Add Item
                                                                      </a>
                                                                    </td>
                                                                    </tr>
                        ...
                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;rma=NF&amp;item=<%=_replaceItem%>&amp;cla_id=<%=_ClaItem_ID%>" style="font-weight: bold;
                                                                    text-decoration: none; color: #1589FF;">Delete Item</a>
                                                            </td>
                                                            </tr>
                                                                <%
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <a href="/OrderDetailsExpress.aspx?bulkorder=1&amp;rma=CI&amp;item=<%= _ClarifyItem %>&amp;DelQty=<%=_orderQty%>&amp;cla_id=<%=_ClaItem_ID%> "
                                                                        ...
                                                                        { %>
                                                                          ...
                                                                          <tr>
                                                                            ...
                                                                            {   
                                                                             ...
                                                                             <tr>                                                                           
                                                                                    ...
                                                                                    <td width="100" align ="right" >
                                                                                      ...
                                                                                      <td width="100" align="center">
                                                                                        <a href="/OrderDetailsExpress.aspx?&bulkorder=1&SelPid=<%=pid1%>&amp;SelProdPrice=<%=ProdTotal1%>&amp;ProdPrice=<%=ProductUnitPrice1%>&amp;ORDER_ID=<%=OrderID%>&amp;ORDER_ITEM_ID=<%=orderItemId%> " style="color: #0099ff">Remove</a>
                                                                                    </td>                                                                            
                                                                                  </tr>
                                                                             <%
                                                                            ...
                                                                            <td colspan="3" align="left"  >
                                                                                <a href="/OrderDetailsExpress.aspx?&bulkorder=1&amp;ORDER_ID=<%=OrderID%>&amp;CombainProd_id=<%=pid1%>"style="color: #0099ff">Combine all into one (QTY discount may apply)</a>
                                                                                
                                                                                <br />
                                                                                 <a href="/OrderDetailsExpress.aspx?&bulkorder=1&amp;ORDER_ID=<%=OrderID%>&amp;LeaveProd_id=<%=pid1%>"style="color: #0099ff">Leave as multiple lines</a>
                                                                            </td>
               ...
               <div class="col-sm-20 bluebg-heading">
        	    <h4>Order Contents</h4>
               </div>
               <div class="table-responsive col-sm-20 inner-table">
                                            ...
                                            foreach (DataRow rItem in dsOItem.Tables[0].Rows)
                                            {
                                             flgchkdummy = false;
                                                                                                                                      ...
                                                                                                                                      
                                               {
                                                ...
                                                string _catid = "";
                                                string neweapath = "";
                                                DataSet tmpds = (DataSet)objHelperDB.GetGenericDataDB(WesCatalogId, pid.ToString(), "GET_PARENT_CATEGORY_ID_PATH_INPUT_PID_BIGTOP", HelperDB.ReturnType.RTDataSet);
 ...
 string[] catpath=null;
                                                        if (tmpds.Tables[0].Rows[0]["CATEGORY_PATH"].ToString() != "")
                                                        {
                                                            ...
                                                            Ea_Path = EA_New_Product_init_cat_path + "////" + tmpds.Tables[0].Rows[0]["PARENT_FAMILY_ID"].ToString() + "////" + pid + "=" + rItem["CATALOG_ITEM_NO"].ToString() + "////" + (catpath.Length >= 3 ? catpath[2] : " ") + (catpath.Length >= 4 ? "////" + catpath[3] : " ") + (catpath.Length >= 5 ? "////" + catpath[4] : " ") + (catpath.Length >= 6 ? "////" + catpath[5] : " ") + "////" + tmpds.Tables[0].Rows[0]["FAMILY_NAME"].ToString();
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        Ea_Path = EA_New_Product_init_cat_path + "////" + tmpds.Tables[0].Rows[0]["FAMILY_ID"].ToString() + "////" + pid + "=" + rItem["CATALOG_ITEM_NO"].ToString() + "////" + (catpath.Length >= 3 ? catpath[2] : " ") + (catpath.Length >= 4 ? "////" + catpath[3] : " ") + (catpath.Length >= 5 ? "////" + catpath[4] : " ") + (catpath.Length >= 6 ? "////" + catpath[5] : " ") + "////" + tmpds.Tables[0].Rows[0]["FAMILY_NAME"].ToString();
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;<a href="/OrderDetailsExpress.aspx?&bulkorder=1&SelPid=<%=pid%>&amp;SelProdPrice=<%=ProdTotal%>&amp;ProdPrice=<%=ProductUnitPrice%>&amp;ORDER_ID=<%=OrderID%>&amp;ORDER_ITEM_ID=<%=OrderItemId1%>" class="gray_40">Remove</a>&nbsp;&nbsp;
                                    </td>
                                    <td>
                                        <%=Desc%>
                                    </td>
               ...
               <div class="col-sm-20 text-right viewcart_btns inner-table">
                                        ...
                                        <%
                                            UserCheckout = objHelperServices.GetIsEcomEnabled(Userid.ToString());
                                             ...
                                             <asp:Button ID="ImageButton4" runat="server"   OnClick="btnContinueNext_Click" Text="Continue Shopping"   class="btn btn-primary" Style="display:inline;"   />

                                        
                                        <% if (UserCheckout == true)
                                           { %>                                        
                                        <asp:Button ID="lblOrderProceed" runat="server"   OnClick="btnNext_Click" Text="Go to Check Out"  class="btn primary-btn-green"  Style="display:none;" />
                                        <%}
                                           else
                                           { %>
                                  
                                             <asp:Button ID="ImageButton5" runat="server"   OnClick="btnContinueNext_Click" Text="Continue Shopping"   class="btn btn-primary"  Style="display:none;" />

                                        <%} %>

                  <%-- <%  if (HttpContext.Current.Session["USER_ID"] != "" && Convert.ToInt32(HttpContext.Current.Session["USER_ID"].ToString()) > 0 && HttpContext.Current.Session["USER_ID"].ToString() == "777" ){ %>--%>
                    ...
                    <div class="modal-body"> 
                         <div class="warning-info clearfix">
                             <div class="close-selected">
                               <asp:ImageButton ID="ImageButton3"   runat="server" OnClick="btnCancel_Click"   CausesValidation="false"/>
                    </div>
...
<script type="text/javascript">
 ...
 <%if (Request.QueryString["popup"] != null)
      ...
      <div class="modal-footer clear border_top_none centered-block">
                            ...
                            <a class="btn primary-btn-green ico_checkout" href="/OrderDetailsExpress.aspx?&bulkorder=1&pid=0">View Order & Check out</a>
                          </div>
