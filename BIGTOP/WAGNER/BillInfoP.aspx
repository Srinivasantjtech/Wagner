<%@ Page Title="" Language="C#" MasterPageFile="~/Mainpage.master" AutoEventWireup="true" CodeBehind="BillInfoP.aspx.cs" Inherits="BillInfoP" %>
...
var google_conversion_id = 1051450606;
var google_conversion_language = "en";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "ldLiCMT09wsQ7rmv9QM"; var google_conversion_value = 100.00; var google_remarketing_only = false;
</script>
<script type="text/javascript" src="//www.googleadservices.com/pagead/conversion.js">
</script>
<noscript>
<div style="display:inline;">
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1051450606/?value=100.00&amp;label=ldLiCMT09wsQ7rmv9QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<div class="">
<div class="cl"></div>
         <div id="divOk" runat="server"  class="alert greenbox icon_2"  style="padding:30px 10px 30px 60px;font-family: arial;font-size: 13px;font-weight: bold;">
        </div>
<div class="grid6" style="width:469px;" >
<fieldset style="height:100px;">
  <legend>Order Details</legend>
<p class="para pad10">Order No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <asp:Label ID="lblOrderNo" runat="server" Text="" 
    
    Class="LabelStyle" style="font-weight:normal;" ></asp:Label></p>
