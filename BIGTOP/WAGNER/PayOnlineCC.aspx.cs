...
using System.Text;
    ...
    public partial class PayOnlineCC : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("PayOnlineCC.aspx?" + HttpUtility.UrlEncode( EncryptSP(Request.QueryString["pay"].ToString())));
                return;
            }
            ...
            if (blnpp == false && blnsp == false)
            {
                divPayUnavailable.Visible = true;
                divCC.Visible = false;
                return;
            }
