                                ...
                                <tr>
                                    ...
                                    <td valign="top" height="90" style="width: 695px">
                                        <div style="margin-left: 101px; margin-top: 01px; margin-right: 4px; line-height: 12px"
                                            class="b1">
                                            <asp:Image ID="ImgPhone" runat="server" Style="margin-right: 7px" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/z1.gif"
                                        ...
                                        <div style="margin-left: 17px; margin-top: 25px; margin-right: 4px; line-height: 12px"
                                            class="w">
                                            <asp:Image ID="imgArrow1" runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px;" />
                                            <asp:LinkButton ID="lbAccount" runat="server" Text="<%$ Resources:Top,lbAccount %>"
                                                SkinID="TopLevelSkin" PostBackUrl="~/Login.aspx"></asp:LinkButton><asp:Image ID="imgArrow2"
                                                    runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px; margin-left: 9px" />
                                            <%
                                                string tOrderID = "";
                                            ...
                                            <asp:LinkButton ID="lbViewCart" runat="server" SkinID="TopLevelSkin" Text="<%$ Resources:Top,lbViewCart %>"
                                                PostBackUrl="~/orderDetails.aspx?&bulkorder=1&Pid=0&ORDER_ID=<% tOrderID %>"></asp:LinkButton><asp:Image
                                                    ID="imgArrow3" runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px;
                                                    margin-left: 12px" />
                                            <asp:LinkButton ID="lbWishlist" runat="server" Text="<%$ Resources:Top,lbWishlist%>"
                                                SkinID="TopLevelSkin" PostBackUrl="~/UserBasicInfo.aspx"></asp:LinkButton><asp:Image
                                                    ID="imgArrow4" runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px;
                                                    margin-left: 12px" />
                                            <asp:LinkButton ID="lborderstatus" runat="server" Text="<%$ Resources:Top,lborderstatus%>"
                                                SkinID="TopLevelSkin" PostBackUrl="~/Orders.aspx?ViewType=STATUS"></asp:LinkButton><asp:Image
                                                    ID="imgArrow5" runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px;
                                                    margin-left: 12px" />
                                            <asp:LinkButton ID="lbViewWishList" runat="server" SkinID="TopLevelSkin" Text="<%$ Resources:Top,lbViewWishList %>"
                                                PostBackUrl="~/WishListDetails.aspx"></asp:LinkButton><asp:Image ID="imgArrow" runat="server"
                                                    ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/top_arrow.gif" Style="margin-right: 4px; margin-left: 12px" />
                                    ...
                                    <td valign="top" width="80" style="height: 45px">
                                        <div style="margin-left: 0px; margin-top: 23px">
                                            <asp:ImageButton ID="cmdSearch" OnClientClick="return ValidateSearchText(this);"
                                                runat="server" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>Images/go.gif" /><%--  OnClick="cmdSearch_Click"    OnClientClick="return ValidateSearchText();" --%>
