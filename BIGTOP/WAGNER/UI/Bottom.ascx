...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
       ...
       <table border ="0" width ="865px">
            <tr>
                <td  align ="center" valign="top" width="850px" style="background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/bottom.gif); height: 9px;">
                </td>
            </tr>
        </table>
        <table border="0" width ="850px" >
            ...
            <tr>
            <td align="right">
            <asp:ImageButton id="ImageButton2" runat="server" OnClientClick="javascript:window.open('http://tradingbell.com',null, 'status=yes,scrollbars=yes, toolbar=yes, menubar=yes, location=no,resizable=yes'); void('');return false" ImageUrl="<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/Logo.png">
