 ...
 <table>
        <tr>
            <td valign ="top" align ="left" style="width: 200px;">
                <table cellpadding="0" cellspacing="0" border="0" style="height:100% ">
					<tr>
						<td valign="top" width="197" height="7" style="background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/line_top.gif) "></td>
					</tr>
					<tr>
					    <td valign="top" width="197" style="height:50px; background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/1_line2.gif) ">
				    ...
				    <tr>
				        <td valign="top" width="197" height="6" style="background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/1_line3.gif) "></td>
				    </tr>
				</table>
			    </td>
			   </tr>
        ...
        <tr>
            <td valign ="top" align ="left" style="width: 200px" >
                <table cellpadding="0" cellspacing="0" border="0" style="height:100% ">
					<tr>
						<td valign="top" width="197" style="background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/line_top.gif) ; height: 7px;"></td>
					</tr>
					<tr>
					    <td valign="top" width="197" style="height:110px; background-image:url(<%=System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString()%>images/1_line2.gif) ">
