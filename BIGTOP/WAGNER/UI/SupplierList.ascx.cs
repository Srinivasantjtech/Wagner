                ...
                foreach (DataRow rIndex in dsIndex.Tables[0].Rows)
                {
                    ...
                    if (dsSupplierLst != null)
                    {
                        ...
                        for (int i = 0; i < Rcnt; i++)
                        {
                            ...
                            oHyLink.NavigateUrl = "/fl.aspx?SName=" + dsSupplierLst.Tables[0].Rows[i].ItemArray[0].ToString().Replace("&", "?"); ;
                            ...
                            if (i + j < dsSupplierLst.Tables[0].Rows.Count)
                            {
                                oHyLink = new HyperLink();
                                oHyLink.CssClass = _LinkCssClass;
                                oHyLink.NavigateUrl = "/fl.aspx?SName=" + dsSupplierLst.Tables[0].Rows[i + j].ItemArray[0].ToString().Replace("&", "?");
