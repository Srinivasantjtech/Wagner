...
public partial class MCheckOut : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ImageButton3.ImageUrl = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "Images/close2.png";
        ImagePaySP.ImageUrl = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/pay1ch.png";
        ImagePay.ImageUrl = System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString() + "images/pay2uch.png";
        ...
        if (paidtab == false &&  objOrderServices.IsNativeCountry(OrderID) == 1)
        {
            if (orderdstatus != Enum.GetName(typeof(OrderServices.OrderStatus), tmpOrdStatus))
            {
                Session["ORDER_ID"] = 0;
                Response.Redirect("MConfirmMessage.aspx?Result=QTEEMPTY_ORDER", true);
                return;
            }
        }
       ...
       // this.Panelerroritems.Visible = false;
        ...
        if (tbErrorItems != null && Session["USER_NAME"].ToString() == "" && tbErrorItems.Rows.Count > 0 || tbErrorChk != null && tbErrorChk.Rows.Count > 0 || tbErrorReplace != null && tbErrorReplace.Rows.Count > 0)
        {
      ...
      //{
            ...
            if (objHelperServices.GetOptionValues("ECOMMERCEENABLED").ToString().ToUpper() == "YES")
            {
                ...
                if (!IsPostBack && (tbErrorItems == null && DuplicateItem_Prod_idCount == 0))
                {
                    try
                    {
                        if (Session["USER_ID"] != null || Session["USER_ID"].ToString() != "")
                        {
                            ...
                            {
                                Response.Redirect("MConfirmMessage.aspx?Result=QTEEMPTY",false);
                ...
                else
                {
                    ...
                    if ((tbErrorItems != null && tbErrorItems.Rows.Count > 0) || DuplicateItem_Prod_idCount > 0)
                    {
                        ...
                        {
                            Response.Redirect("morderDetails.aspx?bulkorder=1&amp;Pid=0&amp;ORDER_ID=" + Session["ORDER_ID"], true);
                        }
                        else
                        {
                            Response.Redirect("morderDetails.aspx?bulkorder=1&amp;Pid=0", true);
                        }
                    }
                    //}
                    // }
            ...
            {
                Response.Redirect("MConfirmMessage.aspx?Result=NOECOMMERCE", false);
            }
            if (Convert.ToInt16(Session["USER_ROLE"]) == 3)
            {
                Load_UserRole(Session["USER_ID"].ToString());
                ...
                if (PaytabType == "Pay" || PaytabType == "PayApi")
                {
                    ...
                    if (HttpContext.Current.Session["payflowresponse"] != null && HttpContext.Current.Session["payflowresponse"].ToString()  != "")
                    {
                        ...
                        if (HttpContext.Current.Session["payflowresponse"].ToString() == "SUCCESS")
                        {
                            ...
                            objErrorHandler.CreatePayLog("MS before UpdatePaymentOrderStatus Orderid=" + OrderID);


                            objOrderServices.UpdatePaymentOrderStatus(OrderID, PaymentID, isipn, oOrderInfo.isppppp);

                            objErrorHandler.CreatePayLog("MS after UpdatePaymentOrderStatus Orderid=" + OrderID);


                            objErrorHandler.CreatePayLog("MS before SendMail_AfterPayment Orderid=" + OrderID);
                            if (objOrderServices.IsNativeCountry(OrderID) == 1)
                            {
                                ...
                                if (dtcheckmailsend == null || dtcheckmailsend.Rows.Count == 0)
                                {
                                    ...
                                    objErrorHandler.CreatePayLog("MS after SendMail_AfterPaymentPP CheckMailLog Orderid=" + OrderID);
                            ...
                            else
                            {
                                ...
                                TBWTemplateEngine tbwtEngine = new TBWTemplateEngine();
                                tbwtEngine.SendMail_Review(OrderID, (int)OrderServices.OrderStatus.Proforma_Payment_Success, false);
                            }
                            //objOrderServices.UpdateOrderStatus(OrderID, (int)OrderServices.OrderStatus.Payment_Successful );

                            objErrorHandler.CreatePayLog("MS after SendMail_AfterPayment Orderid=" + OrderID);
                        ...
                        else
                        {
                            ...
                            if (isnative == 1)
                                divlink.InnerHtml = "<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString()) + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
                            else
                                divlink.InnerHtml = "<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString() + "#####" + "Pay") + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
                        }
                    ...
                    else if (HttpContext.Current.Session["payAPIresponse"] != null && HttpContext.Current.Session["payAPIresponse"].ToString() != "")
                    {
                        ...
                        {
                            objErrorHandler.CreatePayLog("MS before UpdatePaymentOrderStatus APIres Orderid=" + OrderID);
                            objOrderServices.UpdatePaymentOrderStatus(OrderID, PaymentID, isipn, oOrderInfo.isppppp);
                            objErrorHandler.CreatePayLog("MS after UpdatePaymentOrderStatus APIres Orderid=" + OrderID);


                            objErrorHandler.CreatePayLog("MS before SendMail_AfterPaymentPP APIres Orderid=" + OrderID);
                            if (objOrderServices.IsNativeCountry(OrderID) == 1)
                                SendMail_AfterPayment(OrderID, (int)OrderServices.OrderStatus.Payment_Successful);
                            else
                                SendMail_AfterPayment(OrderID, (int)OrderServices.OrderStatus.Proforma_Payment_Success);
                            objErrorHandler.CreatePayLog("MS after SendMail_AfterPaymentPP APIres Orderid=" + OrderID);
                        ...
                        else
                        {
                            ...
                            divOk.Visible = false;
                            PayOkDiv.Visible = true;
                            objErrorHandler.CreatePayLog("MS Transaction failed payAPIresponse! Please try again Orderid=" + OrderID);

                            divError.InnerHtml = "Transaction failed! Please try again.<br/><br/>";
                            if (isnative == 1)
                                divlink.InnerHtml = "<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString()) + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
                            else
                                divlink.InnerHtml = "<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString() + "#####" + "PayApi") + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
                ...
                else  /// secure pay
                {
                   ...
                   OrderServices.OrderInfo oOrderInfo = new OrderServices.OrderInfo();
                    ...
                    if (HttpContext.Current.Session["paySPresponse"] != null && HttpContext.Current.Session["paySPresponse"].ToString() != "")
                    {
                        ...
                        {
                            objErrorHandler.CreatePayLog("MS SP before UpdatePaymentOrderStatus Orderid=" + OrderID);
                            objOrderServices.UpdatePaymentOrderStatus(OrderID, PaymentID, false, oOrderInfo.isppppp);
                            objErrorHandler.CreatePayLog("MS SP after UpdatePaymentOrderStatus Orderid=" + OrderID);

                            objErrorHandler.CreatePayLog("MS SP before SendMail_AfterPaymentSP  Orderid=" + OrderID);
                            if (objOrderServices.IsNativeCountry(OrderID) == 1)
                                SendMail_AfterPayment(OrderID, (int)OrderServices.OrderStatus.Payment_Successful);
                            else
                                SendMail_AfterPayment(OrderID, (int)OrderServices.OrderStatus.Proforma_Payment_Success);
                        ...
                        else
                        {
                            ...
                            objErrorHandler.CreatePayLog("MS SP Transaction failed! Please try again Orderid=" + OrderID);
                            divError.InnerHtml = "Transaction failed! Please try again.<br/><br/>";
                            ...
                            if (isnative == 1)
                                ...
                                divlink.InnerHtml = "<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString() + "#####" + "PaySP") + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
    ...
    private void SendMail_AfterPayment(int OrderId, int OrderStatus)
    {
        objErrorHandler.CreatePayLog("SendMail_AfterPayment start OrderId=" + OrderId);
        try
        {
            ...
            objErrorHandler.CreatePayLog("SendMail_AfterPayment inner1 OrderId=" + OrderId);
            oPayInfo = objPaymentServices.GetPayment(OrderId);
            oOrderInfo = objOrderServices.GetOrder(OrderId);
            ...
            try
            {
              ...
              //  DataTable dt = null;
                ...
                int ictrecords = 0;
                objErrorHandler.CreatePayLog("SendMail_AfterPayment inner2 OrderId=" + OrderId);
               ...
               // else
                ...
                objErrorHandler.CreatePayLog("SendMail_AfterPayment inner3 OrderId=" + OrderId);
                ...
                objErrorHandler.CreatePayLog("SendMail_AfterPayment inner4 OrderId=" + OrderId);
                sHTML = _stmpl_container.ToString();
                objErrorHandler.CreatePayLog(sHTML);
            }
            catch (Exception ex)
            {
                objHelperServices.Mail_Error_Log("MS_SMAF", oOrderInfo.OrderID, "", ex.Message, 0, objHelperServices.CI(Session["USER_ID"].ToString()), Convert.ToInt16(Session["USER_ROLE"]), 2);
                objErrorHandler.ErrorMsg = ex;
                objErrorHandler.CreateLog();
                sHTML = "";
            }
            if (sHTML != "")
            {
                ...
                string emails = "";
                string Adminemails = "";
                objErrorHandler.CreatePayLog("SendMail_AfterPayment inner5 OrderId=" + OrderId);
        ...
        {
            objHelperServices.Mail_Error_Log("MS_SMAF", OrderId, "", ex.Message, 0, objHelperServices.CI(Session["USER_ID"].ToString()), Convert.ToInt16(Session["USER_ROLE"]), 2);
            objErrorHandler.ErrorMsg = ex;
            objErrorHandler.CreateLog();

        }

        objErrorHandler.CreatePayLog("SendMail_AfterPayment end OrderId=" + OrderId);
    }
    ...
    public string LoadShippingInfostr(string sUserID)
    {
        ...
        try
        {
            ...
            //if (oOrdShippInfo.MiddleName != "" && oOrdShippInfo.MiddleName !=null)
            //{
    ...
    protected void ImageButton5_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["USER_ID"] != null || Session["USER_ID"].ToString() != "")
            {
                ...
                {
                    Response.Redirect("morderDetails.aspx?bulkorder=1&amp;Pid=0&amp;ORDER_ID=" + Session["ORDER_ID"], false);
                }
                else
                {
                    Response.Redirect("morderDetails.aspx?bulkorder=1&amp;Pid=0", false);
                }
            }
                       ...
                       // ImageButton5.Visible = false;
                        ...
                        {  
                            ...
                            if (objSecurePayService.CheckSecurePay()==true) 
                                Response.Redirect("mcheckout.aspx?" + EncryptSP(OrderID.ToString() +"#####"+"PaySP"), false);
                            else
                                Response.Redirect("mcheckout.aspx?" + EncryptSP(OrderID.ToString() + "#####" + "Pay"), false);
    ...
    protected void ImgBtnEditShipping_Click(object sender, EventArgs e)
    {
        if (Session["USER_ID"] != null && Session["USER_ID"].ToString() != "" && Convert.ToInt32(Session["USER_ID"].ToString()) > 0)
        {
            if (OrderID > 0)
            {
                Response.Redirect("/morderDetails.aspx?bulkorder=1&amp;Pid=0&amp;ORDER_ID=" + OrderID.ToString(), false);
            }
            else
            {
                Response.Redirect("/morderDetails.aspx?bulkorder=1&amp;Pid=0", false);
    ...
    private void SendMail(int OrderId, int OrderStatus ,bool isau)
    {
        ...
        try
        {
            ...
            {
                objHelperServices.Mail_Error_Log("ICOS", OrderID, toemail.ToString(), ex.Message, 0, objHelperServices.CI(Session["USER_ID"].ToString()), Convert.ToInt16(Session["USER_ROLE"]), 2);
                objErrorHandler.ErrorMsg = ex;
                objErrorHandler.CreateLog();
                sHTML = "";
            }
    ...
    protected void btnSecurePay_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["XpayMS"] != null)
            {
                ...
                {
                    div1.InnerHtml = "";
                    div2.InnerHtml = "More than 3 attempt. try again" + "<br/>"+"<a href=\"mcheckout.aspx?" + EncryptSP(OrderID.ToString() + "#####" + "Pay") + "\" class=\"btn-lg green_bg border_none border_radius_none white_color semi_bold font_14 mar_right_30 mar_left_20 margin_top_20 \" >Pay Now</a>";
                    div2.Visible = true;
                    return;
                }
                else
            ...
            else
            {
               ...
               // div2.Visible = false;
                ...
                Response.Redirect("mcheckout.aspx?key="+ EncryptSP(OrderID.ToString() + "#####" + "PaySP"+ "#####" + "Paid" ));
            }
