...
public partial class MultiUserSetup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Page.Title = "Wagner-MultiuserSetup";
    ...
    private int AddUser()
    {
        ...
        try
        {
            ...
            {
                websiteid = System.Configuration.ConfigurationManager.AppSettings["WEBSITEID"];
            }
            else
            {
            ...
            oCmd.Parameters.AddWithValue("@WEBSITE_ID", websiteid);
            oCmd.Parameters.AddWithValue("@LOGIN_NAME", txtLogin.Text);
            Newpassword = objSecurity.StringEnCrypt_password(txtPass.Text);
    ...
    private void ResetPassword(int UserID)
    {
        ...
        else
        {
            ...
            //oCmd.ExecuteNonQuery();
            Newpassword = objSecurity.StringEnCrypt_password(Password);
    ...
    public void GetFillUser(int UserID)
    {
        ...
        if (oDs != null)
        {
            ...
            foreach (DataRow oDr in oDs.Tables["UserInfo"].Rows)
            {
                ...
                txtPass.Text = objSecurity.StringDeCrypt_password(oDr["Password"].ToString());
                txtPass.Attributes.Add("value", txtPass.Text);
                txtCPass.Text = objSecurity.StringDeCrypt_password(oDr["Password"].ToString());
