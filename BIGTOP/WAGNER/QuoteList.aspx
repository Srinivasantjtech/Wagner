...
<table align="center" width="558" border="0" cellspacing="0" cellpadding="5"><tr><td align="left" class="tx_1"> <a href="/Home.aspx" style="color:#0099FF" class="tx_3">Home</a> / Quote List</td></tr><tr><td class="tx_3"> <hr></td></tr></table>
 <br /> <table width="558" ><tr><td align ="left" ><asp:Panel ID="pnlQuote" runat="server" ></asp:Panel><asp:Label ID="Message" runat="server" meta:resourcekey="lblQteListMsg" Class="lblBoldHeadSkin"></asp:Label></td></tr></table>
</asp:Content>
