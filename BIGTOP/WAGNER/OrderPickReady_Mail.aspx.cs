    ...
    public partial class OrderPickReady_Mail : System.Web.UI.Page
    {
        ...
        private int SendMail(int OrderId, int OrderStatus, bool isau)
        {
            try
            {
                ...
                if (sHTML != "")
                {
                    ...
                    // {
                    MessageObj.Subject = "Bigtop Electronics - Order Ready For Pick Up - Invoice#" + oOrderInfo.InvoiceNo;
                    ...
                    objHelperServices.Mail_Log("OP", OrderId, Emailadd, "Bigtop - Order Ready For Pick Up");
        ...
        private string SendSMS(string InvoiceNo, string MobileNo)
        {
            ...
            try
            {
                ...
                message = message += "Wagner Electronics\n";
