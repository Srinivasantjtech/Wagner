...
namespace TradingBell.WebCat.TemplateRender
{
    ...
    public class TBWTemplateEngineMS
    {
        ...
        public string EA_ROOT_CATEGORY_PATH = System.Configuration.ConfigurationManager.AppSettings["EA_ROOT_CATEGORY_PATH"];
                ...
                if (dscontainer != null)
                {
                    if (dscontainer.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow dr in dscontainer.Tables[0].Rows)
                        {
                                ...
                                if (HttpContext.Current.Request.QueryString["fid"] != null)
                                {
                                    ...
                                    if (tmpds != null && tmpds.Tables.Count > 0)
                                    {
                                      ...
                                      //  objHelperService.Cons_NewURl(_stmpl_container, _stmpl_container.GetAttribute("TBT_FAMILY_ID").ToString() + "////" + _fid, "fl.aspx", true, "", false, false);
                                        ...
                                        objHelperService.SimpleURL_MS(_stmpl_container, "AllProducts////WESAUSTRALASIA////" +(catpath.Length >= 1 ? catpath[0] : " ")+"////"+ (catpath.Length >= 2 ? catpath[1] : " ")+  "////" +  "Family"+"////"+_fid , "fl.aspx");
                            ...
                            _stmpl_container.SetAttribute("CDNROOT", System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString());
                   ...
                   // DataRow[] row = EasyAsk.GetCategoryAndBrand("MainCategory").Tables[0].Select("CATEGORY_ID='" + paraValue.ToString() + "'");
                    ...
                    if (DSDR != null && DSDR.Tables.Count>0)
                    {
                        ...
                        foreach (DataRow _dsrow in DSDR.Tables[0].Rows)
                        {
                            ...
                            FileInfo Fil = new FileInfo(strImgFilesnew + _dsrow["IMAGE_FILE"].ToString());
                ...
                if (dsrecords.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow cdr in cellrow)
                    {
                            ...
                            if (HttpContext.Current.Request.QueryString["fid"] != null)
                            {
                                ...
                                if (tmpds != null && tmpds.Tables.Count > 0)
                                {
                                   ...
                                   // string[] catpath = tmpds.Tables[0].Rows[0]["CATEGORY_PATH"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);
                                    ...
                                    string eapath = "AllProducts////WESAUSTRALASIA////" +  (catpath.Length >= 2 ? catpath[1] : " ")+"////"+(catpath.Length >= 3 ? catpath[2] : " ")  ;
                      ...
                      //
                            ...
                            string catpat = cdr["CATEGORY_PATH"].ToString().ToLower().Replace("supplier product feed", "");
                          //  objErrorHandler.CreateLog(catpat);
                            string[] catpath = catpat.Split(new string[] { "////" }, StringSplitOptions.None);
                            objHelperService.SimpleURL_MS(_stmpl_records, "AllProducts////WESAUSTRALASIA////" + "////" + (catpath.Length >=2 ? catpath[1] : " ")+"////"+ (catpath.Length >= 3 ? catpath[2] : " ")+ "////" + cdr["FAMILY_name"].ToString()+"////"+cdr["FAMILY_ID"].ToString() , "fl.aspx");
                        ...
                        //
                            ...
                            objHelperService.SimpleURL_MS (_stmpl_records, "AllProducts////WESAUSTRALASIA////" + "////" +(catpath.Length >= 2 ? catpath[1] : " ")+"////"+ (catpath.Length >= 3 ? catpath[2] : " ")   + "////" +  cdr["FAMILY_name"].ToString() + "////" + cdr["product_ID"].ToString() + "=" + pcode+"////"+cdr["FAMILY_ID"].ToString() , "pd.aspx");
                        }
                        ...
                        foreach (DataColumn dc in dsrecords.Tables[0].Columns)
                        {
                            ...
                            else if ((package_name.Equals("NEWPRODUCT") || package_name.Equals("PROMOTIONS") || package_name.Equals("MOREPRODUCTS")) && dc.ColumnName.ToString().ToUpper().Equals("PRODUCT_ID"))
                            {
                                ...
                                {
                                    //objHelperService.Cons_NewURl(_stmpl_records, "AllProducts////WESAUSTRALASIA////" + "////" + cdr["CATEGORY_PATH"].ToString() + "////" + cdr["Family_id"].ToString() + "=" + cdr["Family_name"].ToString() + "////" + cdr["Product_ID"].ToString() + "=" + pcode, "pd.aspx", true, "");
                                    string[] catpath = cdr["CATEGORY_PATH"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);
                                ...
                                if (Dsfamilyname != null && Dsfamilyname.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    //added by :indu
                                     ...
                                     else
                                     {
                                         ...
                                         //}
                                         objHelperService.SimpleURL_MS(_stmpl_records, "AllProducts////WESAUSTRALASIA////" +  _stmpl_records.GetAttribute("TBT_FAMILY_NAME") + "////" + cdr["Product_ID"].ToString() + "=" + pcode+"////"+_stmpl_records.GetAttribute("TBT_FAMILY_ID") , "pd.aspx");
                        ...
                        if (package_name.Equals("PRODUCT") || package_name.Equals("COMPARE") || package_name.Equals("NEWPRODUCT") || package_name.Equals("PROMOTIONS") || package_name.Equals("NEWPRODUCTNAV") || package_name.Equals("MOREPRODUCTS") || package_name.Equals("NEWPRODUCTHIGHLIGHTSCATLIST"))
                        {
                            ...
                            if (package_name.Equals("PRODUCT"))
                            {
                                ...
                                if (package_name.Equals("PRODUCT"))
                                {
                                    ...
                                    //categorypath = catpath[0] + "////" + catpath[1]+"////"+ catpath[2] + "////" + catpath[3];
                                    string[] catpath = HttpContext.Current.Request.RawUrl.Split('/');
                                   string eapath = "AllProducts////WESAUSTRALASIA////" +  (catpath.Length >= 2 ? catpath[1] : " ") + "////" + (catpath.Length >= 3 ? catpath[2] : " ")+"////"+ (catpath.Length >= 4 ? catpath[3] : " ")  ;

                                   strurlnew = objHelperService.SimpleURL_MS(_stmpl_records, eapath + "////" + _stmpl_records.GetAttribute("TBT_PARENT_FAMILY_ID"), "fl.aspx");
                            ...
                            if (package_name.Equals("PRODUCT"))
                            {
                                if (HttpContext.Current.Session["PRODUCT_CATEGORY_NAME_MS_SES"] != null)
                                    _stmpl_records.SetAttribute("PRODUCT_CATEGORY_NAME", HttpContext.Current.Session["PRODUCT_CATEGORY_NAME_MS_SES"].ToString());
                                string userid = "0";
                                ...
                                if ((isProductReplace == true) && (Issubstitute != ""))
                                {
                                    ...
                                    GetProductReplacementDetails(_stmpl_records, cdr["STRING_VALUE"].ToString(), Convert.ToInt32(userid), _StockStatus);
        ...
        private string GetProductReplacementDetails(StringTemplate _stmpl_records, string _CODE, int user_id, string _StockStatus)
        {
            ...
            DataTable rtntbl = objProductServices.GetSubstituteProductDetails(_CODE, user_id,"mpd");
            ...
            {
                _stmpl_records.SetAttribute("TBT_NIL_CODE", _CODE);
                _stmpl_records.SetAttribute("TBT_STOCK_STATUS_1", _StockStatus);
                _stmpl_records.SetAttribute("TBT_REPLACED_EXISTS", false);
                
            }
            else if (samecodenotFound == false && samecodesubproduct == false)
            {
                _stmpl_records.SetAttribute("TBT_REPLACED_EXISTS", true);
                _stmpl_records.SetAttribute("TBT_NIL_CODE", _CODE);                
                _stmpl_records.SetAttribute("TBT_STOCK_STATUS_1", "Product Not Available.");
                _stmpl_records.SetAttribute("TBT_REPLACED_CODE", wag_product_code);
                _stmpl_records.SetAttribute("TBT_REPLACED_URL", Ea_Path); 

                //_sPriceTable += string.Format("<tr><td style=\"color:red;\">{0}</td>", _CODE);
                        ...
                        foreach (DataRow oDr in dr)
                {
                    ...
                    if (P1[1].Length >= 4 && P2[1].Length >= 4)
                    {
                        if ((P1.Length > 0 && Convert.ToInt32(P1[1].Substring(2, 2)) > 1) || P2.Length > 0 && Convert.ToInt32(P2[1].Substring(2, 2)) > 1)
                            ...
                            _sPriceTable += string.Format("<tr><td align=\"center\" class=\"bg_grey3\">{0}</td><td align=\"center\">${1:0.0000}</td><td align=\"center\">${2:0.0000}</td></tr>", oDr["QTY"],  oDr["Price1"] ,  oDr["Price2"] );
                        else
                            ...
                            _sPriceTable += string.Format("<tr><td align=\"center\" class=\"bg_grey3\">{0}</td><td align=\"center\">${1:0.00}</td><td align=\"center\">${2:0.00}</td></tr>", oDr["QTY"],  oDr["Price1"] , oDr["Price2"] );
                    }
                    else
                        //_sPriceTable += string.Format("<tr><td align=\"center\" class=\"bg_grey3\">{0}</td><td align=\"center\"><meta itemprop=\"priceCurrency\" content=\"AUD\"/>${1:0.00}</td><td align=\"center\"><meta itemprop=\"priceCurrency\" content=\"AUD\"/>${2:0.00}</td></tr>", oDr["QTY"], "<span itemprop=\"price\">" + oDr["Price1"] + "</span>", "<span itemprop=\"price\">" + oDr["Price2"] + "</span>");
                        _sPriceTable += string.Format("<tr><td align=\"center\" class=\"bg_grey3\">{0}</td><td align=\"center\">${1:0.00}</td><td align=\"center\">${2:0.00}</td></tr>", oDr["QTY"],  oDr["Price1"] ,  oDr["Price2"] );
                           ...
                           // _sPriceTable += string.Format("<tr><td class=\"{3}\">{0}</td><td  class=\"{3}\" align=\"center\"><meta itemprop=\"priceCurrency\" content=\"AUD\"/>${1:0.00}</td><td class=\"{3}\" align=\"center\"><meta itemprop=\"priceCurrency\" content=\"AUD\"/>${2:0.00}</td></tr>", oDr["QTY"], "<span itemprop=\"price\">" + oDr["Price1"] + "</span>", "<span itemprop=\"price\">" + oDr["Price2"] + "</span>", _color);
                            if (P1[1].Length >= 4 && P2[1].Length >= 4)
                            {
                                if ((P1.Length > 0 && Convert.ToInt32(P1[1].Substring(2, 2)) > 1) || P2.Length > 0 && Convert.ToInt32(P2[1].Substring(2, 2)) > 1)
                                    ...
                                    _sPriceTable += string.Format("<tr><td align=\"center\" class=\"{3}\">{0}</td><td  class=\"{3}\" align=\"center\">${1:0.0000}</td><td class=\"{3}\" align=\"center\">${2:0.0000}</td></tr>", oDr["QTY"], oDr["Price1"], oDr["Price2"], _color);
                                else
                                    ...
                                    _sPriceTable += string.Format("<tr><td align=\"center\" class=\"{3}\">{0}</td><td  class=\"{3}\" align=\"center\">${1:0.00}</td><td class=\"{3}\" align=\"center\">${2:0.00}</td></tr>", oDr["QTY"], oDr["Price1"], oDr["Price2"], _color);
                            }
                            else
        ...
        private void GetMultipleImages(int ProductID, int FamilyID,int SubFamilyId, StringTemplate st)
        {
           ...
           // objErrorHandler.CreateLog("ProductID" + ProductID + "--" + "FamilyID" + FamilyID + "--" + "SubFamilyId" + SubFamilyId);
            try
            { 
            if (oDs != null)
            {
  ...
  //                      st.SetAttribute("CDNROOT", System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString());
                        if (firstImg)
                        {
     ...
     //                   st.SetAttribute("CDNROOT", System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString());
                    ...
                    foreach (DataRow dr in dsrecords.Tables[0].Rows)
                    {
                                        ...
                                        if (dc_columnname.ToUpper().Equals("TOSUITE_MODEL") || dc_columnname.ToUpper().Equals("TOSUITE_BRAND"))
                                        {
                                            ...
                                            if (package_name.Equals("CATEGORYLISTIMG"))
                                            {
                                              ...
                                              string model= _stmpl_records.GetAttribute("TBT_TOSUITE_MODEL").ToString();  
                                                objHelperService.SimpleURL_MS(_stmpl_records, "//// ////" + parentcat + "////" + HttpContext.Current.Request.QueryString["tsb"]  , "bb.aspx");
                        ...
                        if (package_name.Equals("TOP") || package_name.Equals("TOPLOG") || package_name.Equals("BOTTOM"))
                        {
                            if (HttpContext.Current.Request.Url.Segments[1].ToString().ToUpper().Equals("/Home.aspx") || HttpContext.Current.Session["URLINIHOME"] == null || HttpContext.Current.Request.Url.Segments[1].ToString().ToUpper().Equals("/Login.aspx"))
                            {
                                ...
                                objHelperService.SimpleURL_MS(_stmpl_records,"//// ////"+  dr["Category_name"].ToString(), "ct.aspx");
        ...
        public string ST_Top_attribute_Filter()
        {
            ...
            try
            {
                ...
                string urlpage=HttpContext.Current.Request.Url.ToString().ToLower();
                if (urlpage.Contains("mpl.aspx") == true)
                    pagetype="mpl";
                else if (urlpage.Contains("mps.aspx") == true)
                    pagetype="mps";
                else if (urlpage.Contains("mfl.aspx") == true)
                    pagetype = "mfl";
                else
                    pagetype = "mpl";
                ...
                if (dscat != null)
                {
                    ...
                    if (dscat.Tables.Count > 0)
                        lstrows = new TBWDataList[dscat.Tables.Count + 3];

                    for (int i = 0; i < dscat.Tables.Count; i++)
                    {
                        Boolean tmpallow = true;
                        if (dscat.Tables[i].TableName.Contains("Category") && urlpage.Contains("mfl.aspx") == true)
                        {
                            tmpallow = false;
                        }
                        else
                        ...
                        if (tmpallow == true)
                        {
                            if (dscat.Tables[i].Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow dr in dscat.Tables[i].Rows)//For Records
                                {
                                    ...
                                    {
                                        _stmpl_records = _stg_records.GetInstanceOf("searchrsltcategoryTop" + "\\" + "cell4");
                                    }
                                    else
                                    {
                                        _stmpl_records = _stg_records.GetInstanceOf("searchrsltcategoryTop" + "\\" + "cell");
                             ...
                             //  objHelperServices.SimpleURL_MS_Str(, "pl.aspx", true, "");


                                    //if (HttpContext.Current.Request.RawUrl.Contains("/mps") == false)
                                    //{
                                    ...
                                    //else
                                    //{
                                    //    _stmpl_records.SetAttribute("ORG_EA_PATH",EA_ROOT_CATEGORY_PATH+"////"+ Filter_EA_Path.Replace("//// //// ////",""));
            ...
            try
            {
               ...
               // dsSubCat = EasyAsk.GetCategoryAndBrand("SubCategory");
                ...
                foreach (DataRow dr in dsMainCat.Tables[0].Rows)//For Records
                {
                    ...
                    _stmpl_records.SetAttribute("TBT_REWRITEURL",  objHelperServices.SimpleURL_MS_Str(_BCEAPath + "////" + dr["CATEGORY_NAME"].ToString(), "mpl.aspx",true));
            ...
            try
            {
             ...
             EasyAsk.GetMainMenuClickDetailJson(strsupplierId, "", true );
                ...
                foreach (DataRow dr in dtMainCat.Rows)//For Records
                {
                    ...
                    string formname = HttpContext.Current.Request.RawUrl.ToString();
                    string[] consurl = null;
                    string catname = string.Empty; 
                    if (formname.Contains("/mct/") || formname.Contains("/mpl/") || formname.Contains("/mfl/")
                        || formname.Contains("/mps/"))
                    {
                        consurl = formname.Split('/');
                        catname = consurl[1];
                    }
                    else
                    {

                        catname = strsupplierName;
                    }
                    _stmpl_records.SetAttribute("TBT_REWRITEURL", objHelperServices.SimpleURL_MS_Str(catname + "////" + dr["CATEGORY_NAME"].ToString(), "mpl.aspx", false));
                    _stmpl_records.SetAttribute("TBT_CATEGORY_NAME", dr["CATEGORY_NAME"].ToString());
                    _stmpl_records.SetAttribute("MENU_NO", ictrows);
                    if (ictrows==1)
                        ...
                        if (subrows.Length > 0)
                        {
                            foreach (DataRow subdr in subrows)//For Records
                            {
                             ...
                             //   _stmpl_records1.SetAttribute("TBT_REWRITEURL", objHelperServices.Cons_NewURlASPX("", dr["EA_PATH"] + "////" + dr["CATEGORY_NAME"].ToString() + "////" + subdr["CATEGORY_NAME"].ToString(), "mpl.aspx", true, "Category"));
                                _stmpl_records1.SetAttribute("TBT_REWRITEURL", objHelperServices.SimpleURL_MS_Str(catname + "////" + dr["CATEGORY_NAME"].ToString(), "mpl.aspx", false));
                    ...
                    if (dtSubCat != null && dtSubCat.Rows.Count > 0)
                    {
                        ...
                        if (subrows.Length > 0)
                        {
                            foreach (DataRow subdr in subrows)//For Records
                            {
                                ...
                                _stmpl_records1 = _stg_records1.GetInstanceOf(_Package + "\\" + "cell");
                                //_stmpl_records1.SetAttribute("TBT_REWRITEURL", subdr["URL_RW_PATH"].ToString());
                                //_stmpl_records1.SetAttribute("TBT_REWRITEURL", objHelperServices.SimpleURL_MS_Str(consurl[0]  + "////" + dr["CATEGORY_NAME"].ToString() + "////" + subdr["CATEGORY_NAME"].ToString(), "mpl.aspx"));
                                _stmpl_records1.SetAttribute("TBT_REWRITEURL", objHelperServices.SimpleURL_MS_Str(catname + "////" + dr["CATEGORY_NAME"].ToString(), "mpl.aspx", false));
        ...
        public string ST_Top_Cart_item()
        {
            ...
            try
            {
                ...
                if (objHelperServices.CI(_Tbt_Order_Id) > 0 && OrderStatus == OrderServices.OrderStatus.OPEN.ToString())    // || OrderStatus=="CAU_PENDING")
                {
                    ...
                    dsCart = objHelperDB.GetDataSetDB("exec STP_TBWC_PICK_CART_ITEM_BIGTOP " + _Tbt_Order_Id + ",'" + sessionId_dum + "','" + strsupplierId + "'" );
                }
                else
                {
                    dsCart = null;
               ...
               _Tbt_Ship_URL = "/morderDetails.aspx?bulkorder=1&amp;Pid=0&amp;ORDER_ID=" + _Tbt_Order_Id  ;
                ...
                if (dsCart == null || dsCart.Tables.Count <= 0 || dsCart.Tables[0].Rows.Count <= 0)
                {
                    ...
                    _stmpl_records1.SetAttribute("CDN", System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString());
                    _stmpl_records1.SetAttribute("CDNROOT", System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString()); 
                    ...
                    foreach (DataRow dr in dsCart.Tables[0].Rows)//For Records
                    {
                        ...
                        DataSet tmpds = (DataSet)objHelperDB.GetGenericDataDB(WesCatalogId, dr["product_id"].ToString(), strsupplierId, "GET_PARENT_CATEGORY_ID_PATH_INPUT_PID", HelperDB.ReturnType.RTDataSet);
                         if (tmpds != null && tmpds.Tables.Count > 0)
                         {
                             ...
                             newurl = objHelperServices.SimpleURL_MS_Str("AllProducts////WESAUSTRALASIA////" + "////" + (catpath.Length >= 1 ? catpath[0] : " ") + "////" +  (catpath.Length >= 2 ? catpath[1] : " ") + "////" + tmpds.Tables[0].Rows[0]["FAMILY_name"].ToString() + "////" + tmpds.Tables[0].Rows[0]["product_ID"].ToString() + "=" + dr["Code"].ToString() + "////" + tmpds.Tables[0].Rows[0]["FAMILY_ID"].ToString(), "mpd.aspx",true);
                    ...
                    foreach (DataRow dr in dsCart.Tables[0].Rows)//For Records
                    {
                        ...
                        category = strsupplierName;
                         ...
                         if (tmpds != null && tmpds.Tables.Count > 0)
                         {
                             ...
                             newurl = objHelperServices.SimpleURL_MS_Str("AllProducts////WESAUSTRALASIA////" + "////" + (catpath.Length >= 1 ? catpath[0] : " ") + "////" +  (catpath.Length >= 2 ? catpath[1] : " ") + "////" + tmpds.Tables[0].Rows[0]["FAMILY_name"].ToString() + "////"
        ...
        public string ST_Bootom_Cat_menu()
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dsMainCat.Tables["Category"].Rows)//For Records
                {
                    ...
                    ictrows = ictrows + 1;
                    _stmpl_records = _stg_records.GetInstanceOf(_Package + "\\" + "Row");
                    _stmpl_records.SetAttribute("TBT_REWRITEURL", objHelperServices.SimpleURL_MS_Str( suppliername + "////" + dr["CATEGORY_NAME"].ToString(), "mpl.aspx",true));
                    _stmpl_records.SetAttribute("TBT_CATEGORY_NAME", dr["CATEGORY_NAME"].ToString());
                    _stmpl_records.SetAttribute("MENU_NO", ictrows);
        ...
        public DataTable  GetSupplierDetail()
        {
            ...
            try
            {
                ...
                if (formname.Contains("/mct/") || formname.Contains("/mpl/") || formname.Contains("/mfl/")
                    || formname.Contains("/mps/"))
                {
                    return rtntbl = GetMainCat_FromURl();
                }
                else
                {
                    if (HttpContext.Current.Session["BreadCrumbDS"] != null)
                        ...
                        if (dsbc.Tables[0].Rows.Count > 0)
                        {
                            if (dsbc.Tables[0].Rows[0]["itemType"].ToString().ToLower() == "category")
                            {
                                ...
                                if (HttpContext.Current.Application["key_MainCategory"] != null)
                                {
                                 ...
                                 HttpContext.Current.Session["SUPPLIER_NAME"] = strsupplierName;
        ...
        private DataTable GetMainCat_FromURl()
        {
       ...
       //    mainds = EasyAsk.GetCategoryAndBrand("MainCategory");
            ...
            if (HttpContext.Current.Application["key_MainCategory"] != null)
      {
          mainds = (DataSet)HttpContext.Current.Application["key_MainCategory"];
            ...
            DataTable rtntbl = mainds.Tables[0].Select("URL_RW_PATH='" + ConsURL[1] + "' ").CopyToDataTable();
        ...
        private string GetEAPath()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dsbc = (DataSet)HttpContext.Current.Session["BreadCrumbDS_URL"];
                }
         ...
         public string ST_NewProduct_Load()
        {
           ...
           if(strsupplierId!="SPF-JUDGECCTV")
           {
              tmpds = objHelperDB.GetDataSetDB("exec STP_TBWC_PICK_NEW_PRODUCT_WAG 6,0," + userid + ",'" + strsupplierId + "'");
           }
           else

           {
                 tmpds = objHelperDB.GetDataSetDB("exec STP_TBWC_PICK_NEW_PRODUCT_WAG_JUDGECCTV 6,0," + userid + ",'" + strsupplierId + "'");
           }
              ...
              //   tmpds = dscat;
               // objErrorHandler.CreateLog("exec STP_TBWC_PICK_NEW_PRODUCT_WAG 6,0," + userid + ",'" + strsupplierId + "'");
                ...
                foreach (DataRow dr in tmpds.Tables[0].Rows)//For Records
                {
                    ...
                    if (tmpds1 != null && tmpds.Tables.Count > 0)
                    {
                        string[] catpath = tmpds1.Tables[0].Rows[0]["CATEGORY_PATH"].ToString().ToLower().Replace("supplier product feed////","").Split(new string[] { "////" }, StringSplitOptions.None);
                        URL_RW_PATH = objHelperServices.SimpleURL_MS_Str( "AllProducts////WESAUSTRALASIA////" + "////" + (catpath.Length >=1 ? catpath[0] : " ") + "////" +  (catpath.Length >= 2? catpath[1] : " ") + "////" + tmpds1.Tables[0].Rows[0]["FAMILY_name"].ToString() + "////" + tmpds1.Tables[0].Rows[0]["product_ID"].ToString() + "=" + dr["Code"].ToString() + "////" + tmpds1.Tables[0].Rows[0]["parent_FAMILY_ID"].ToString(), "mpd.aspx",true);

                        //_stmpl_records.SetAttribute("TBT_REWRITEURL", "/" + newurl + "/mpd/");
                        //  dr["URL_RW_PATH"] = "/" + newurl + "/mpd/";
                    }
                   // _stmpl_records.SetAttribute("TBT_REWRITEURL", URL_RW_PATH.Replace("/supplier-product-feed",""));
   ...
   //              StringTemplate _stmpl_container = null;
                 ...
                 if (HttpContext.Current.Request.QueryString["cid"] != null)
                 {
                     ...
                     _stmpl_container = _stg_container.GetInstanceOf(_Package + "\\" + "Main-" + HttpContext.Current.Request.QueryString["cid"].ToString() );
                     _stmpl_container.SetAttribute("CDN", System.Configuration.ConfigurationManager.AppSettings["CDN"].ToString());
                     _stmpl_container.SetAttribute("CDNROOT", System.Configuration.ConfigurationManager.AppSettings["CDNROOT"].ToString());
                     sHTML = _stmpl_container.ToString();
                 }
                 else
                 {
                     ...
                     //_stmpl_container = _stg_container.GetInstanceOf(_Package + "\\" + "Main-SPF-CYP" );
                     //sHTML = _stmpl_container.ToString();
                sHTML = "";
             ...
             try
             {
                 ...
                 if (tmpds != null && tmpds.Tables[0].Rows.Count > 0)
                 {
                     ...
                     foreach (DataRow dr in tmpds.Tables[0].Rows)
                     {
                         ...
                         if (tmpds1 != null && tmpds.Tables.Count > 0)
                         {
                             string[] catpath = tmpds1.Tables[0].Rows[0]["CATEGORY_PATH"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);
                             string categorypath = string.Empty;
                             if (catpath[0].ToLower() != "supplier product feed")
                             {
                             ...
                             string newurl = objHelperServices.SimpleURL_MS_Str( "AllProducts////WESAUSTRALASIA////"
                                 + categorypath + "////" +
                                 tmpds1.Tables[0].Rows[0]["FAMILY_name"].ToString() + "////"
                                 + tmpds1.Tables[0].Rows[0]["product_ID"].ToString() + "="
                                 + dr["Code"].ToString() + "////" + tmpds1.Tables[0].Rows[0]["PARENT_FAMILY_ID"].ToString(), "mpd.aspx",true);
         ...
         public string ST_SubFamily_Load(DataSet tempDs)
         {
             ...
             try
             {
                 ...
                 FileInfo Fil = new FileInfo(strImgFilesnew + drs[0]["FAMILY_TH_IMAGE"].ToString().Replace("\\", "/"));
                 if (Fil.Exists)
                 {
             ...
             try
             {
                ...
                //DataSet dsrecords = new DataSet();
                 ...
                 foreach (DataRow dr in dsrecords.Tables[0].Rows)//For Records
                 {
                     ...
                     else if( (attname.Contains("SHORT_DESCRIPTION"))||(attname.Contains("SHORT DESCRIPTION")))
                     {
                         _stmpl_container.SetAttribute("TBT_SHORT_DESCRIPTION", dr["STRING_VALUE"].ToString());
                     }
                 ...
                 if (HttpContext.Current.Request.QueryString["fid"] != null)
                 {
                     ...
                     if (tmpds != null && tmpds.Tables.Count > 0)
                     {
                         _stmpl_container.SetAttribute("TBT_FAMILY_ID", _fid);
                         string[] catpath = tmpds.Tables[0].Rows[0]["CATEGORY_PATH"].ToString().Split(new string[] { "////" }, StringSplitOptions.None);
                         string eapath = "AllProducts////WESAUSTRALASIA////" + (catpath.Length >= 1 ? catpath[0] : " ") + "////" +  (catpath.Length >= 2 ? catpath[1] : " ");


                         _stmpl_container.SetAttribute("TBT_EA_PATH", HttpUtility.UrlEncode(objSecurity.StringEnCrypt(eapath)));
                         _stmpl_container.SetAttribute("TBT_ORGEA_PATH", eapath);
                         string bceapath = HttpContext.Current.Session["breadcrumEAPATH"].ToString();
                         objHelperService.SimpleURL_MS(_stmpl_container, eapath + "////" + "Family" + "////" + _fid, "fl.aspx");
