...
namespace TradingBell.WebCat.TemplateRender
{
    ...
    public class TBWTemplateEngine
    {
        ...
        private void BuildRecordsTemplateColumn()
        {
            ...
            stopwatch.Stop();
            objErrorHandler.CreateLog("buildrecordstemplatecolumn -" + stopwatch.Elapsed);
        }
...
<<<<<<< .mine
            ...
            stopwatch.Stop();
            objErrorHandler.CreateLog("getproductpricetable -" + stopwatch.Elapsed);
            return _sPriceTable;
=======
                _sPriceTable = new StringBuilder();
            }         
...
>>>>>>> .r3857
        ...
        private void GetMultipleImages(int ProductID, int FamilyID,int SubFamilyId, StringTemplate st)
        {
            ...
            stopwatch.Stop();
            objErrorHandler.CreateLog("getmultipleimages -" + stopwatch.Elapsed);
        }
         ...
         public string ST_NewProduct_Load()
        {
            ...
            try
            {
               ...
               // DataRow[] drs = null;
                ...
                DataSet tmpds   = objHelperDB.GetDataSetDB("exec STP_TBWC_PICK_NEW_PRODUCT_WAG 10,0," + userid);
         ...
         public string ST_NewProductLogNav_Load(DataSet tmpds,HttpContext ctx)
         {
             ...
             stopwatch.Stop();
             objErrorHandler.CreateLog("st_newproductlognav_load -" + stopwatch.Elapsed);
             return ProdimageRreplaceImages(sHTML);
         }
